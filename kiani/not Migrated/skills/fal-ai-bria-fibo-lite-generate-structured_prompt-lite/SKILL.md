---
name: fal-ai-bria-fibo-lite-generate-structured_prompt-lite
description: >
  Use this skill for the fal.ai Fibo Lite model (bria/fibo-lite/generate/structured_prompt/lite). Structured Prompt Generation endpoint for Fibo-Lite, Bria's SOTA Open source model
---
...
**Endpoint:** `bria/fibo-lite/generate/structured_prompt/lite`
**Source:** https://fal.ai/models/bria/fibo-lite/generate/structured_prompt/lite/api
...
- API page: https://fal.ai/models/bria/fibo-lite/generate/structured_prompt/lite/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=bria/fibo-lite/generate/structured_prompt/lite
