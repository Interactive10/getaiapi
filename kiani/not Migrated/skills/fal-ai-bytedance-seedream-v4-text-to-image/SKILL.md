...
description: >
  Use this skill for the fal.ai Bytedance Seedream v4 model (fal-ai/bytedance/seedream/v4/text-to-image). A new-generation image creation model ByteDance, Seedream 4.0 integrates image generation and image editing capabilities into a single, unified architecture.
---
...
**Source:** https://fal.ai/models/fal-ai/bytedance/seedream/v4/text-to-image/api
...
| `image_size` | ImageSize | enum (9 values) | No | `{'height': 2048, 'width': 2048}` | The size of the generated image. Total pixels must be between 960x960 and 4096x4096. |
| `enhance_prompt_mode` | enum: `standard`, `fast` | No | `"standard"` | The mode to use for enhancing prompt enhancement. Standard mode provides higher quality results but takes longer to g... |
...
- API page: https://fal.ai/models/fal-ai/bytedance/seedream/v4/text-to-image/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/bytedance/seedream/v4/text-to-image
