...
description: >
  Use this skill for the fal.ai Bytedance model (fal-ai/bytedance/seedream/v4.5/edit). A new-generation image creation model ByteDance, Seedream 4.5 integrates image generation and image editing capabilities into a single, unified architecture.
---
...
- API page: https://fal.ai/models/fal-ai/bytedance/seedream/v4.5/edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/bytedance/seedream/v4.5/edit
