---
name: fal-ai-chrono-edit
description: >
  Use this skill for the fal.ai Chrono Edit model (fal-ai/chrono-edit). NVIDIA's Logically Consistent and Physics-Aware Image Editing Model
---
...
**Source:** https://fal.ai/models/fal-ai/chrono-edit/api
...
- API page: https://fal.ai/models/fal-ai/chrono-edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/chrono-edit
