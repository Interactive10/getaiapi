---
name: fal-ai-decart-lucy-edit-pro
description: >
  Use this skill for the fal.ai Lucy Edit [Pro] model (decart/lucy-edit/pro). Edit outfits, objects, faces, or restyle your video - all with maximum detail retention.
---
...
**Source:** https://fal.ai/models/decart/lucy-edit/pro/api
...
```javascript
const { request_id } = await fal.queue.submit("decart/lucy-edit/pro", {
  input: {
        "video_url": "https://example.com/input.png",
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("decart/lucy-edit/pro", {
...
```javascript
const result = await fal.queue.result("decart/lucy-edit/pro", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/decart/lucy-edit/pro/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=decart/lucy-edit/pro
