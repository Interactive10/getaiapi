---
name: fal-ai-f-lite-standard
description: >
  Use this skill for the fal.ai F Lite model (fal-ai/f-lite/standard). F Lite is a 10B parameter diffusion model created by Fal and Freepik, trained exclusively on copyright-safe and SFW content.
---
...
**Endpoint:** `fal-ai/f-lite/standard`
**Source:** https://fal.ai/models/fal-ai/f-lite/standard/api
...
- API page: https://fal.ai/models/fal-ai/f-lite/standard/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/f-lite/standard
