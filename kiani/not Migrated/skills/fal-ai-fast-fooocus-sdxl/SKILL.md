---
name: fal-ai-fast-fooocus-sdxl
description: >
  Use this skill for the fal.ai Fooocus model (fal-ai/fast-fooocus-sdxl). Fooocus extreme speed mode as a standalone app.
---
...
**Endpoint:** `fal-ai/fast-fooocus-sdxl`
**Source:** https://fal.ai/models/fal-ai/fast-fooocus-sdxl/api
...
const result = await fal.subscribe("fal-ai/fast-fooocus-sdxl", {
  input: {
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/fast-fooocus-sdxl", {
  input: {
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/fast-fooocus-sdxl", {
...
```javascript
const result = await fal.queue.result("fal-ai/fast-fooocus-sdxl", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/fast-fooocus-sdxl/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-fooocus-sdxl
