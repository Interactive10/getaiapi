---
name: fal-ai-fast-lightning-sdxl-inpainting
description: >
  Use this skill for the fal.ai Stable Diffusion XL Lightning model (fal-ai/fast-lightning-sdxl/inpainting). Run SDXL at the speed of light
---
...
**Endpoint:** `fal-ai/fast-lightning-sdxl/inpainting`
**Source:** https://fal.ai/models/fal-ai/fast-lightning-sdxl/inpainting/api
...
const result = await fal.subscribe("fal-ai/fast-lightning-sdxl/inpainting", {
  input: {
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/fast-lightning-sdxl/inpainting", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png",
        "mask_url": "https://example.com/input.png"
...
```javascript
const status = await fal.queue.status("fal-ai/fast-lightning-sdxl/inpainting", {
...
```javascript
const result = await fal.queue.result("fal-ai/fast-lightning-sdxl/inpainting", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/fast-lightning-sdxl/inpainting/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-lightning-sdxl/inpainting
