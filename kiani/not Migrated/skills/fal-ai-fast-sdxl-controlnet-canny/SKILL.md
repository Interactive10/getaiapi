---
name: fal-ai-fast-sdxl-controlnet-canny
description: >
  Use this skill for the fal.ai ControlNet SDXL model (fal-ai/fast-sdxl-controlnet-canny). Generate Images with ControlNet.
---
...
**Source:** https://fal.ai/models/fal-ai/fast-sdxl-controlnet-canny/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/fast-sdxl-controlnet-canny", {
  input: {
        "prompt": "your value here",
        "control_image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/fast-sdxl-controlnet-canny", {
...
```javascript
const result = await fal.queue.result("fal-ai/fast-sdxl-controlnet-canny", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/fast-sdxl-controlnet-canny/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-sdxl-controlnet-canny
