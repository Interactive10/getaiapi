---
name: fal-ai-flux-2-klein-4b-base-edit
description: >
  Use this skill for the fal.ai Flux 2 [klein] 4B Base model (fal-ai/flux-2/klein/4b/base/edit). Image-to-image editing with Flux 2 [klein] 4B Base from Black Forest Labs. Precise modifications using natural language descriptions and hex color control.
---
...
**Endpoint:** `fal-ai/flux-2/klein/4b/base/edit`
**Source:** https://fal.ai/models/fal-ai/flux-2/klein/4b/base/edit/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/flux-2/klein/4b/base/edit", {
  input: {
        "prompt": "your value here",
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/flux-2/klein/4b/base/edit", {
...
```javascript
const result = await fal.queue.result("fal-ai/flux-2/klein/4b/base/edit", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/flux-2/klein/4b/base/edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2/klein/4b/base/edit
