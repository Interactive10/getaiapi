---
name: fal-ai-flux-2-klein-4b-edit
description: >
  Use this skill for the fal.ai Flux 2 [klein] 4B model (fal-ai/flux-2/klein/4b/edit). Image-to-image editing with Flux 2 [klein] 4B from Black Forest Labs. Precise modifications using natural language descriptions and hex color control.
---
...
**Source:** https://fal.ai/models/fal-ai/flux-2/klein/4b/edit/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/flux-2/klein/4b/edit", {
  input: {
        "prompt": "your value here",
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/flux-2/klein/4b/edit", {
...
```javascript
const result = await fal.queue.result("fal-ai/flux-2/klein/4b/edit", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/flux-2/klein/4b/edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2/klein/4b/edit
