---
name: fal-ai-flux-2-klein-9b-base
description: >
  Use this skill for the fal.ai FLUX.2 [klein] 9B Base model (fal-ai/flux-2/klein/9b/base). Text-to-image generation with FLUX.2 [klein] 9B Base from Black Forest Labs. Enhanced realism, crisper text generation, and native editing capabilities.
---
...
**Endpoint:** `fal-ai/flux-2/klein/9b/base`
**Source:** https://fal.ai/models/fal-ai/flux-2/klein/9b/base/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/flux-2/klein/9b/base", {
  input: {
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/flux-2/klein/9b/base", {
...
```javascript
const result = await fal.queue.result("fal-ai/flux-2/klein/9b/base", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/flux-2/klein/9b/base/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2/klein/9b/base
