---
name: fal-ai-flux-2-lora-gallery-digital-comic-art
description: >
  Use this skill for the fal.ai Flux 2 Lora Gallery model (fal-ai/flux-2-lora-gallery/digital-comic-art). Transforms images into comic book style
---
...
**Endpoint:** `fal-ai/flux-2-lora-gallery/digital-comic-art`
**Source:** https://fal.ai/models/fal-ai/flux-2-lora-gallery/digital-comic-art/api
...
| --- | --- | --- | --- | --- |
| `prompt` | string | **Yes** |  | The prompt to generate a digital comic art style image. Use 'd1g1t4l' trigger word for best results. |
...
| `lora_scale` | float | No | `1` | The strength of the digital comic art effect. |
...
| `images` | list<Image> | The generated digital comic art style images |
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/flux-2-lora-gallery/digital-comic-art", {
  input: {
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/flux-2-lora-gallery/digital-comic-art", {
...
```javascript
const result = await fal.queue.result("fal-ai/flux-2-lora-gallery/digital-comic-art", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/flux-2-lora-gallery/digital-comic-art/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2-lora-gallery/digital-comic-art
