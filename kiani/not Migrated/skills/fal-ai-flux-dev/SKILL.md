...
description: >
  Use this skill for the fal.ai FLUX.1 [dev] model (fal-ai/flux/dev). FLUX.1 [dev] is a 12 billion parameter flow transformer that generates high-quality images from text. It is suitable for personal and commercial use.
---
...
- API page: https://fal.ai/models/fal-ai/flux/dev/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux/dev
