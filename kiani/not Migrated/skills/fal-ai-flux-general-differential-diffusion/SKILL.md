---
name: fal-ai-flux-general-differential-diffusion
description: >
  Use this skill for the fal.ai FLUX.1 [dev] with Controlnets and Loras model (fal-ai/flux-general/differential-diffusion). A specialized FLUX endpoint combining differential diffusion control with LoRA, ControlNet, and IP-Adapter support, enabling precise, region-specific image transformations through customizable change 
---
...
**Endpoint:** `fal-ai/flux-general/differential-diffusion`
**Source:** https://fal.ai/models/fal-ai/flux-general/differential-diffusion/api
...
| `strength` | float | No | `0.85` | The strength to use for differential diffusion. 1.0 is completely remakes the image while 0.0 preserves the original. |
...
- API page: https://fal.ai/models/fal-ai/flux-general/differential-diffusion/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-general/differential-diffusion
