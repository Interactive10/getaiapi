...
**Source:** https://fal.ai/models/fal-ai/flux-general/image-to-image/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/flux-general/image-to-image", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/flux-general/image-to-image", {
...
```javascript
const result = await fal.queue.result("fal-ai/flux-general/image-to-image", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/flux-general/image-to-image/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-general/image-to-image
