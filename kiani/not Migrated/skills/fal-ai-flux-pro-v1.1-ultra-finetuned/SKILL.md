...
description: >
  Use this skill for the fal.ai FLUX1.1 [pro] ultra Fine-tuned model (fal-ai/flux-pro/v1.1-ultra-finetuned). FLUX1.1 [pro] ultra fine-tuned is the newest version of FLUX1.1 [pro] with a fine-tuned LoRA, maintaining professional-grade image quality while delivering up to 2K resolution with improved photo real
---
...
**Source:** https://fal.ai/models/fal-ai/flux-pro/v1.1-ultra-finetuned/api
...
- API page: https://fal.ai/models/fal-ai/flux-pro/v1.1-ultra-finetuned/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-pro/v1.1-ultra-finetuned
