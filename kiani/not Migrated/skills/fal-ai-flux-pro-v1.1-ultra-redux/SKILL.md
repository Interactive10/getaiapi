...
description: >
  Use this skill for the fal.ai FLUX1.1 [pro] ultra Redux model (fal-ai/flux-pro/v1.1-ultra/redux). FLUX1.1 [pro] ultra Redux is a high-performance endpoint for the FLUX1.1 [pro] model that enables rapid transformation of existing images, delivering high-quality style transfers and image modificatio
---
...
**Source:** https://fal.ai/models/fal-ai/flux-pro/v1.1-ultra/redux/api
...
- API page: https://fal.ai/models/fal-ai/flux-pro/v1.1-ultra/redux/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-pro/v1.1-ultra/redux
