---
name: fal-ai-gpt-image-1-text-to-image
description: >
  Use this skill for the fal.ai gpt-image-1 model (fal-ai/gpt-image-1/text-to-image). OpenAI's latest image generation and editing model: gpt-1-image.
---
...
**Source:** https://fal.ai/models/fal-ai/gpt-image-1/text-to-image/api
...
- API page: https://fal.ai/models/fal-ai/gpt-image-1/text-to-image/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/gpt-image-1/text-to-image
