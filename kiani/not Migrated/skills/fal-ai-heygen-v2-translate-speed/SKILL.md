---
name: fal-ai-heygen-v2-translate-speed
description: >
  Use this skill for the fal.ai Heygen model (fal-ai/heygen/v2/translate/speed). Heygen Translate Model with Extreme Speed
---
...
**Source:** https://fal.ai/models/fal-ai/heygen/v2/translate/speed/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/heygen/v2/translate/speed", {
  input: {
        "video_url": "https://example.com/input.png",
        "output_language": "English"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/heygen/v2/translate/speed", {
...
```javascript
const result = await fal.queue.result("fal-ai/heygen/v2/translate/speed", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/heygen/v2/translate/speed/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/heygen/v2/translate/speed
