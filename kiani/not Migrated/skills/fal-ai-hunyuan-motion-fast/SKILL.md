---
name: fal-ai-hunyuan-motion-fast
description: >
  Use this skill for the fal.ai Hunyuan Motion [0.46B] model (fal-ai/hunyuan-motion/fast). Generate 3D human motions via text-to-generation interface of Hunyuan Motion!
---
...
**Endpoint:** `fal-ai/hunyuan-motion/fast`
**Source:** https://fal.ai/models/fal-ai/hunyuan-motion/fast/api
...
const result = await fal.subscribe("fal-ai/hunyuan-motion/fast", {
  input: {
...
- API page: https://fal.ai/models/fal-ai/hunyuan-motion/fast/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/hunyuan-motion/fast
