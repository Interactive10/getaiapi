...
description: >
  Use this skill for the fal.ai Hunyuan Video model (fal-ai/hunyuan-video). Hunyuan Video is an Open video generation model with high visual quality, motion diversity, text-video alignment, and generation stability. This endpoint generates videos from text descriptions.
---
...
**Source:** https://fal.ai/models/fal-ai/hunyuan-video/api
...
- API page: https://fal.ai/models/fal-ai/hunyuan-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/hunyuan-video
