---
name: fal-ai-ideogram-character-edit
description: >
  Use this skill for the fal.ai Ideogram V3 Character Edit model (fal-ai/ideogram/character/edit). Modify consistent characters while preserving their core identity. Edit poses, expressions, or clothing without losing recognizable character features
---
...
**Endpoint:** `fal-ai/ideogram/character/edit`
**Source:** https://fal.ai/models/fal-ai/ideogram/character/edit/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ideogram/character/edit", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png",
        "reference_image_urls": [],
...
```javascript
const status = await fal.queue.status("fal-ai/ideogram/character/edit", {
...
```javascript
const result = await fal.queue.result("fal-ai/ideogram/character/edit", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ideogram/character/edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ideogram/character/edit
