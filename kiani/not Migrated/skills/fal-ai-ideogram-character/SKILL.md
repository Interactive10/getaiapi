---
name: fal-ai-ideogram-character
description: >
  Use this skill for the fal.ai Ideogram V3 Character model (fal-ai/ideogram/character). Generate consistent character appearances across multiple images. Maintain facial features, proportions, and distinctive traits for cohesive storytelling and branding
---
...
**Source:** https://fal.ai/models/fal-ai/ideogram/character/api
...
- API page: https://fal.ai/models/fal-ai/ideogram/character/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ideogram/character
