---
name: fal-ai-ideogram-v2-turbo-edit
description: >
  Use this skill for the fal.ai Ideogram V2 Turbo Edit model (fal-ai/ideogram/v2/turbo/edit). Edit images faster with Ideogram V2 Turbo. Quick modifications and adjustments while preserving the high-quality standards and realistic outputs of Ideogram.
---
...
**Endpoint:** `fal-ai/ideogram/v2/turbo/edit`
**Source:** https://fal.ai/models/fal-ai/ideogram/v2/turbo/edit/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ideogram/v2/turbo/edit", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png",
        "mask_url": "https://example.com/input.png"
...
```javascript
const status = await fal.queue.status("fal-ai/ideogram/v2/turbo/edit", {
...
```javascript
const result = await fal.queue.result("fal-ai/ideogram/v2/turbo/edit", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ideogram/v2/turbo/edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ideogram/v2/turbo/edit
