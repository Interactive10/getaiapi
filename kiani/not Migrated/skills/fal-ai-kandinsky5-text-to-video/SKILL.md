---
name: fal-ai-kandinsky5-text-to-video
description: >
  Use this skill for the fal.ai Kandinsky5 model (fal-ai/kandinsky5/text-to-video). Kandinsky 5.0 is a diffusion model for fast, high-quality text-to-video  generation.
---
...
**Endpoint:** `fal-ai/kandinsky5/text-to-video`
**Source:** https://fal.ai/models/fal-ai/kandinsky5/text-to-video/api
...
- API page: https://fal.ai/models/fal-ai/kandinsky5/text-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kandinsky5/text-to-video
