---
name: fal-ai-kling-video-o3-standard-text-to-video
description: >
  Use this skill for the fal.ai Kling O3 Text to Video [Standard] model (fal-ai/kling-video/o3/standard/text-to-video). Generate realistic videos using Kling O3 from Kling Team!
---
...
**Source:** https://fal.ai/models/fal-ai/kling-video/o3/standard/text-to-video/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/kling-video/o3/standard/text-to-video", {
  input: {
        "prompt": "your prompt here"
      },
...
```javascript
const status = await fal.queue.status("fal-ai/kling-video/o3/standard/text-to-video", {
...
```javascript
const result = await fal.queue.result("fal-ai/kling-video/o3/standard/text-to-video", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/kling-video/o3/standard/text-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/o3/standard/text-to-video
