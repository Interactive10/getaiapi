---
name: fal-ai-kling-video-o3-standard-video-to-video-edit
description: >
  Use this skill for the fal.ai Kling O3 Edit Video [Standard] model (fal-ai/kling-video/o3/standard/video-to-video/edit). Edit videos using Kling O3 from Kling Team!
---
...
**Source:** https://fal.ai/models/fal-ai/kling-video/o3/standard/video-to-video/edit/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/kling-video/o3/standard/video-to-video/edit", {
  input: {
        "prompt": "your value here",
        "video_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/kling-video/o3/standard/video-to-video/edit", {
...
```javascript
const result = await fal.queue.result("fal-ai/kling-video/o3/standard/video-to-video/edit", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/kling-video/o3/standard/video-to-video/edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/o3/standard/video-to-video/edit
