---
name: fal-ai-kling-video-v1-pro-ai-avatar
description: >
  Use this skill for the fal.ai Kling AI Avatar Pro model (fal-ai/kling-video/v1/pro/ai-avatar). Kling AI Avatar Pro: The premium endpoint for creating avatar videos with realistic humans, animals, cartoons, or stylized characters
---
...
**Source:** https://fal.ai/models/fal-ai/kling-video/v1/pro/ai-avatar/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/kling-video/v1/pro/ai-avatar", {
  input: {
        "audio_url": "https://example.com/input.png",
        "image_url": "https://example.com/input.png"
    },
...
- API page: https://fal.ai/models/fal-ai/kling-video/v1/pro/ai-avatar/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v1/pro/ai-avatar
