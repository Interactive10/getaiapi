---
name: fal-ai-kling-video-v1.6-standard-image-to-video
description: >
  Use this skill for the fal.ai Kling 1.6 model (fal-ai/kling-video/v1.6/standard/image-to-video). Generate video clips from your images using Kling 1.6 (std)
---
...
**Source:** https://fal.ai/models/fal-ai/kling-video/v1.6/standard/image-to-video/api
...
- API page: https://fal.ai/models/fal-ai/kling-video/v1.6/standard/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v1.6/standard/image-to-video
