...
description: >
  Use this skill for the fal.ai Kling 2.0 Master model (fal-ai/kling-video/v2/master/text-to-video). Generate video clips from your prompts using Kling 2.0 Master
---
...
**Source:** https://fal.ai/models/fal-ai/kling-video/v2/master/text-to-video/api
...
- API page: https://fal.ai/models/fal-ai/kling-video/v2/master/text-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v2/master/text-to-video
