...
description: >
  Use this skill for the fal.ai Kling 2.1 (pro) model (fal-ai/kling-video/v2.1/pro/image-to-video). Kling 2.1 Pro is an advanced endpoint for the Kling 2.1 model, offering professional-grade videos with enhanced visual fidelity, precise camera movements, and dynamic motion control, perfect for cinem
---
...
**Source:** https://fal.ai/models/fal-ai/kling-video/v2.1/pro/image-to-video/api
...
- API page: https://fal.ai/models/fal-ai/kling-video/v2.1/pro/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v2.1/pro/image-to-video
