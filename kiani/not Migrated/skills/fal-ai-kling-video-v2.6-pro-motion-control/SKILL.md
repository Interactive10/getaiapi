...
description: >
  Use this skill for the fal.ai Kling Video v2.6 Motion Control [Pro] model (fal-ai/kling-video/v2.6/pro/motion-control). Transfer movements from a reference video to any character image. Pro mode delivers higher quality output, ideal for complex dance moves and gestures.
---
...
**Source:** https://fal.ai/models/fal-ai/kling-video/v2.6/pro/motion-control/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/kling-video/v2.6/pro/motion-control", {
  input: {
        "video_url": "https://example.com/input.png",
        "character_orientation": "image",
        "image_url": "https://example.com/input.png"
...
```javascript
const status = await fal.queue.status("fal-ai/kling-video/v2.6/pro/motion-control", {
...
```javascript
const result = await fal.queue.result("fal-ai/kling-video/v2.6/pro/motion-control", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/kling-video/v2.6/pro/motion-control/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v2.6/pro/motion-control
