...
description: >
  Use this skill for the fal.ai Kling Video v2.6 Text to Video model (fal-ai/kling-video/v2.6/pro/text-to-video). Kling 2.6 Pro: Top-tier text-to-video with cinematic visuals, fluid motion, and native audio generation.
---
...
- API page: https://fal.ai/models/fal-ai/kling-video/v2.6/pro/text-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v2.6/pro/text-to-video
