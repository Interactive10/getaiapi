...
description: >
  Use this skill for the fal.ai Kling Video v3 Text to Video [Standard] model (fal-ai/kling-video/v3/standard/text-to-video). Kling 3.0 Standard: Top-tier text-to-video with cinematic visuals, fluid motion, and native audio generation, with multi-shot support.
---
...
- API page: https://fal.ai/models/fal-ai/kling-video/v3/standard/text-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v3/standard/text-to-video
