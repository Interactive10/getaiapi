---
name: fal-ai-ltx-2-19b-distilled-audio-to-video-lora
description: >
  Use this skill for the fal.ai LTX-2 19B Distilled model (fal-ai/ltx-2-19b/distilled/audio-to-video/lora). Generate video with audio from audio, text and images using LTX-2 Distilled and custom LoRA
---
...
**Endpoint:** `fal-ai/ltx-2-19b/distilled/audio-to-video/lora`
**Source:** https://fal.ai/models/fal-ai/ltx-2-19b/distilled/audio-to-video/lora/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ltx-2-19b/distilled/audio-to-video/lora", {
  input: {
        "prompt": "your value here",
        "loras": [],
        "audio_url": "https://example.com/input.png"
...
```javascript
const status = await fal.queue.status("fal-ai/ltx-2-19b/distilled/audio-to-video/lora", {
...
```javascript
const result = await fal.queue.result("fal-ai/ltx-2-19b/distilled/audio-to-video/lora", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ltx-2-19b/distilled/audio-to-video/lora/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2-19b/distilled/audio-to-video/lora
