---
name: fal-ai-ltx-2-19b-distilled-extend-video
description: >
  Use this skill for the fal.ai LTX-2 19B Distilled model (fal-ai/ltx-2-19b/distilled/extend-video). Extend videos with audio using LTX-2 Distilled
---
...
**Endpoint:** `fal-ai/ltx-2-19b/distilled/extend-video`
**Source:** https://fal.ai/models/fal-ai/ltx-2-19b/distilled/extend-video/api
...
const result = await fal.subscribe("fal-ai/ltx-2-19b/distilled/extend-video", {
  input: {
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ltx-2-19b/distilled/extend-video", {
  input: {
        "video_url": "https://example.com/input.png",
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/ltx-2-19b/distilled/extend-video", {
...
```javascript
const result = await fal.queue.result("fal-ai/ltx-2-19b/distilled/extend-video", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ltx-2-19b/distilled/extend-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2-19b/distilled/extend-video
