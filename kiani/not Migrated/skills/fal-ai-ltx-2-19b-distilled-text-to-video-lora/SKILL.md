---
name: fal-ai-ltx-2-19b-distilled-text-to-video-lora
description: >
  Use this skill for the fal.ai LTX-2 19B Distilled model (fal-ai/ltx-2-19b/distilled/text-to-video/lora). Generate video with audio from text using LTX-2 Distilled and custom LoRA
---
...
**Endpoint:** `fal-ai/ltx-2-19b/distilled/text-to-video/lora`
**Source:** https://fal.ai/models/fal-ai/ltx-2-19b/distilled/text-to-video/lora/api
...
const result = await fal.subscribe("fal-ai/ltx-2-19b/distilled/text-to-video/lora", {
  input: {
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ltx-2-19b/distilled/text-to-video/lora", {
  input: {
        "prompt": "your value here",
        "loras": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/ltx-2-19b/distilled/text-to-video/lora", {
...
```javascript
const result = await fal.queue.result("fal-ai/ltx-2-19b/distilled/text-to-video/lora", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ltx-2-19b/distilled/text-to-video/lora/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2-19b/distilled/text-to-video/lora
