---
name: fal-ai-ltx-video-13b-dev
description: >
  Use this skill for the fal.ai LTX Video-0.9.7 13B model (fal-ai/ltx-video-13b-dev). Generate videos from prompts using LTX Video-0.9.7 13B and custom LoRA
---
...
**Source:** https://fal.ai/models/fal-ai/ltx-video-13b-dev/api
...
const result = await fal.subscribe("fal-ai/ltx-video-13b-dev", {
  input: {
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ltx-video-13b-dev", {
  input: {
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/ltx-video-13b-dev", {
...
```javascript
const result = await fal.queue.result("fal-ai/ltx-video-13b-dev", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ltx-video-13b-dev/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-video-13b-dev
