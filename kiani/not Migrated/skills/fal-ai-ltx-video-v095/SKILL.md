---
name: fal-ai-ltx-video-v095
description: >
  Use this skill for the fal.ai LTX Video-0.9.5 model (fal-ai/ltx-video-v095). Generate videos from prompts using LTX Video-0.9.5
---
...
**Endpoint:** `fal-ai/ltx-video-v095`
**Source:** https://fal.ai/models/fal-ai/ltx-video-v095/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ltx-video-v095", {
  input: {
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/ltx-video-v095", {
...
```javascript
const result = await fal.queue.result("fal-ai/ltx-video-v095", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ltx-video-v095/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-video-v095
