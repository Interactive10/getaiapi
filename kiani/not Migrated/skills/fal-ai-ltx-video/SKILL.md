...
description: >
  Use this skill for the fal.ai LTX Video (preview) model (fal-ai/ltx-video). Generate videos from prompts using LTX Video
---
...
**Source:** https://fal.ai/models/fal-ai/ltx-video/api
...
- API page: https://fal.ai/models/fal-ai/ltx-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-video
