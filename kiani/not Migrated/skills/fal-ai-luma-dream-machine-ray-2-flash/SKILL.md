...
description: >
  Use this skill for the fal.ai Luma Ray 2 Flash model (fal-ai/luma-dream-machine/ray-2-flash). Ray2 Flash is a fast video generative model capable of creating realistic visuals with natural, coherent motion.
---
...
**Source:** https://fal.ai/models/fal-ai/luma-dream-machine/ray-2-flash/api
...
| `duration` | enum: `5s`, `9s` | No | `"5s"` | The duration of the generated video (9s costs 2x more) |
...
- API page: https://fal.ai/models/fal-ai/luma-dream-machine/ray-2-flash/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/luma-dream-machine/ray-2-flash
