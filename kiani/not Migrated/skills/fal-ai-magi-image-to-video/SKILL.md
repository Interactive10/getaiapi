---
name: fal-ai-magi-image-to-video
description: >
  Use this skill for the fal.ai MAGI-1 model (fal-ai/magi/image-to-video). MAGI-1 generates videos from images with exceptional understanding of physical interactions and prompting
---
...
**Endpoint:** `fal-ai/magi/image-to-video`
**Source:** https://fal.ai/models/fal-ai/magi/image-to-video/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/magi/image-to-video", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/magi/image-to-video", {
...
```javascript
const result = await fal.queue.result("fal-ai/magi/image-to-video", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/magi/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/magi/image-to-video
