...
name: fal-ai-maya
description: >
  Use this skill for the fal.ai Maya1 model (fal-ai/maya). Maya1 is a state-of-the-art speech model by Maya Research for expressive voice generation, built to capture real human emotion and precise voice design.
---
...
**Source:** https://fal.ai/models/fal-ai/maya/api
...
| `output_format` | enum: `wav`, `mp3` | No | `"wav"` | Output audio format for the generated speech |
...
| `sample_rate` | enum: `48 kHz`, `24 kHz` | No | `"48 kHz"` | Output audio sample rate. 48 kHz provides higher quality audio, 24 kHz is faster. |
...
- API page: https://fal.ai/models/fal-ai/maya/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/maya
