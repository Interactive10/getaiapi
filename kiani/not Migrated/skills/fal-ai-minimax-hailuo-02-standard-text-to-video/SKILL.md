...
description: >
  Use this skill for the fal.ai MiniMax Hailuo 02 [Standard] (Text to Video) model (fal-ai/minimax/hailuo-02/standard/text-to-video). MiniMax Hailuo-02 Text To Video API (Standard, 768p): Advanced video generation model with 768p resolution
---
...
**Source:** https://fal.ai/models/fal-ai/minimax/hailuo-02/standard/text-to-video/api
...
- API page: https://fal.ai/models/fal-ai/minimax/hailuo-02/standard/text-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/minimax/hailuo-02/standard/text-to-video
