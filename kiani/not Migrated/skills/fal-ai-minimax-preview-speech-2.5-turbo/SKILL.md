...
description: >
  Use this skill for the fal.ai Minimax model (fal-ai/minimax/preview/speech-2.5-turbo). Generate fast speech from text prompts and different voices using the MiniMax Speech-02 Turbo model, which leverages advanced AI techniques to create high-quality text-to-speech.
---
...
**Endpoint:** `fal-ai/minimax/preview/speech-2.5-turbo`
**Source:** https://fal.ai/models/fal-ai/minimax/preview/speech-2.5-turbo/api
...
- API page: https://fal.ai/models/fal-ai/minimax/preview/speech-2.5-turbo/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/minimax/preview/speech-2.5-turbo
