...
description: >
  Use this skill for the fal.ai MiniMax Speech-02 Turbo model (fal-ai/minimax/speech-02-turbo). Generate fast speech from text prompts and different voices using the MiniMax Speech-02 Turbo model, which leverages advanced AI techniques to create high-quality text-to-speech.
---
...
**Source:** https://fal.ai/models/fal-ai/minimax/speech-02-turbo/api
...
- API page: https://fal.ai/models/fal-ai/minimax/speech-02-turbo/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/minimax/speech-02-turbo
