...
description: >
  Use this skill for the fal.ai Nano Banana model (fal-ai/nano-banana/edit). Google's famous original image generation and editing model
---
...
**Source:** https://fal.ai/models/fal-ai/nano-banana/edit/api
...
- API page: https://fal.ai/models/fal-ai/nano-banana/edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/nano-banana/edit
