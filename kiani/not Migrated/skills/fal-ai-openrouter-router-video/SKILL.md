---
name: fal-ai-openrouter-router-video
description: >
  Use this skill for the fal.ai OpenRouter [Video] model (openrouter/router/video). Run any VLM (Video Language Model) with fal, powered by OpenRouter.
---
...
**Source:** https://fal.ai/models/openrouter/router/video/api
...
- API page: https://fal.ai/models/openrouter/router/video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=openrouter/router/video
