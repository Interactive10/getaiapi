---
name: fal-ai-openrouter-router-vision
description: >
  Use this skill for the fal.ai OpenRouter [Vision] model (openrouter/router/vision). Run any VLM (Vision Language Model) with fal, powered by OpenRouter.
---
...
**Source:** https://fal.ai/models/openrouter/router/vision/api
...
| `image_urls` | list<string> | **Yes** |  | List of image URLs to be processed |
...
```javascript
const status = await fal.queue.status("openrouter/router/vision", {
...
```javascript
const result = await fal.queue.result("openrouter/router/vision", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/openrouter/router/vision/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=openrouter/router/vision
