...
name: fal-ai-piflow
description: >
  Use this skill for the fal.ai Piflow model (fal-ai/piflow). Use the faster speed of piflow to generate images with same quality to that of slower models.
---
...
**Endpoint:** `fal-ai/piflow`
**Source:** https://fal.ai/models/fal-ai/piflow/api
...
| `seed` | integer | No |  | Random seed for reproducible generation. If set to None, a random seed will be used. |
...
- API page: https://fal.ai/models/fal-ai/piflow/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/piflow
