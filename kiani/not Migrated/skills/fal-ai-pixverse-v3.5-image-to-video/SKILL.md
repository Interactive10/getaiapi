...
description: >
  Use this skill for the fal.ai PixVerse v3.5: Image to Video model (fal-ai/pixverse/v3.5/image-to-video). Generate high quality video clips from text and image prompts using PixVerse v3.5
---
...
**Source:** https://fal.ai/models/fal-ai/pixverse/v3.5/image-to-video/api
...
- API page: https://fal.ai/models/fal-ai/pixverse/v3.5/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v3.5/image-to-video
