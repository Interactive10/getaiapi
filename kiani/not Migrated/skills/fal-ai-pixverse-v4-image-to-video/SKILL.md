---
name: fal-ai-pixverse-v4-image-to-video
description: >
  Use this skill for the fal.ai PixVerse v4: Image to Video model (fal-ai/pixverse/v4/image-to-video). Generate high quality video clips from text and image prompts using PixVerse v4
---
...
**Source:** https://fal.ai/models/fal-ai/pixverse/v4/image-to-video/api
...
const result = await fal.subscribe("fal-ai/pixverse/v4/image-to-video", {
  input: {
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/pixverse/v4/image-to-video", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/pixverse/v4/image-to-video", {
...
```javascript
const result = await fal.queue.result("fal-ai/pixverse/v4/image-to-video", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/pixverse/v4/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v4/image-to-video
