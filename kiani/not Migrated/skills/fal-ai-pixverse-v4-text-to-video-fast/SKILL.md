---
name: fal-ai-pixverse-v4-text-to-video-fast
description: >
  Use this skill for the fal.ai PixVerse v4: Text to Video Fast model (fal-ai/pixverse/v4/text-to-video/fast). Generate high quality and fast video clips from text and image prompts using PixVerse v4 fast
---
...
**Endpoint:** `fal-ai/pixverse/v4/text-to-video/fast`
**Source:** https://fal.ai/models/fal-ai/pixverse/v4/text-to-video/fast/api
...
- API page: https://fal.ai/models/fal-ai/pixverse/v4/text-to-video/fast/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v4/text-to-video/fast
