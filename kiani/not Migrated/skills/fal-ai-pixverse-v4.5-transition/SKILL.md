---
name: fal-ai-pixverse-v4.5-transition
description: >
  Use this skill for the fal.ai Pixverse model (fal-ai/pixverse/v4.5/transition). Create seamless transition between images using PixVerse v4.5
---
...
**Endpoint:** `fal-ai/pixverse/v4.5/transition`
**Source:** https://fal.ai/models/fal-ai/pixverse/v4.5/transition/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/pixverse/v4.5/transition", {
  input: {
        "prompt": "your value here",
        "first_image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/pixverse/v4.5/transition", {
...
```javascript
const result = await fal.queue.result("fal-ai/pixverse/v4.5/transition", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/pixverse/v4.5/transition/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v4.5/transition
