---
name: fal-ai-playground-v25-image-to-image
description: >
  Use this skill for the fal.ai Playground v2.5 model (fal-ai/playground-v25/image-to-image). State-of-the-art open-source model in aesthetic quality
---
...
**Source:** https://fal.ai/models/fal-ai/playground-v25/image-to-image/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/playground-v25/image-to-image", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/playground-v25/image-to-image", {
...
```javascript
const result = await fal.queue.result("fal-ai/playground-v25/image-to-image", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/playground-v25/image-to-image/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/playground-v25/image-to-image
