---
name: fal-ai-playground-v25-inpainting
description: >
  Use this skill for the fal.ai Playground v2.5 model (fal-ai/playground-v25/inpainting). State-of-the-art open-source model in aesthetic quality
---
...
**Endpoint:** `fal-ai/playground-v25/inpainting`
**Source:** https://fal.ai/models/fal-ai/playground-v25/inpainting/api
...
const result = await fal.subscribe("fal-ai/playground-v25/inpainting", {
  input: {
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/playground-v25/inpainting", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png",
        "mask_url": "https://example.com/input.png"
...
```javascript
const status = await fal.queue.status("fal-ai/playground-v25/inpainting", {
...
```javascript
const result = await fal.queue.result("fal-ai/playground-v25/inpainting", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/playground-v25/inpainting/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/playground-v25/inpainting
