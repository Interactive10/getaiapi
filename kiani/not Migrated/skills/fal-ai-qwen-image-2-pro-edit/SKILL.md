---
name: fal-ai-qwen-image-2-pro-edit
description: >
  Use this skill for the fal.ai Qwen Image 2 model (fal-ai/qwen-image-2/pro/edit). Qwen-Image-2.0 is a next-generation foundational unified generation-and-editing model
---
...
**Source:** https://fal.ai/models/fal-ai/qwen-image-2/pro/edit/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/qwen-image-2/pro/edit", {
  input: {
        "prompt": "your value here",
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/qwen-image-2/pro/edit", {
...
```javascript
const result = await fal.queue.result("fal-ai/qwen-image-2/pro/edit", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/qwen-image-2/pro/edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-2/pro/edit
