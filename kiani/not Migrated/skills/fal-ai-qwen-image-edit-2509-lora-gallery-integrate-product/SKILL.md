---
name: fal-ai-qwen-image-edit-2509-lora-gallery-integrate-product
description: >
  Use this skill for the fal.ai Qwen Image Edit 2509 Lora Gallery model (fal-ai/qwen-image-edit-2509-lora-gallery/integrate-product). Blend products into backgrounds with automatic perspective and lighting correction
---
...
**Endpoint:** `fal-ai/qwen-image-edit-2509-lora-gallery/integrate-product`
**Source:** https://fal.ai/models/fal-ai/qwen-image-edit-2509-lora-gallery/integrate-product/api
...
const result = await fal.subscribe("fal-ai/qwen-image-edit-2509-lora-gallery/integrate-product", {
  input: {
        "image_urls": []
    },
  logs: true,
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/qwen-image-edit-2509-lora-gallery/integrate-product", {
  input: {
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/qwen-image-edit-2509-lora-gallery/integrate-product", {
...
```javascript
const result = await fal.queue.result("fal-ai/qwen-image-edit-2509-lora-gallery/integrate-product", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/qwen-image-edit-2509-lora-gallery/integrate-product/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-edit-2509-lora-gallery/integrate-product
