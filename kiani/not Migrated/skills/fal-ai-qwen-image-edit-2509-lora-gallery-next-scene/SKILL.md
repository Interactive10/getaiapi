---
name: fal-ai-qwen-image-edit-2509-lora-gallery-next-scene
description: >
  Use this skill for the fal.ai Qwen Image Edit 2509 Lora Gallery model (fal-ai/qwen-image-edit-2509-lora-gallery/next-scene). Create cinematic transitions and scene progressions (camera movements, framing changes)
---
...
**Source:** https://fal.ai/models/fal-ai/qwen-image-edit-2509-lora-gallery/next-scene/api
...
const result = await fal.subscribe("fal-ai/qwen-image-edit-2509-lora-gallery/next-scene", {
  input: {
        "image_urls": []
    },
  logs: true,
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/qwen-image-edit-2509-lora-gallery/next-scene", {
  input: {
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/qwen-image-edit-2509-lora-gallery/next-scene", {
...
```javascript
const result = await fal.queue.result("fal-ai/qwen-image-edit-2509-lora-gallery/next-scene", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/qwen-image-edit-2509-lora-gallery/next-scene/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-edit-2509-lora-gallery/next-scene
