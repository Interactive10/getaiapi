---
name: fal-ai-qwen-image-edit-inpaint
description: >
  Use this skill for the fal.ai Qwen Image Edit model (fal-ai/qwen-image-edit/inpaint). Inpainting Endpoint for the Qwen Edit Image editing model.
---
...
**Source:** https://fal.ai/models/fal-ai/qwen-image-edit/inpaint/api
...
| `strength` | float | No | `0.93` | Strength of noising process for inpainting |
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/qwen-image-edit/inpaint", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png",
        "mask_url": "https://example.com/input.png"
...
```javascript
const status = await fal.queue.status("fal-ai/qwen-image-edit/inpaint", {
...
```javascript
const result = await fal.queue.result("fal-ai/qwen-image-edit/inpaint", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/qwen-image-edit/inpaint/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-edit/inpaint
