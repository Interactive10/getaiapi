---
name: fal-ai-qwen-image-edit-plus-lora-gallery-lighting-restoration
description: >
  Use this skill for the fal.ai Qwen Image Edit Plus Lora Gallery model (fal-ai/qwen-image-edit-plus-lora-gallery/lighting-restoration). Removes harsh shadows and light spots from images, replacing them with soft, even, natural-looking illumination.
---
...
**Source:** https://fal.ai/models/fal-ai/qwen-image-edit-plus-lora-gallery/lighting-restoration/api
...
const result = await fal.subscribe("fal-ai/qwen-image-edit-plus-lora-gallery/lighting-restoration", {
  input: {
        "image_urls": []
    },
  logs: true,
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/qwen-image-edit-plus-lora-gallery/lighting-restoration", {
  input: {
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/qwen-image-edit-plus-lora-gallery/lighting-restoration", {
...
```javascript
const result = await fal.queue.result("fal-ai/qwen-image-edit-plus-lora-gallery/lighting-restoration", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/qwen-image-edit-plus-lora-gallery/lighting-restoration/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-edit-plus-lora-gallery/lighting-restoration
