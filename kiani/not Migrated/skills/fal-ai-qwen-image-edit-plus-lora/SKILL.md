---
name: fal-ai-qwen-image-edit-plus-lora
description: >
  Use this skill for the fal.ai Qwen Image Edit Plus Lora model (fal-ai/qwen-image-edit-plus-lora). LoRA endpoint for the Qwen Image Edit Plus model.
---
...
**Source:** https://fal.ai/models/fal-ai/qwen-image-edit-plus-lora/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/qwen-image-edit-plus-lora", {
  input: {
        "prompt": "your value here",
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/qwen-image-edit-plus-lora", {
...
```javascript
const result = await fal.queue.result("fal-ai/qwen-image-edit-plus-lora", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/qwen-image-edit-plus-lora/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-edit-plus-lora
