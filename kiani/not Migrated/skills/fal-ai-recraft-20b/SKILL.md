---
name: fal-ai-recraft-20b
description: >
  Use this skill for the fal.ai Recraft 20b model (fal-ai/recraft-20b). Recraft 20b is a new and affordable text-to-image model.
---
...
**Endpoint:** `fal-ai/recraft-20b`
**Source:** https://fal.ai/models/fal-ai/recraft-20b/api
...
| `style` | enum (37 values) | No | `"realistic_image"` | The style of the generated images. Vector images cost 2X as much. |
...
- API page: https://fal.ai/models/fal-ai/recraft-20b/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/recraft-20b
