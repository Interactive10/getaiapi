---
name: fal-ai-sana-v1.5-1.6b
description: >
  Use this skill for the fal.ai Sana v1.5 1.6B model (fal-ai/sana/v1.5/1.6b). Sana v1.5 1.6B is a lightweight text-to-image model that delivers 4K image generation with impressive efficiency.
---
...
**Endpoint:** `fal-ai/sana/v1.5/1.6b`
**Source:** https://fal.ai/models/fal-ai/sana/v1.5/1.6b/api
...
const result = await fal.subscribe("fal-ai/sana/v1.5/1.6b", {
  input: {
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/sana/v1.5/1.6b", {
  input: {
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/sana/v1.5/1.6b", {
...
```javascript
const result = await fal.queue.result("fal-ai/sana/v1.5/1.6b", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/sana/v1.5/1.6b/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/sana/v1.5/1.6b
