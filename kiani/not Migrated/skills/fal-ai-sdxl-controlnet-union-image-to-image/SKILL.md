---
name: fal-ai-sdxl-controlnet-union-image-to-image
description: >
  Use this skill for the fal.ai SDXL ControlNet Union model (fal-ai/sdxl-controlnet-union/image-to-image). An efficent SDXL multi-controlnet image-to-image model.
---
...
**Endpoint:** `fal-ai/sdxl-controlnet-union/image-to-image`
**Source:** https://fal.ai/models/fal-ai/sdxl-controlnet-union/image-to-image/api
...
- API page: https://fal.ai/models/fal-ai/sdxl-controlnet-union/image-to-image/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/sdxl-controlnet-union/image-to-image
