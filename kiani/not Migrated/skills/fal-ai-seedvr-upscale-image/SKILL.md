...
description: >
  Use this skill for the fal.ai SeedVR2 model (fal-ai/seedvr/upscale/image). Use SeedVR2 to upscale your images
---
...
**Source:** https://fal.ai/models/fal-ai/seedvr/upscale/image/api
...
| `output_format` | enum: `png`, `jpg`, `webp` | No | `"jpg"` | The format of the output image. |
...
- API page: https://fal.ai/models/fal-ai/seedvr/upscale/image/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/seedvr/upscale/image
