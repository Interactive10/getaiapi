---
name: fal-ai-sonauto-v2-inpaint
description: >
  Use this skill for the fal.ai Sonauto V2 model (sonauto/v2/inpaint). Replace sections of an existing audio with newly generated content
---
...
**Endpoint:** `sonauto/v2/inpaint`
**Source:** https://fal.ai/models/sonauto/v2/inpaint/api
...
| --- | --- | --- | --- | --- |
| `lyrics_prompt` | string | **Yes** |  | The lyrics sung in the generated song. An empty string will generate an instrumental track. |
| `tags` | list<string> | No |  | Tags/styles of the music to generate. You can view a list of all available tags at https://sonauto.ai/tag-explorer. |
...
| `selection_crop` | boolean | No | `false` | Crop to the selected region |
| `sections` | list<InpaintSection> | **Yes** |  | List of sections to inpaint. Currently, only one section is supported so the list length must be 1. |
...
- API page: https://fal.ai/models/sonauto/v2/inpaint/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=sonauto/v2/inpaint
