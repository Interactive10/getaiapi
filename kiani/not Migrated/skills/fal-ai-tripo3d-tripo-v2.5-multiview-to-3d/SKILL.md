---
name: fal-ai-tripo3d-tripo-v2.5-multiview-to-3d
description: >
  Use this skill for the fal.ai Tripo3D model (tripo3d/tripo/v2.5/multiview-to-3d). State of the art Multiview to 3D Object generation. Generate 3D models from multiple images!
---
...
**Source:** https://fal.ai/models/tripo3d/tripo/v2.5/multiview-to-3d/api
...
| `right_image_url` | string | No |  | Right view image of the object. |
...
| `front_image_url` | string | **Yes** |  | Front view image of the object. |
...
| `back_image_url` | string | No |  | Back view image of the object. |
...
| `left_image_url` | string | No |  | Left view image of the object. |
...
- API page: https://fal.ai/models/tripo3d/tripo/v2.5/multiview-to-3d/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=tripo3d/tripo/v2.5/multiview-to-3d
