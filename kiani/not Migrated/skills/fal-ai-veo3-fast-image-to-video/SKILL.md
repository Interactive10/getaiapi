...
description: >
  Use this skill for the fal.ai Veo 3 Fast [Image to Video] model (fal-ai/veo3/fast/image-to-video). Now with a 50% price drop. Generate videos from your image prompts using Veo 3 fast.
---
...
**Source:** https://fal.ai/models/fal-ai/veo3/fast/image-to-video/api
...
- API page: https://fal.ai/models/fal-ai/veo3/fast/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/veo3/fast/image-to-video
