...
description: >
  Use this skill for the fal.ai Veo 3.1 model (fal-ai/veo3.1/first-last-frame-to-video). Generate videos from a first and last framed using Google's Veo 3.1
---
...
**Source:** https://fal.ai/models/fal-ai/veo3.1/first-last-frame-to-video/api
...
- API page: https://fal.ai/models/fal-ai/veo3.1/first-last-frame-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/veo3.1/first-last-frame-to-video
