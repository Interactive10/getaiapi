...
name: fal-ai-veo3
description: >
  Use this skill for the fal.ai Veo 3 model (fal-ai/veo3). Veo 3 by Google, the most advanced AI video generation model in the world. With sound on!
---
...
**Source:** https://fal.ai/models/fal-ai/veo3/api
...
- API page: https://fal.ai/models/fal-ai/veo3/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/veo3
