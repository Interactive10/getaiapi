...
description: >
  Use this skill for the fal.ai VibeVoice 7B model (fal-ai/vibevoice/7b). Generate long, expressive multi-voice speech using Microsoft's powerful TTS
---
...
**Endpoint:** `fal-ai/vibevoice/7b`
**Source:** https://fal.ai/models/fal-ai/vibevoice/7b/api
...
- API page: https://fal.ai/models/fal-ai/vibevoice/7b/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/vibevoice/7b
