...
description: >
  Use this skill for the fal.ai Wan-2.1 Pro Image-to-Video model (fal-ai/wan-pro/image-to-video). Wan-2.1 Pro is a premium image-to-video model that generates high-quality 1080p videos at 30fps with up to 6 seconds duration, delivering exceptional visual quality and motion diversity from images
---
...
**Source:** https://fal.ai/models/fal-ai/wan-pro/image-to-video/api
...
- API page: https://fal.ai/models/fal-ai/wan-pro/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-pro/image-to-video
