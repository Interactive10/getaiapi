...
description: >
  Use this skill for the fal.ai Wan-2.2 Animate Move model (fal-ai/wan/v2.2-14b/animate/move). Wan-Animate is a video model that generates high-fidelity character videos by replicating the expressions and movements of characters from reference videos.
---
...
**Source:** https://fal.ai/models/fal-ai/wan/v2.2-14b/animate/move/api
...
const result = await fal.subscribe("fal-ai/wan/v2.2-14b/animate/move", {
  input: {
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/wan/v2.2-14b/animate/move", {
  input: {
        "video_url": "https://example.com/input.png",
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/wan/v2.2-14b/animate/move", {
...
```javascript
const result = await fal.queue.result("fal-ai/wan/v2.2-14b/animate/move", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/wan/v2.2-14b/animate/move/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan/v2.2-14b/animate/move
