---
name: fal-ai-wan-v2.2-5b-image-to-video
description: >
  Use this skill for the fal.ai Wan v2.2 5B model (fal-ai/wan/v2.2-5b/image-to-video). Wan 2.2's 5B model produces up to 5 seconds of video 720p at 24FPS with fluid motion and powerful prompt understanding
---
...
```javascript
const status = await fal.queue.status("fal-ai/wan/v2.2-5b/image-to-video", {
...
- API page: https://fal.ai/models/fal-ai/wan/v2.2-5b/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan/v2.2-5b/image-to-video
