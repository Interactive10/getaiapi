---
name: fal-ai-wan-v2.2-a14b-text-to-image-lora
description: >
  Use this skill for the fal.ai Wan v2.2 A14B Text-to-Image A14B with LoRAs model (fal-ai/wan/v2.2-a14b/text-to-image/lora). Wan 2.2's 14B model with LoRA support generates high-fidelity images with enhanced prompt alignment, style adaptability.
---
...
**Source:** https://fal.ai/models/fal-ai/wan/v2.2-a14b/text-to-image/lora/api
...
- API page: https://fal.ai/models/fal-ai/wan/v2.2-a14b/text-to-image/lora/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan/v2.2-a14b/text-to-image/lora
