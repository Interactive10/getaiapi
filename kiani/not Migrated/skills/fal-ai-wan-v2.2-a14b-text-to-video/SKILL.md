...
description: >
  Use this skill for the fal.ai Wan-2.2 Text-to-Video A14B model (fal-ai/wan/v2.2-a14b/text-to-video). Wan-2.2 text-to-video is a video model that generates high-quality videos with high visual quality and motion diversity from text prompts.
---
...
**Source:** https://fal.ai/models/fal-ai/wan/v2.2-a14b/text-to-video/api
...
- API page: https://fal.ai/models/fal-ai/wan/v2.2-a14b/text-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan/v2.2-a14b/text-to-video
