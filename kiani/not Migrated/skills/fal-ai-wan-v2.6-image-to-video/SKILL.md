---
name: fal-ai-wan-v2.6-image-to-video
description: >
  Use this skill for the fal.ai Wan v2.6 Image to Video model (wan/v2.6/image-to-video). Wan 2.6 image-to-video model.
---
...
- API page: https://fal.ai/models/wan/v2.6/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=wan/v2.6/image-to-video
