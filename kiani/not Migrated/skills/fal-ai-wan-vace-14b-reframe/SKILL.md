---
name: fal-ai-wan-vace-14b-reframe
description: >
  Use this skill for the fal.ai Wan VACE 14B model (fal-ai/wan-vace-14b/reframe). VACE is a video generation model that uses a source image, mask, and video to create prompted videos with controllable sources.
---
...
**Endpoint:** `fal-ai/wan-vace-14b/reframe`
**Source:** https://fal.ai/models/fal-ai/wan-vace-14b/reframe/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/wan-vace-14b/reframe", {
  input: {
        "video_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/wan-vace-14b/reframe", {
...
```javascript
const result = await fal.queue.result("fal-ai/wan-vace-14b/reframe", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/wan-vace-14b/reframe/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-vace-14b/reframe
