...
description: >
  Use this skill for the fal.ai Wan VACE 14B model (fal-ai/wan-vace-14b). VACE is a video generation model that uses a source image, mask, and video to create prompted videos with controllable sources.
---
...
**Source:** https://fal.ai/models/fal-ai/wan-vace-14b/api
...
| `video_url` | string | null | No |  | URL to the source video file. If provided, the model will use this video as a reference. |
...
| `mask_video_url` | string | null | No |  | URL to the source mask file. If provided, the model will use this mask as a reference. |
...
| `task` | enum: `depth`, `pose`, `inpainting`, `outpainting`, `reframe` | No | `"depth"` | Task type for the model. |
| `mask_image_url` | string | null | No |  | URL to the guiding mask file. If provided, the model will use this mask as a reference to create masked video. If pro... |
...
- API page: https://fal.ai/models/fal-ai/wan-vace-14b/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-vace-14b
