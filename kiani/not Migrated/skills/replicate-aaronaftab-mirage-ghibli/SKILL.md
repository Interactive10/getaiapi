---
name: replicate-aaronaftab-mirage-ghibli
description: >
  Use this skill for the Replicate Mirage Ghibli model (aaronaftab/mirage-ghibli). Use the Mirage Ghibli model via Replicate API.
---

# Mirage Ghibli

**Model:** `aaronaftab/mirage-ghibli`
**Source:** https://replicate.com/aaronaftab/mirage-ghibli
...
output = replicate.run("aaronaftab/mirage-ghibli",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/aaronaftab/mirage-ghibli/predictions \
...
- Model page: https://replicate.com/aaronaftab/mirage-ghibli
- API page: https://replicate.com/aaronaftab/mirage-ghibli/api
