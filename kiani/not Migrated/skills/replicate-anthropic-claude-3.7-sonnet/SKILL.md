...
description: >
  Use this skill for the Replicate Claude 3.7 Sonnet model (anthropic/claude-3.7-sonnet). Use the Claude 3.7 Sonnet model via Replicate API.
---

# Claude 3.7 Sonnet

**Model:** `anthropic/claude-3.7-sonnet`
**Source:** https://replicate.com/anthropic/claude-3.7-sonnet
...
output = replicate.run("anthropic/claude-3.7-sonnet",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/anthropic/claude-3.7-sonnet/predictions \
...
- Model page: https://replicate.com/anthropic/claude-3.7-sonnet
- API page: https://replicate.com/anthropic/claude-3.7-sonnet/api
