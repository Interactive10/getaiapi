...
description: >
  Use this skill for the Replicate Claude 4.5 Sonnet model (anthropic/claude-4.5-sonnet). Use the Claude 4.5 Sonnet model via Replicate API.
---
...
output = replicate.run("anthropic/claude-4.5-sonnet",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/anthropic/claude-4.5-sonnet/predictions \
...
- Model page: https://replicate.com/anthropic/claude-4.5-sonnet
- API page: https://replicate.com/anthropic/claude-4.5-sonnet/api
