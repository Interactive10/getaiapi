...
description: >
  Use this skill for the Replicate Flux 1.1 Pro model (black-forest-labs/flux-1.1-pro). Use the Flux 1.1 Pro model via Replicate API.
---
...
- API page: https://replicate.com/black-forest-labs/flux-1.1-pro/api
