---
name: replicate-black-forest-labs-flux-2-max
description: >
  Use this skill for the Replicate Flux 2 Max model (black-forest-labs/flux-2-max). Use the Flux 2 Max model via Replicate API.
---

# Flux 2 Max

**Model:** `black-forest-labs/flux-2-max`
**Source:** https://replicate.com/black-forest-labs/flux-2-max
**Version:** `c9a020854ba37d5fe801ab712570d7e437b17c148843fe96dbcb7cadd160a8f7`
...
output = replicate.run("black-forest-labs/flux-2-max",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/black-forest-labs/flux-2-max/predictions \
...
- Model page: https://replicate.com/black-forest-labs/flux-2-max
- API page: https://replicate.com/black-forest-labs/flux-2-max/api
