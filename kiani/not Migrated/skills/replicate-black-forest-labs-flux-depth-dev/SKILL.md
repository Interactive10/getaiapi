---
name: replicate-black-forest-labs-flux-depth-dev
description: >
  Use this skill for the Replicate Flux Depth Dev model (black-forest-labs/flux-depth-dev). Use the Flux Depth Dev model via Replicate API.
---

# Flux Depth Dev

**Model:** `black-forest-labs/flux-depth-dev`
**Source:** https://replicate.com/black-forest-labs/flux-depth-dev
...
const output = await replicate.run("black-forest-labs/flux-depth-dev", {
  input: {
...
output = replicate.run("black-forest-labs/flux-depth-dev",
    input={
        "prompt": "your prompt here",
        "control_image": "https://example.com/input.png"
    },
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/black-forest-labs/flux-depth-dev/predictions \
...
| `control_image` | string (URL) | **Yes** |  | Image used to control the generation. The depth map will be automatically generated. |
...
| `guidance` | float | No | `10` | Guidance for generated image |
...
- Model page: https://replicate.com/black-forest-labs/flux-depth-dev
- API page: https://replicate.com/black-forest-labs/flux-depth-dev/api
