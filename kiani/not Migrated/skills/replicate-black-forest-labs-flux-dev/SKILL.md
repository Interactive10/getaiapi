...
description: >
  Use this skill for the Replicate Flux Dev model (black-forest-labs/flux-dev). Use the Flux Dev model via Replicate API.
---

# Flux Dev

**Model:** `black-forest-labs/flux-dev`
**Source:** https://replicate.com/black-forest-labs/flux-dev
...
output = replicate.run("black-forest-labs/flux-dev",
    input={
        "prompt": "your prompt here"
    },
)
...
- Model page: https://replicate.com/black-forest-labs/flux-dev
- API page: https://replicate.com/black-forest-labs/flux-dev/api
