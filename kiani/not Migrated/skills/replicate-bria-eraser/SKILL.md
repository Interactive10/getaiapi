---
name: replicate-bria-eraser
description: >
  Use this skill for the Replicate Eraser model (bria/eraser). Use the Eraser model via Replicate API.
---
...
output = replicate.run("bria/eraser",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/bria/eraser/predictions \
...
- Model page: https://replicate.com/bria/eraser
- API page: https://replicate.com/bria/eraser/api
