---
name: replicate-bria-remove-background
description: >
  Use this skill for the Replicate Remove Background model (bria/remove-background). Use the Remove Background model via Replicate API.
---

# Remove Background

**Model:** `bria/remove-background`
**Source:** https://replicate.com/bria/remove-background
...
output = replicate.run("bria/remove-background",
    input={
        "prompt": "your prompt here"
    },
)
...
| `preserve_partial_alpha` | boolean | No | `true` | [DEPRECATED] Preserve partial alpha. No longer used in V2 API - use preserve_alpha instead. |
...
- API page: https://replicate.com/bria/remove-background/api
