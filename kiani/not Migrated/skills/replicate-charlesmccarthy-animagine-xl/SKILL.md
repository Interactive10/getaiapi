---
name: replicate-charlesmccarthy-animagine-xl
description: >
  Use this skill for the Replicate Animagine Xl model (charlesmccarthy/animagine-xl). Use the Animagine Xl model via Replicate API.
---

# Animagine Xl

**Model:** `charlesmccarthy/animagine-xl`
**Source:** https://replicate.com/charlesmccarthy/animagine-xl
...
const output = await replicate.run("charlesmccarthy/animagine-xl", {
  input: {
...
output = replicate.run("charlesmccarthy/animagine-xl",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/charlesmccarthy/animagine-xl/predictions \
...
- Model page: https://replicate.com/charlesmccarthy/animagine-xl
- API page: https://replicate.com/charlesmccarthy/animagine-xl/api
