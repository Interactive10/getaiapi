---
name: replicate-cjwbw-supir-v0q
description: >
  Use this skill for the Replicate Supir V0Q model (cjwbw/supir-v0q). Use the Supir V0Q model via Replicate API.
---

# Supir V0Q

**Model:** `cjwbw/supir-v0q`
**Source:** https://replicate.com/cjwbw/supir-v0q
...
const output = await replicate.run("cjwbw/supir-v0q", {
  input: {
...
output = replicate.run("cjwbw/supir-v0q",
    input={
        "image": "https://example.com/input.png"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/cjwbw/supir-v0q/predictions \
...
- Model page: https://replicate.com/cjwbw/supir-v0q
- API page: https://replicate.com/cjwbw/supir-v0q/api
