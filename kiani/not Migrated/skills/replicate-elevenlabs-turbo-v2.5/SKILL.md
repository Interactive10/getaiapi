---
name: replicate-elevenlabs-turbo-v2.5
description: >
  Use this skill for the Replicate Turbo V2.5 model (elevenlabs/turbo-v2.5). Use the Turbo V2.5 model via Replicate API.
---

# Turbo V2.5

**Model:** `elevenlabs/turbo-v2.5`
**Source:** https://replicate.com/elevenlabs/turbo-v2.5
**Version:** `bdab64445fa0fb0ade1c2ae20d00f3024104afe3ff8b4572fc487de30fb24bf0`
...
output = replicate.run("elevenlabs/turbo-v2.5",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/elevenlabs/turbo-v2.5/predictions \
...
- Model page: https://replicate.com/elevenlabs/turbo-v2.5
- API page: https://replicate.com/elevenlabs/turbo-v2.5/api
