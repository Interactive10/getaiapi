---
name: replicate-fewjative-ultimate-sd-upscale
description: >
  Use this skill for the Replicate Ultimate Sd Upscale model (fewjative/ultimate-sd-upscale). Use the Ultimate Sd Upscale model via Replicate API.
---

# Ultimate Sd Upscale

**Model:** `fewjative/ultimate-sd-upscale`
**Source:** https://replicate.com/fewjative/ultimate-sd-upscale
...
const output = await replicate.run("fewjative/ultimate-sd-upscale", {
  input: {
...
output = replicate.run("fewjative/ultimate-sd-upscale",
    input={
        "image": "https://example.com/input.png"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/fewjative/ultimate-sd-upscale/predictions \
...
| `positive_prompt` | string | No | `"Hey! Have a nice day :D"` | Positive Prompt |
| `negative_prompt` | string | No | `""` | Negative Prompt |
| `upscaler` | enum: `4x_NMKD-Siax_200k`, `4x-UltraSharp`, `RealESRGAN_x4plus`, `RealESRGAN_x4plus_anime_6B` | No | `"4x-UltraSharp"` | Upscaler |
...
- Model page: https://replicate.com/fewjative/ultimate-sd-upscale
- API page: https://replicate.com/fewjative/ultimate-sd-upscale/api
