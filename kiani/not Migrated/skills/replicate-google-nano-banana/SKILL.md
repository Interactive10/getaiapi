---
name: replicate-google-nano-banana
description: >
  Use this skill for the Replicate Nano Banana model (google/nano-banana). Use the Nano Banana model via Replicate API.
---
...
output = replicate.run("google/nano-banana",
    input={
        "prompt": "your prompt here"
    },
)
...
- API page: https://replicate.com/google/nano-banana/api
