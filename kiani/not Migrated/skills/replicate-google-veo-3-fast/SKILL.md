---
name: replicate-google-veo-3-fast
description: >
  Use this skill for the Replicate Veo 3 Fast model (google/veo-3-fast). Use the Veo 3 Fast model via Replicate API.
---

# Veo 3 Fast

**Model:** `google/veo-3-fast`
**Source:** https://replicate.com/google/veo-3-fast
**Version:** `368d4063e21ecf73746b8e6d27989837d97ba07b5eca43a4e5488c852e10c2ec`
...
output = replicate.run("google/veo-3-fast",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/google/veo-3-fast/predictions \
...
- Model page: https://replicate.com/google/veo-3-fast
- API page: https://replicate.com/google/veo-3-fast/api
