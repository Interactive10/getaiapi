---
name: replicate-ibm-granite-granite-20b-code-instruct-8k
description: >
  Use this skill for the Replicate Granite 20B Code Instruct 8K model (ibm-granite/granite-20b-code-instruct-8k). Use the Granite 20B Code Instruct 8K model via Replicate API.
---

# Granite 20B Code Instruct 8K

**Model:** `ibm-granite/granite-20b-code-instruct-8k`
**Source:** https://replicate.com/ibm-granite/granite-20b-code-instruct-8k
**Version:** `409a0c68b74df416c7ae2a3f1552101123356f5a2c6e46d681629b62904c605b`
...
const output = await replicate.run("ibm-granite/granite-20b-code-instruct-8k", {
  input: {
...
output = replicate.run("ibm-granite/granite-20b-code-instruct-8k",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/ibm-granite/granite-20b-code-instruct-8k/predictions \
...
- Model page: https://replicate.com/ibm-granite/granite-20b-code-instruct-8k
- API page: https://replicate.com/ibm-granite/granite-20b-code-instruct-8k/api
