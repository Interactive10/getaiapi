---
name: replicate-ibm-granite-granite-vision-3.3-2b
description: >
  Use this skill for the Replicate Granite Vision 3.3 2B model (ibm-granite/granite-vision-3.3-2b). Use the Granite Vision 3.3 2B model via Replicate API.
---

# Granite Vision 3.3 2B

**Model:** `ibm-granite/granite-vision-3.3-2b`
**Source:** https://replicate.com/ibm-granite/granite-vision-3.3-2b
...
const output = await replicate.run("ibm-granite/granite-vision-3.3-2b", {
  input: {
...
output = replicate.run("ibm-granite/granite-vision-3.3-2b",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/ibm-granite/granite-vision-3.3-2b/predictions \
...
| `images` | list<> | No |  | Image inputs for the model. |
| `image` | string (URL) | No |  | Deprecated single image input.Use images input instead.Ignored if images used. |
...
- Model page: https://replicate.com/ibm-granite/granite-vision-3.3-2b
- API page: https://replicate.com/ibm-granite/granite-vision-3.3-2b/api
