---
name: replicate-ideogram-ai-ideogram-v2-turbo
description: >
  Use this skill for the Replicate Ideogram V2 Turbo model (ideogram-ai/ideogram-v2-turbo). Use the Ideogram V2 Turbo model via Replicate API.
---

# Ideogram V2 Turbo

**Model:** `ideogram-ai/ideogram-v2-turbo`
**Source:** https://replicate.com/ideogram-ai/ideogram-v2-turbo
**Version:** `7cef9d520d672bb802588ad0d13151bc51aee9a408c270aebf25d6530045dd29`
...
output = replicate.run("ideogram-ai/ideogram-v2-turbo",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/ideogram-ai/ideogram-v2-turbo/predictions \
...
- Model page: https://replicate.com/ideogram-ai/ideogram-v2-turbo
- API page: https://replicate.com/ideogram-ai/ideogram-v2-turbo/api
