---
name: replicate-ideogram-ai-ideogram-v3-balanced
description: >
  Use this skill for the Replicate Ideogram V3 Balanced model (ideogram-ai/ideogram-v3-balanced). Use the Ideogram V3 Balanced model via Replicate API.
---

# Ideogram V3 Balanced

**Model:** `ideogram-ai/ideogram-v3-balanced`
**Source:** https://replicate.com/ideogram-ai/ideogram-v3-balanced
**Version:** `41f9f0d4bf6c470dd0f5085dadc6c14ffb8ed4ce1f6bffbbc10b03ecf5b053fb`
...
const output = await replicate.run("ideogram-ai/ideogram-v3-balanced", {
  input: {
...
output = replicate.run("ideogram-ai/ideogram-v3-balanced",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/ideogram-ai/ideogram-v3-balanced/predictions \
...
- Model page: https://replicate.com/ideogram-ai/ideogram-v3-balanced
- API page: https://replicate.com/ideogram-ai/ideogram-v3-balanced/api
