---
name: replicate-kwaivgi-kling-v1.6-pro
description: >
  Use this skill for the Replicate Kling V1.6 Pro model (kwaivgi/kling-v1.6-pro). Use the Kling V1.6 Pro model via Replicate API.
---

# Kling V1.6 Pro

**Model:** `kwaivgi/kling-v1.6-pro`
**Source:** https://replicate.com/kwaivgi/kling-v1.6-pro
**Version:** `974c9c5bc69f8f9c178ddea80d8936ba46c48081ad6b6ccca8843d44010c0642`
...
output = replicate.run("kwaivgi/kling-v1.6-pro",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/kwaivgi/kling-v1.6-pro/predictions \
...
- Model page: https://replicate.com/kwaivgi/kling-v1.6-pro
- API page: https://replicate.com/kwaivgi/kling-v1.6-pro/api
