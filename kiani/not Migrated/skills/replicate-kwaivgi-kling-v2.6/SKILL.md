---
name: replicate-kwaivgi-kling-v2.6
description: >
  Use this skill for the Replicate Kling V2.6 model (kwaivgi/kling-v2.6). Use the Kling V2.6 model via Replicate API.
---
...
output = replicate.run("kwaivgi/kling-v2.6",
    input={
        "prompt": "your prompt here"
    },
)
...
| `generate_audio` | boolean | No | `true` | Generate audio for the video. When enabled, the model will create synchronized audio based on the video content. |
...
- Model page: https://replicate.com/kwaivgi/kling-v2.6
- API page: https://replicate.com/kwaivgi/kling-v2.6/api
