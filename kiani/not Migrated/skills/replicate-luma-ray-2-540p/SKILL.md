---
name: replicate-luma-ray-2-540p
description: >
  Use this skill for the Replicate Ray 2 540P model (luma/ray-2-540p). Use the Ray 2 540P model via Replicate API.
---

# Ray 2 540P

**Model:** `luma/ray-2-540p`
**Source:** https://replicate.com/luma/ray-2-540p
**Version:** `838565ddabd524ed2b1ab8011d811956b954b8f3716c7a15853fd326e826b6c7`
...
const output = await replicate.run("luma/ray-2-540p", {
  input: {
...
output = replicate.run("luma/ray-2-540p",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/luma/ray-2-540p/predictions \
...
- Model page: https://replicate.com/luma/ray-2-540p
- API page: https://replicate.com/luma/ray-2-540p/api
