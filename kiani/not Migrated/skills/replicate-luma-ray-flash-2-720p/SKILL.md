---
name: replicate-luma-ray-flash-2-720p
description: >
  Use this skill for the Replicate Ray Flash 2 720P model (luma/ray-flash-2-720p). Use the Ray Flash 2 720P model via Replicate API.
---

# Ray Flash 2 720P

**Model:** `luma/ray-flash-2-720p`
**Source:** https://replicate.com/luma/ray-flash-2-720p
**Version:** `4de59b4688ad158409be13c0c0c37ddfcf21824b2acf326505b03bcf679acab5`
...
output = replicate.run("luma/ray-flash-2-720p",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/luma/ray-flash-2-720p/predictions \
...
- Model page: https://replicate.com/luma/ray-flash-2-720p
- API page: https://replicate.com/luma/ray-flash-2-720p/api
