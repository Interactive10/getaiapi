...
description: >
  Use this skill for the Replicate Llama 2 70B Chat model (meta/llama-2-70b-chat). Use the Llama 2 70B Chat model via Replicate API.
---

# Llama 2 70B Chat

**Model:** `meta/llama-2-70b-chat`
**Source:** https://replicate.com/meta/llama-2-70b-chat
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/meta/llama-2-70b-chat/predictions \
...
- Model page: https://replicate.com/meta/llama-2-70b-chat
- API page: https://replicate.com/meta/llama-2-70b-chat/api
