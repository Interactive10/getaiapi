...
description: >
  Use this skill for the Replicate Llama 2 7B model (meta/llama-2-7b). Use the Llama 2 7B model via Replicate API.
---

# Llama 2 7B

**Model:** `meta/llama-2-7b`
**Source:** https://replicate.com/meta/llama-2-7b
**Version:** `527827021d8756c7ab79fde0abbfaac885c37a3ed5fe23c7465093f0878d55ef`
...
const output = await replicate.run("meta/llama-2-7b", {
  input: {
...
output = replicate.run("meta/llama-2-7b",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/meta/llama-2-7b/predictions \
...
- Model page: https://replicate.com/meta/llama-2-7b
- API page: https://replicate.com/meta/llama-2-7b/api
