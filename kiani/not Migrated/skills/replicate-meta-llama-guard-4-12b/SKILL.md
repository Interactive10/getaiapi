---
name: replicate-meta-llama-guard-4-12b
description: >
  Use this skill for the Replicate Llama Guard 4 12B model (meta/llama-guard-4-12b). Use the Llama Guard 4 12B model via Replicate API.
---

# Llama Guard 4 12B

**Model:** `meta/llama-guard-4-12b`
**Source:** https://replicate.com/meta/llama-guard-4-12b
...
const output = await replicate.run("meta/llama-guard-4-12b", {
  input: {
...
output = replicate.run("meta/llama-guard-4-12b",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/meta/llama-guard-4-12b/predictions \
...
| `max_completion_tokens` | integer | No | `512` | Maximum number of completion tokens to generate |
...
- Model page: https://replicate.com/meta/llama-guard-4-12b
- API page: https://replicate.com/meta/llama-guard-4-12b/api
