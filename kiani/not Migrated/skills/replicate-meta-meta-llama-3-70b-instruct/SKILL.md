---
name: replicate-meta-meta-llama-3-70b-instruct
description: >
  Use this skill for the Replicate Meta Llama 3 70B Instruct model (meta/meta-llama-3-70b-instruct). Use the Meta Llama 3 70B Instruct model via Replicate API.
---
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/meta/meta-llama-3-70b-instruct/predictions \
...
- Model page: https://replicate.com/meta/meta-llama-3-70b-instruct
- API page: https://replicate.com/meta/meta-llama-3-70b-instruct/api
