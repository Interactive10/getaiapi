---
name: replicate-meta-meta-llama-3-70b
description: >
  Use this skill for the Replicate Meta Llama 3 70B model (meta/meta-llama-3-70b). Use the Meta Llama 3 70B model via Replicate API.
---

# Meta Llama 3 70B

**Model:** `meta/meta-llama-3-70b`
**Source:** https://replicate.com/meta/meta-llama-3-70b
**Version:** `83c5bdea9941e83be68480bd06ad792f3f295612a24e4678baed34083083a87f`
...
const output = await replicate.run("meta/meta-llama-3-70b", {
  input: {
...
output = replicate.run("meta/meta-llama-3-70b",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/meta/meta-llama-3-70b/predictions \
...
- Model page: https://replicate.com/meta/meta-llama-3-70b
- API page: https://replicate.com/meta/meta-llama-3-70b/api
