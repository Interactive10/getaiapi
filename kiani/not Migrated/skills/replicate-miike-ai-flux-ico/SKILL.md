---
name: replicate-miike-ai-flux-ico
description: >
  Use this skill for the Replicate Flux Ico model (miike-ai/flux-ico). Use the Flux Ico model via Replicate API.
---

# Flux Ico

**Model:** `miike-ai/flux-ico`
**Source:** https://replicate.com/miike-ai/flux-ico
**Version:** `478cae37f1aec0fde7977fdd54b272aaeabede7d8060801841920c16306369a9`
...
const output = await replicate.run("miike-ai/flux-ico", {
  input: {
...
output = replicate.run("miike-ai/flux-ico",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/miike-ai/flux-ico/predictions \
...
- Model page: https://replicate.com/miike-ai/flux-ico
- API page: https://replicate.com/miike-ai/flux-ico/api
