---
name: replicate-minimax-speech-02-hd
description: >
  Use this skill for the Replicate Speech 02 Hd model (minimax/speech-02-hd). Use the Speech 02 Hd model via Replicate API.
---

# Speech 02 Hd

**Model:** `minimax/speech-02-hd`
**Source:** https://replicate.com/minimax/speech-02-hd
...
output = replicate.run("minimax/speech-02-hd",
    input={
        "text": "your value here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/minimax/speech-02-hd/predictions \
...
- Model page: https://replicate.com/minimax/speech-02-hd
- API page: https://replicate.com/minimax/speech-02-hd/api
