...
description: >
  Use this skill for the Replicate Speech 2.8 Hd model (minimax/speech-2.8-hd). Use the Speech 2.8 Hd model via Replicate API.
---

# Speech 2.8 Hd

**Model:** `minimax/speech-2.8-hd`
**Source:** https://replicate.com/minimax/speech-2.8-hd
**Version:** `bb4b16034cd66abe0d3147d50a63890e0144328136ca082f3f141f42ed0d4be9`
...
const output = await replicate.run("minimax/speech-2.8-hd", {
  input: {
...
output = replicate.run("minimax/speech-2.8-hd",
    input={
        "text": "your value here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/minimax/speech-2.8-hd/predictions \
...
- Model page: https://replicate.com/minimax/speech-2.8-hd
- API page: https://replicate.com/minimax/speech-2.8-hd/api
