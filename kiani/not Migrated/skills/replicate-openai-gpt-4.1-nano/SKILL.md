...
description: >
  Use this skill for the Replicate Gpt 4.1 Nano model (openai/gpt-4.1-nano). Use the Gpt 4.1 Nano model via Replicate API.
---

# Gpt 4.1 Nano

**Model:** `openai/gpt-4.1-nano`
**Source:** https://replicate.com/openai/gpt-4.1-nano
**Version:** `756e9851b24d755bc245572b53d1f40121719eed75663c38ea6628202720a54b`
...
const output = await replicate.run("openai/gpt-4.1-nano", {
  input: {
...
output = replicate.run("openai/gpt-4.1-nano",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/openai/gpt-4.1-nano/predictions \
...
- Model page: https://replicate.com/openai/gpt-4.1-nano
- API page: https://replicate.com/openai/gpt-4.1-nano/api
