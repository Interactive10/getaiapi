...
description: >
  Use this skill for the Replicate Gpt 4O model (openai/gpt-4o). Use the Gpt 4O model via Replicate API.
---

# Gpt 4O

**Model:** `openai/gpt-4o`
**Source:** https://replicate.com/openai/gpt-4o
**Version:** `42f4eb858641c70ce390c381605f5aed04eeb37554d299459429e14a33f88933`
...
output = replicate.run("openai/gpt-4o",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/openai/gpt-4o/predictions \
...
- Model page: https://replicate.com/openai/gpt-4o
- API page: https://replicate.com/openai/gpt-4o/api
