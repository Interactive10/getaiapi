---
name: replicate-openai-gpt-5.1
description: >
  Use this skill for the Replicate Gpt 5.1 model (openai/gpt-5.1). Use the Gpt 5.1 model via Replicate API.
---

# Gpt 5.1

**Model:** `openai/gpt-5.1`
**Source:** https://replicate.com/openai/gpt-5.1
**Version:** `6fefc0acd5f42b1112d3e5dd57b42823e68b2ce68cad753eed05d24a96e2d35b`
...
const output = await replicate.run("openai/gpt-5.1", {
  input: {
...
output = replicate.run("openai/gpt-5.1",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/openai/gpt-5.1/predictions \
...
| `reasoning_effort` | enum: `none`, `low`, `medium`, `high` | No | `"none"` | Constrains effort on reasoning for GPT-5.1. Supported values are none, low, medium, and high. |
...
- Model page: https://replicate.com/openai/gpt-5.1
- API page: https://replicate.com/openai/gpt-5.1/api
