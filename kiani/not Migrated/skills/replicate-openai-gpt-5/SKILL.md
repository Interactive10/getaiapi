...
description: >
  Use this skill for the Replicate Gpt 5 model (openai/gpt-5). Use the Gpt 5 model via Replicate API.
---

# Gpt 5

**Model:** `openai/gpt-5`
**Source:** https://replicate.com/openai/gpt-5
**Version:** `feacd077889bbeea463bb0314810093c23b2e1b49af8ca6f82975f8c36a2ebd0`
...
output = replicate.run("openai/gpt-5",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/openai/gpt-5/predictions \
...
- Model page: https://replicate.com/openai/gpt-5
- API page: https://replicate.com/openai/gpt-5/api
