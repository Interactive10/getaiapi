---
name: replicate-pixverse-pixverse-v3.5
description: >
  Use this skill for the Replicate Pixverse V3.5 model (pixverse/pixverse-v3.5). Use the Pixverse V3.5 model via Replicate API.
---

# Pixverse V3.5

**Model:** `pixverse/pixverse-v3.5`
**Source:** https://replicate.com/pixverse/pixverse-v3.5
**Version:** `ea0d7f0a2654cfdd794faef1a074b6251d94de38aecc34ffdf725dcc88af6fb5`
...
const output = await replicate.run("pixverse/pixverse-v3.5", {
  input: {
...
output = replicate.run("pixverse/pixverse-v3.5",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/pixverse/pixverse-v3.5/predictions \
...
- Model page: https://replicate.com/pixverse/pixverse-v3.5
- API page: https://replicate.com/pixverse/pixverse-v3.5/api
