---
name: replicate-pixverse-pixverse-v4.5
description: >
  Use this skill for the Replicate Pixverse V4.5 model (pixverse/pixverse-v4.5). Use the Pixverse V4.5 model via Replicate API.
---

# Pixverse V4.5

**Model:** `pixverse/pixverse-v4.5`
**Source:** https://replicate.com/pixverse/pixverse-v4.5
**Version:** `5a31b090decb67bde4291ca5d2a69d7908720c0a1262a4b5d72022518a9b5a3c`
...
const output = await replicate.run("pixverse/pixverse-v4.5", {
  input: {
...
output = replicate.run("pixverse/pixverse-v4.5",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/pixverse/pixverse-v4.5/predictions \
...
- Model page: https://replicate.com/pixverse/pixverse-v4.5
- API page: https://replicate.com/pixverse/pixverse-v4.5/api
