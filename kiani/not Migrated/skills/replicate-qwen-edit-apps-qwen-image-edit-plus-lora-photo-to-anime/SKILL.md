---
name: replicate-qwen-edit-apps-qwen-image-edit-plus-lora-photo-to-anime
description: >
  Use this skill for the Replicate Qwen Image Edit Plus Lora Photo To Anime model (qwen-edit-apps/qwen-image-edit-plus-lora-photo-to-anime). Use the Qwen Image Edit Plus Lora Photo To Anime model via Replicate API.
---

# Qwen Image Edit Plus Lora Photo To Anime

**Model:** `qwen-edit-apps/qwen-image-edit-plus-lora-photo-to-anime`
**Source:** https://replicate.com/qwen-edit-apps/qwen-image-edit-plus-lora-photo-to-anime
**Version:** `bc101c8a367f975c528267a275ef0b25574966fdfd73ba17f0ff8c3f570cfea6`
...
const output = await replicate.run("qwen-edit-apps/qwen-image-edit-plus-lora-photo-to-anime", {
  input: {
...
output = replicate.run("qwen-edit-apps/qwen-image-edit-plus-lora-photo-to-anime",
    input={
        "image": "https://example.com/input.png"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/qwen-edit-apps/qwen-image-edit-plus-lora-photo-to-anime/predictions \
...
| `prompt` | string | No | `"transform into anime, clean line art, vibrant cel-shaded colors"` | Prompt hint: `transform into anime` and optionally add style cues (cel shading, energetic lighting, manga line work). |
...
- Model page: https://replicate.com/qwen-edit-apps/qwen-image-edit-plus-lora-photo-to-anime
- API page: https://replicate.com/qwen-edit-apps/qwen-image-edit-plus-lora-photo-to-anime/api
