---
name: replicate-retro-diffusion-rd-fast
description: >
  Use this skill for the Replicate Rd Fast model (retro-diffusion/rd-fast). Use the Rd Fast model via Replicate API.
---

# Rd Fast

**Model:** `retro-diffusion/rd-fast`
**Source:** https://replicate.com/retro-diffusion/rd-fast
**Version:** `067f6cd8a3c5582b4317d462176b75d9cdfae8ae548033220bddd0c19c4a1357`
...
const output = await replicate.run("retro-diffusion/rd-fast", {
  input: {
...
output = replicate.run("retro-diffusion/rd-fast",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/retro-diffusion/rd-fast/predictions \
...
| `style` | enum (15 values) | No | `"default"` | Style to apply to the generated image  default: Simple clean pixel art, with Anime illustration influences simple: Si... |
...
- Model page: https://replicate.com/retro-diffusion/rd-fast
- API page: https://replicate.com/retro-diffusion/rd-fast/api
