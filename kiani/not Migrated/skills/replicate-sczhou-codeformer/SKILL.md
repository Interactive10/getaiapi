---
name: replicate-sczhou-codeformer
description: >
  Use this skill for the Replicate Codeformer model (sczhou/codeformer). Use the Codeformer model via Replicate API.
---

# Codeformer

**Model:** `sczhou/codeformer`
**Source:** https://replicate.com/sczhou/codeformer
...
const output = await replicate.run("sczhou/codeformer", {
  input: {
...
output = replicate.run("sczhou/codeformer",
    input={
        "image": "https://example.com/input.png"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/sczhou/codeformer/predictions \
...
- API page: https://replicate.com/sczhou/codeformer/api
