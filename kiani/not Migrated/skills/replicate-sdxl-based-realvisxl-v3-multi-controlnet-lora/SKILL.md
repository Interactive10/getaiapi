---
name: replicate-sdxl-based-realvisxl-v3-multi-controlnet-lora
description: >
  Use this skill for the Replicate Realvisxl V3 Multi Controlnet Lora model (sdxl-based/realvisxl-v3-multi-controlnet-lora). Use the Realvisxl V3 Multi Controlnet Lora model via Replicate API.
---

# Realvisxl V3 Multi Controlnet Lora

**Model:** `sdxl-based/realvisxl-v3-multi-controlnet-lora`
**Source:** https://replicate.com/sdxl-based/realvisxl-v3-multi-controlnet-lora
...
const output = await replicate.run("sdxl-based/realvisxl-v3-multi-controlnet-lora", {
  input: {
...
output = replicate.run("sdxl-based/realvisxl-v3-multi-controlnet-lora",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/sdxl-based/realvisxl-v3-multi-controlnet-lora/predictions \
...
- Model page: https://replicate.com/sdxl-based/realvisxl-v3-multi-controlnet-lora
- API page: https://replicate.com/sdxl-based/realvisxl-v3-multi-controlnet-lora/api
