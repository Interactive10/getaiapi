...
description: >
  Use this skill for the Replicate Lipsync 2 model (sync/lipsync-2). Use the Lipsync 2 model via Replicate API.
---

# Lipsync 2

**Model:** `sync/lipsync-2`
**Source:** https://replicate.com/sync/lipsync-2
**Version:** `3190ef7dc0cbca29458d0032c032ef140a840087141cf10333e8d19a213f9194`
...
output = replicate.run("sync/lipsync-2",
    input={
        "audio": "your value here",
        "video": "https://example.com/input.png"
    },
...
- Model page: https://replicate.com/sync/lipsync-2
- API page: https://replicate.com/sync/lipsync-2/api
