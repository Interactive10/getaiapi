---
name: replicate-wan-video-wan-2.6-i2v
description: >
  Use this skill for the Replicate Wan 2.6 I2V model (wan-video/wan-2.6-i2v). Use the Wan 2.6 I2V model via Replicate API.
---

# Wan 2.6 I2V

**Model:** `wan-video/wan-2.6-i2v`
**Source:** https://replicate.com/wan-video/wan-2.6-i2v
**Version:** `8dee499c1e4c5fe717885d0f52db9b10af3b28a4a29677f1c3091cae0e2c3934`
...
const output = await replicate.run("wan-video/wan-2.6-i2v", {
  input: {
...
output = replicate.run("wan-video/wan-2.6-i2v",
    input={
        "image": "https://example.com/input.png",
        "prompt": "your prompt here"
    },
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/wan-video/wan-2.6-i2v/predictions \
...
- Model page: https://replicate.com/wan-video/wan-2.6-i2v
- API page: https://replicate.com/wan-video/wan-2.6-i2v/api
