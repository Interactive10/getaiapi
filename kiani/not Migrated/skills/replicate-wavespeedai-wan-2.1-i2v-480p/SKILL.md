---
name: replicate-wavespeedai-wan-2.1-i2v-480p
description: >
  Use this skill for the Replicate Wan 2.1 I2V 480P model (wavespeedai/wan-2.1-i2v-480p). Use the Wan 2.1 I2V 480P model via Replicate API.
---

# Wan 2.1 I2V 480P

**Model:** `wavespeedai/wan-2.1-i2v-480p`
**Source:** https://replicate.com/wavespeedai/wan-2.1-i2v-480p
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/wavespeedai/wan-2.1-i2v-480p/predictions \
...
- Model page: https://replicate.com/wavespeedai/wan-2.1-i2v-480p
- API page: https://replicate.com/wavespeedai/wan-2.1-i2v-480p/api
