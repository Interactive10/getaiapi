---
name: replicate-wavespeedai-wan-2.1-t2v-480p
description: >
  Use this skill for the Replicate Wan 2.1 T2V 480P model (wavespeedai/wan-2.1-t2v-480p). Use the Wan 2.1 T2V 480P model via Replicate API.
---
...
output = replicate.run("wavespeedai/wan-2.1-t2v-480p",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/wavespeedai/wan-2.1-t2v-480p/predictions \
...
- Model page: https://replicate.com/wavespeedai/wan-2.1-t2v-480p
- API page: https://replicate.com/wavespeedai/wan-2.1-t2v-480p/api
