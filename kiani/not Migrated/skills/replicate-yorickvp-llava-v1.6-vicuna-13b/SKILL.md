---
name: replicate-yorickvp-llava-v1.6-vicuna-13b
description: >
  Use this skill for the Replicate Llava V1.6 Vicuna 13B model (yorickvp/llava-v1.6-vicuna-13b). Use the Llava V1.6 Vicuna 13B model via Replicate API.
---

# Llava V1.6 Vicuna 13B

**Model:** `yorickvp/llava-v1.6-vicuna-13b`
**Source:** https://replicate.com/yorickvp/llava-v1.6-vicuna-13b
...
const output = await replicate.run("yorickvp/llava-v1.6-vicuna-13b", {
  input: {
...
output = replicate.run("yorickvp/llava-v1.6-vicuna-13b",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/yorickvp/llava-v1.6-vicuna-13b/predictions \
...
- Model page: https://replicate.com/yorickvp/llava-v1.6-vicuna-13b
- API page: https://replicate.com/yorickvp/llava-v1.6-vicuna-13b/api
