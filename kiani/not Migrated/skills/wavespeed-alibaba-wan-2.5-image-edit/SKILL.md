---
name: wavespeed-alibaba-wan-2.5-image-edit
description: >
  Use this skill for the WaveSpeed AI Alibaba WAN 2.5 Image Edit | Prompt-Based Visual Editing model (alibaba/wan-2.5/image-edit). Refine existing visuals with Alibaba WAN 2.5 image-edit using prompt-driven adjustments and stylistic upgrades for photos and graphics. Ready-to-use REST inference API, best performance, no coldstarts
---

# Alibaba WAN 2.5 Image Edit | Prompt-Based Visual Editing
...
**Source:** https://wavespeed.ai/models/alibaba/wan-2.5/image-edit
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/alibaba/wan-2.5/image-edit", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/alibaba/wan-2.5/image-edit",
    headers=HEADERS,
    json={
        "prompt": "your edit prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/alibaba/wan-2.5/image-edit
> - API docs: https://wavespeed.ai/docs/docs-api/alibaba/wan-2.5-image-edit
...
**Additional parameters found on model page:** `Input`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`, `http`
...
**POST** `https://api.wavespeed.ai/api/v3/alibaba/wan-2.5/image-edit`
