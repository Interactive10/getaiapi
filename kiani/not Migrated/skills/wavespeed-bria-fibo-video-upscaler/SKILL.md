---
name: wavespeed-bria-fibo-video-upscaler
description: >
  Use this skill for the WaveSpeed AI Bria Video Upscaler | AI Video Resolution Enhancement model (bria/fibo/video-upscaler). Bria Video Upscaler increases video resolution up to 8K with 2x or 4x upscaling. Ready-to-use REST inference API, best performance, no cold starts, affordable pricing.
---

# Bria Video Upscaler | AI Video Resolution Enhancement
...
**Type:** Upscaler
**Model:** `bria/fibo/video-upscaler`
**Source:** https://wavespeed.ai/models/bria/fibo/video-upscaler
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/bria/fibo/video-upscaler", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/bria/fibo/video-upscaler",
    headers=HEADERS,
    json={
        "video": "https://example.com/input.mp4"
    },
...
> - Model page: https://wavespeed.ai/models/bria/fibo/video-upscaler
> - API docs: https://wavespeed.ai/docs/docs-api/bria/fibo-video-upscaler
...
**POST** `https://api.wavespeed.ai/api/v3/bria/fibo/video-upscaler`
