---
name: wavespeed-bytedance-seedance-v1-pro-i2v-480p
description: >
  Use this skill for the WaveSpeed AI ByteDance Seedance V1 Pro I2V 480p | Image-To-Video Multi-Shot Model model (bytedance/seedance-v1-pro-i2v-480p). ByteDance Seedance v1 Pro i2v (480p) creates coherent multi-shot image-to-video sequences with smooth, stable motion and strong adherence to detailed prompts. Ready-to-use REST inference API, best per
---

# ByteDance Seedance V1 Pro I2V 480p | Image-To-Video Multi-Shot Model
...
**Source:** https://wavespeed.ai/models/bytedance/seedance-v1-pro-i2v-480p
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/bytedance/seedance-v1-pro-i2v-480p", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/bytedance/seedance-v1-pro-i2v-480p",
    headers=HEADERS,
    json={
        "prompt": "your prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/bytedance/seedance-v1-pro-i2v-480p
> - API docs: https://wavespeed.ai/docs/docs-api/bytedance/seedance-v1-pro-i2v-480p
