---
name: wavespeed-elevenlabs-dubbing
description: >
  Use this skill for the WaveSpeed AI ElevenLabs Dubbing | AI Video Audio Translation and Voice Dubbing model (elevenlabs/dubbing). ElevenLabs Dubbing automatically translates and dubs video/audio content into different languages while preserving the original speakers&#x27; voices. Ready-to-use REST inference API, best performance
---

# ElevenLabs Dubbing | AI Video Audio Translation and Voice Dubbing
...
**Source:** https://wavespeed.ai/models/elevenlabs/dubbing
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/elevenlabs/dubbing" \
  -H "Authorization: Bearer $WAVESPEED_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"video": "https://example.com/input.mp4", "target_language": "es"}'
```

### JavaScript Example

```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/elevenlabs/dubbing", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/elevenlabs/dubbing",
    headers=HEADERS,
    json={
        "video": "https://example.com/input.mp4",
        "target_language": "es"
...
> - Model page: https://wavespeed.ai/models/elevenlabs/dubbing
> - API docs: https://wavespeed.ai/docs/docs-api/elevenlabs/dubbing
...
| `target_language` | string | Target language code for translation/dubbing |
...
**Additional parameters found on model page:** `false`, `Auto`, `s`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/elevenlabs/dubbing`
