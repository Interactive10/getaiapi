---
name: wavespeed-elevenlabs-music
description: >
  Use this skill for the WaveSpeed AI ElevenLabs Music | AI Music Generation From Text Prompts model (elevenlabs/music). ElevenLabs Music generates original songs from text descriptions. Create instrumentals or full compositions with customizable duration. Ready-to-use REST inference API, best performance, no cold start
---

# ElevenLabs Music | AI Music Generation From Text Prompts
...
**Source:** https://wavespeed.ai/models/elevenlabs/music
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/elevenlabs/music", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/elevenlabs/music",
    headers=HEADERS,
    json={
        "prompt": "upbeat jazz melody"
    },
...
> - Model page: https://wavespeed.ai/models/elevenlabs/music
> - API docs: https://wavespeed.ai/docs/docs-api/elevenlabs/music
...
**Additional parameters found on model page:** `root_music_length_ms`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/elevenlabs/music`
