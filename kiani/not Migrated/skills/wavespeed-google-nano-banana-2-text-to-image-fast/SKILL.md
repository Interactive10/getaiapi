---
name: wavespeed-google-nano-banana-2-text-to-image-fast
description: >
  Use this skill for the WaveSpeed AI Google Nano Banana 2 Fast | Gemini 3.1 Flash Fast Text-To-Image With 2K &amp; 4K Output model (google/nano-banana-2/text-to-image-fast). Google Nano Banana 2 Fast (Gemini 3.1 Flash Image) is the cheapest Nano Banana 2 option, starting at just $0.045 per image. Delivers fast text-to-image generation with 2K default output and 4K support
---

# Google Nano Banana 2 Fast | Gemini 3.1 Flash Fast Text-To-Image With 2K &amp; 4K Output
...
**Source:** https://wavespeed.ai/models/google/nano-banana-2/text-to-image-fast
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/google/nano-banana-2/text-to-image-fast" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/google/nano-banana-2/text-to-image-fast", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/google/nano-banana-2/text-to-image-fast",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/google/nano-banana-2/text-to-image-fast
> - API docs: https://wavespeed.ai/docs/docs-api/google/nano-banana-2-text-to-image-fast
...
**Additional parameters found on model page:** `Input`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/google/nano-banana-2/text-to-image-fast`
