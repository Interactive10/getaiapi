---
name: wavespeed-google-nano-banana-edit
description: >
  Use this skill for the WaveSpeed AI Nano-Banana | Image Generation &amp; Editing Model model (google/nano-banana/edit). Nano-Banana is an advanced image generation and editing model that produces photorealistic or stylized visuals and performs precise inpainting, outpainting, and background replacement. Ready-to-use RE
---
...
**Source:** https://wavespeed.ai/models/google/nano-banana/edit
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/google/nano-banana/edit",
    headers=HEADERS,
    json={
        "prompt": "your edit prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/google/nano-banana/edit
> - API docs: https://wavespeed.ai/docs/docs-api/google/nano-banana-edit
