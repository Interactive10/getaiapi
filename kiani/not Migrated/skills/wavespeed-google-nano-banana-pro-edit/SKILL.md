---
name: wavespeed-google-nano-banana-pro-edit
description: >
  Use this skill for the WaveSpeed AI Google Nano Banana Pro Edit | 4K Image Editing model (google/nano-banana-pro/edit). Google Nano Banana Pro (Gemini 3.0 Pro Image) Edit enables image editing with 4K-capable output. Ready-to-use REST inference API, best performance, no coldstarts, affordable pricing.
---

# Google Nano Banana Pro Edit | 4K Image Editing
...
**Source:** https://wavespeed.ai/models/google/nano-banana-pro/edit
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/google/nano-banana-pro/edit",
    headers=HEADERS,
    json={
        "prompt": "your edit prompt here",
        "image": "https://example.com/input.png"
...
> - API docs: https://wavespeed.ai/docs/docs-api/google/nano-banana-pro-edit
