---
name: wavespeed-google-nano-banana-pro-text-to-image-ultra
description: >
  Use this skill for the WaveSpeed AI Google Nano Banana Pro T2I Ultra | 8K Text to Image Generation model (google/nano-banana-pro/text-to-image-ultra). Google&#x27;s Nano Banana Pro (Gemini 3.0 Pro Image) is a cutting-edge text-to-image model enabling high-res image generation optimized for phones. Ready-to-use REST inference API, best performance, n
---

# Google Nano Banana Pro T2I Ultra | 8K Text to Image Generation
...
**Source:** https://wavespeed.ai/models/google/nano-banana-pro/text-to-image-ultra
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/google/nano-banana-pro/text-to-image-ultra" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/google/nano-banana-pro/text-to-image-ultra", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/google/nano-banana-pro/text-to-image-ultra",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/google/nano-banana-pro/text-to-image-ultra
> - API docs: https://wavespeed.ai/docs/docs-api/google/nano-banana-pro-text-to-image-ultra
...
**POST** `https://api.wavespeed.ai/api/v3/google/nano-banana-pro/text-to-image-ultra`
