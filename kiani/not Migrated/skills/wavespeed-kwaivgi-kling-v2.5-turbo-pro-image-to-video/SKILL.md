---
name: wavespeed-kwaivgi-kling-v2.5-turbo-pro-image-to-video
description: >
  Use this skill for the WaveSpeed AI Kling 2.5 Turbo Pro | Image-To-Video With Cinematic Motion And Prompt Precision model (kwaivgi/kling-v2.5-turbo-pro/image-to-video). Kling 2.5 Turbo Pro converts images to cinematic videos with fluid motion, dynamic effects, and precise prompt-driven motion for seamless transitions. Ready-to-use REST inference API, best performance
---

# Kling 2.5 Turbo Pro | Image-To-Video With Cinematic Motion And Prompt Precision
...
**Source:** https://wavespeed.ai/models/kwaivgi/kling-v2.5-turbo-pro/image-to-video
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/kwaivgi/kling-v2.5-turbo-pro/image-to-video", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/kwaivgi/kling-v2.5-turbo-pro/image-to-video",
    headers=HEADERS,
    json={
        "prompt": "your prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/kwaivgi/kling-v2.5-turbo-pro/image-to-video
> - API docs: https://wavespeed.ai/docs/docs-api/kwaivgi/kling-v2.5-turbo-pro-image-to-video
...
**Additional parameters found on model page:** `Input`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`, `breathing`
...
**POST** `https://api.wavespeed.ai/api/v3/kwaivgi/kling-v2.5-turbo-pro/image-to-video`
