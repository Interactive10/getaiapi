---
name: wavespeed-kwaivgi-kling-video-to-audio
description: >
  Use this skill for the WaveSpeed AI Kling Video-To-Audio | Auto Generate Sound Effects From Video model (kwaivgi/kling-video-to-audio). Kling Video-to-Audio auto-generates or extracts matching sound effects and audio tracks from video using KlingAI&#x27;s audio generation model. Ready-to-use REST API, best performance, no coldstarts, 
---

# Kling Video-To-Audio | Auto Generate Sound Effects From Video
...
**Source:** https://wavespeed.ai/models/kwaivgi/kling-video-to-audio
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/kwaivgi/kling-video-to-audio" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/kwaivgi/kling-video-to-audio", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/kwaivgi/kling-video-to-audio",
    headers=HEADERS,
    json={
        "video": "https://example.com/input.mp4"
    },
...
> - Model page: https://wavespeed.ai/models/kwaivgi/kling-video-to-audio
> - API docs: https://wavespeed.ai/docs/docs-api/kwaivgi/kling-video-to-audio
...
**Additional parameters found on model page:** `Input`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`, `ht`, `fwoosh`, `whoosh`
...
**POST** `https://api.wavespeed.ai/api/v3/kwaivgi/kling-video-to-audio`
