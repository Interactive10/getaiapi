---
name: wavespeed-wavespeed-ai-ace-step-1.5
description: >
  Use this skill for the WaveSpeed AI ACE-Step 1.5 | AI Music Generation With Lyrics in 50+ Languages model (wavespeed-ai/ace-step-1.5). ACE-Step 1.5 generates up to 4-minute music with lyrics from text. Supports 50+ languages, high acoustic fidelity, and runs efficiently on consumer hardware. Ready-to-use REST inference API, best perf
---

# ACE-Step 1.5 | AI Music Generation With Lyrics in 50+ Languages
...
**Model:** `wavespeed-ai/ace-step-1.5`
**Source:** https://wavespeed.ai/models/wavespeed-ai/ace-step-1.5
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/ace-step-1.5" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/ace-step-1.5", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/ace-step-1.5",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/ace-step-1.5
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/ace-step-1.5
...
**Additional parameters found on model page:** `root_duration`, `Input`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
