---
name: wavespeed-wavespeed-ai-longcat-avatar
description: >
  Use this skill for the WaveSpeed AI LongCat Avatar | Audio-Driven Avatar Lipsync Image-To-Video 720P Conversational AI model (wavespeed-ai/longcat-avatar). LongCat Avatar produces super-realistic, lip-synchronized long video generation with natural dynamics and consistent identity. Converts one photo + audio into audio-driven talking or singing avatar vi
---

# LongCat Avatar | Audio-Driven Avatar Lipsync Image-To-Video 720P Conversational AI
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/longcat-avatar
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/longcat-avatar" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/longcat-avatar", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/longcat-avatar",
    headers=HEADERS,
    json={
        "image": "https://example.com/portrait.png",
        "audio": "https://example.com/audio.wav"
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/longcat-avatar
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/longcat-avatar
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/longcat-avatar`
