---
name: wavespeed-wavespeed-ai-ltx-2-19b-control
description: >
  Use this skill for the WaveSpeed AI LTX-2 19B ControlNet | Video-To-Video With Pose Depth Canny Control model (wavespeed-ai/ltx-2-19b/control). LTX-2 19B ControlNet generates synchronized audio-video (up to 20s) from video input with pose, depth, or canny edge guidance. Supports audio preservation, generation, or removal for flexible video tr
---

# LTX-2 19B ControlNet | Video-To-Video With Pose Depth Canny Control
...
**Model:** `wavespeed-ai/ltx-2-19b/control`
**Source:** https://wavespeed.ai/models/wavespeed-ai/ltx-2-19b/control
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/ltx-2-19b/control", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/ltx-2-19b/control",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/ltx-2-19b/control
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/ltx-2-19b-control
...
**Additional parameters found on model page:** `canonical`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/ltx-2-19b/control`
