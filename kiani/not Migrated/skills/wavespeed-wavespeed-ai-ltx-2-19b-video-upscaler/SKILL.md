---
name: wavespeed-wavespeed-ai-ltx-2-19b-video-upscaler
description: >
  Use this skill for the WaveSpeed AI LTX-2 19B Video Upscaler | 4K Video Enhancement &amp; Frame Consistency model (wavespeed-ai/ltx-2-19b/video-upscaler). LTX-2 19B Video Upscaler converts low-resolution videos into crisp 4K footage with seamless motion dynamics and frame consistency. Ready-to-use REST inference API, best performance, no cold starts, af
---

# LTX-2 19B Video Upscaler | 4K Video Enhancement &amp; Frame Consistency
...
**Type:** Upscaler
**Model:** `wavespeed-ai/ltx-2-19b/video-upscaler`
**Source:** https://wavespeed.ai/models/wavespeed-ai/ltx-2-19b/video-upscaler
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/ltx-2-19b/video-upscaler" \
  -H "Authorization: Bearer $WAVESPEED_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"video": "https://example.com/input.mp4"}'
```

### JavaScript Example

```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/ltx-2-19b/video-upscaler", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/ltx-2-19b/video-upscaler",
    headers=HEADERS,
    json={
        "video": "https://example.com/input.mp4"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/ltx-2-19b/video-upscaler
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/ltx-2-19b-video-upscaler
...
**Additional parameters found on model page:** `false`, `s`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/ltx-2-19b/video-upscaler`
