---
name: wavespeed-wavespeed-ai-molmo2-image-content-moderator
description: >
  Use this skill for the WaveSpeed AI Molmo2-4B Image Content Moderator | AI Image Safety Analysis &amp; Visual Content Moderation model (wavespeed-ai/molmo2/image-content-moderator). Molmo2-4B Image Content Moderator: Analyze image content for safety, appropriateness, and policy compliance. Detects violence, nudity, gore, and other harmful visual content. Open-source vision-langua
---

# Molmo2-4B Image Content Moderator | AI Image Safety Analysis &amp; Visual Content Moderation
...
**Model:** `wavespeed-ai/molmo2/image-content-moderator`
**Source:** https://wavespeed.ai/models/wavespeed-ai/molmo2/image-content-moderator
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/molmo2/image-content-moderator" \
  -H "Authorization: Bearer $WAVESPEED_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"image": "https://example.com/input.png"}'
```

### JavaScript Example

```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/molmo2/image-content-moderator", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/molmo2/image-content-moderator",
    headers=HEADERS,
    json={
        "image": "https://example.com/input.png"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/molmo2/image-content-moderator
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/molmo2-image-content-moderator
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/molmo2/image-content-moderator`
