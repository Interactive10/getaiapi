---
name: wavespeed-wavespeed-ai-qwen-image-edit-multiple-angles
description: >
  Use this skill for the WaveSpeed AI Qwen Image Edit Multiple Angles | Multi-View Image Generation | AI Camera Angle Control model (wavespeed-ai/qwen-image/edit-multiple-angles). Generate specific camera angles from a single image using a 96-pose camera system. Control horizontal rotation, vertical tilt, and zoom to create front, side, back views and more. Ready-to-use REST in
---

# Qwen Image Edit Multiple Angles | Multi-View Image Generation | AI Camera Angle Control
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/qwen-image/edit-multiple-angles
...
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/edit-multiple-angles" \
  ...
  -d '{"prompt": "your edit prompt here", "image": "https://example.com/input.png"}'
```

### JavaScript Example

```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/edit-multiple-angles", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/edit-multiple-angles",
    headers=HEADERS,
    json={
        "prompt": "your edit prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/qwen-image/edit-multiple-angles
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/qwen-image-edit-multiple-angles
...
**Additional parameters found on model page:** `Input`, `Button`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/edit-multiple-angles`
