---
name: wavespeed-wavespeed-ai-qwen-image-text-to-image
description: >
  Use this skill for the WaveSpeed AI Qwen-Image 20B MMDiT | Next-Gen Text-To-Image Generation model (wavespeed-ai/qwen-image/text-to-image). Qwen-Image is a 20B MMDiT next-gen text-to-image model that generates images from text prompts. Ready-to-use REST inference API, best performance, no coldstarts, affordable pricing.
---

# Qwen-Image 20B MMDiT | Next-Gen Text-To-Image Generation
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/qwen-image/text-to-image
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/text-to-image", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/text-to-image",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/qwen-image/text-to-image
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/qwen-image-text-to-image
...
**Additional parameters found on model page:** `Input`, `1024`, `Button`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/text-to-image`
