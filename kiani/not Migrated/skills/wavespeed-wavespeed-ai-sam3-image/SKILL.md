---
name: wavespeed-wavespeed-ai-sam3-image
description: >
  Use this skill for the WaveSpeed AI SAM 3 | AI Image Segmentation With Text and Visual Prompts model (wavespeed-ai/sam3-image). SAM 3 is a unified foundation model for promptable image segmentation using text, points, or boxes to detect and segment objects. Ready-to-use REST inference API, best performance, no coldstarts, affo
---

# SAM 3 | AI Image Segmentation With Text and Visual Prompts
...
**Model:** `wavespeed-ai/sam3-image`
**Source:** https://wavespeed.ai/models/wavespeed-ai/sam3-image
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/sam3-image" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/sam3-image", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/sam3-image",
    headers=HEADERS,
    json={
        "image": "https://example.com/input.png"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/sam3-image
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/sam3-image
...
**Additional parameters found on model page:** `Input`, `root_box_prompts`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/sam3-image`
