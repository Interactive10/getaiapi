---
name: wavespeed-wavespeed-ai-sam3-video-rle
description: >
  Use this skill for the WaveSpeed AI SAM 3 Video RLE | AI Video Segmentation With RLE Encoded Mask Output model (wavespeed-ai/sam3-video-rle). SAM 3 Video RLE is a unified foundation model for prompt-based segmentation in video. Track and segment objects across frames using text, points, or boxes, returning RLE encoded masks for efficient pr
---

# SAM 3 Video RLE | AI Video Segmentation With RLE Encoded Mask Output
...
**Model:** `wavespeed-ai/sam3-video-rle`
**Source:** https://wavespeed.ai/models/wavespeed-ai/sam3-video-rle
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/sam3-video-rle", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/sam3-video-rle",
    headers=HEADERS,
    json={
        "image": "https://example.com/input.png"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/sam3-video-rle
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/sam3-video-rle
...
**Additional parameters found on model page:** `Input`, `root_box_prompts`, `false`, `s`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/sam3-video-rle`
