---
name: wavespeed-wavespeed-ai-seedvr2-image
description: >
  Use this skill for the WaveSpeed AI SeedVR2 Image Upscaler | Upscale To 4K/8K Images With High Quality model (wavespeed-ai/seedvr2/image). SeedVR2 Image Upscaler boosts image resolution and quality, upscaling photos to 4K or 8K for sharp, detailed results. Ready-to-use REST inference API, best performance, no coldstarts, affordable prici
---

# SeedVR2 Image Upscaler | Upscale To 4K/8K Images With High Quality

SeedVR2 Image Upscaler boosts image resolution and quality, upscaling photos to 4K or 8K for sharp, detailed results. Ready-to-use REST inference API, best performance, no coldstarts, affordable pricing.

**Type:** Image Generation
**Model:** `wavespeed-ai/seedvr2/image`
**Source:** https://wavespeed.ai/models/wavespeed-ai/seedvr2/image
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/seedvr2/image" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/seedvr2/image", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/seedvr2/image",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/seedvr2/image
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/seedvr2-image
...
**Additional parameters found on model page:** `Input`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`, `We`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/seedvr2/image`
