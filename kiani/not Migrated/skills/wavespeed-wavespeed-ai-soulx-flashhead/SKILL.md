---
name: wavespeed-wavespeed-ai-soulx-flashhead
description: >
  Use this skill for the WaveSpeed AI SoulX FlashHead | Real-Time Streaming Talking Head With 96 FPS model (wavespeed-ai/soulx-flashhead). SoulX FlashHead enables real-time streaming talking head video generation from portrait image and audio with ultra-fast 96 FPS performance. Ready-to-use REST inference API, best performance, no coldst
---

# SoulX FlashHead | Real-Time Streaming Talking Head With 96 FPS
...
**Model:** `wavespeed-ai/soulx-flashhead`
**Source:** https://wavespeed.ai/models/wavespeed-ai/soulx-flashhead
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/soulx-flashhead", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/soulx-flashhead",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/soulx-flashhead
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/soulx-flashhead
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/soulx-flashhead`
