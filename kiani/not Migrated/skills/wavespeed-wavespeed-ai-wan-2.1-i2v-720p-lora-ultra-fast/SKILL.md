---
name: wavespeed-wavespeed-ai-wan-2.1-i2v-720p-lora-ultra-fast
description: >
  Use this skill for the WaveSpeed AI WAN 2.1 Image To Video 720P Ultra-Fast With LoRA Support model (wavespeed-ai/wan-2.1/i2v-720p-lora-ultra-fast). WAN 2.1 i2v 720p is an ultra-fast Image-to-Video model that turns images into 720P videos and supports custom LoRAs for style control. Ready-to-use REST inference API, best performance, no coldstarts,
---

# WAN 2.1 Image To Video 720P Ultra-Fast With LoRA Support
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/wan-2.1/i2v-720p-lora-ultra-fast
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/wan-2.1/i2v-720p-lora-ultra-fast", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/wan-2.1/i2v-720p-lora-ultra-fast",
    headers=HEADERS,
    json={
        "prompt": "your prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/wan-2.1/i2v-720p-lora-ultra-fast
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/wan-2.1-i2v-720p-lora-ultra-fast
...
**Additional parameters found on model page:** `Input`, `0`, `5`, `Button`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/wan-2.1/i2v-720p-lora-ultra-fast`
