---
name: wavespeed-wavespeed-ai-wan-2.2-animate
description: >
  Use this skill for the WaveSpeed AI WAN 2.2 Animate | Character Animation Video To Video 720P model (wavespeed-ai/wan-2.2/animate). Wan2.2-Animate unified character animation &amp; replacement model replicating movement and expression; generates 720p videos up to 120s. Ready-to-use REST inference API, best performance, no coldstar
---

# WAN 2.2 Animate | Character Animation Video To Video 720P
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/wan-2.2/animate
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/wan-2.2/animate",
    headers=HEADERS,
    json={
        "image": "https://example.com/input.png"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/wan-2.2/animate
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/wan-2.2-animate
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/wan-2.2/animate`
