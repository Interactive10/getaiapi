---
name: wavespeed-wavespeed-ai-wan-2.2-i2v-720p
description: >
  Use this skill for the WaveSpeed AI WAN 2.2 I2V 720P | Image To Video 720P Unlimited AI Video Generation model (wavespeed-ai/wan-2.2/i2v-720p). WAN 2.2 A14B i2v-720p converts images into smooth 720p videos, enabling unlimited AI video generation with the Wan 2.2 image-to-video model. Ready-to-use REST inference API, best performance, no colds
---

# WAN 2.2 I2V 720P | Image To Video 720P Unlimited AI Video Generation
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/wan-2.2/i2v-720p
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/wan-2.2/i2v-720p", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/wan-2.2/i2v-720p",
    headers=HEADERS,
    json={
        "prompt": "your prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/wan-2.2/i2v-720p
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/wan-2.2-i2v-720p
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/wan-2.2/i2v-720p`
