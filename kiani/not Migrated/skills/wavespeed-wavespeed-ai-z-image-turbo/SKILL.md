---
name: wavespeed-wavespeed-ai-z-image-turbo
description: >
  Use this skill for the WaveSpeed AI Z-Image-Turbo | Text-to-Image by Tongyi-MAI model (wavespeed-ai/z-image/turbo). Z-Image-Turbo is a 6 billion parameter text-to-image model that generates photorealistic images in sub-second time. Ready-to-use REST inference API, best performance, no coldstarts, affordable pricing
---

# Z-Image-Turbo | Text-to-Image by Tongyi-MAI

Z-Image-Turbo is a 6 billion parameter text-to-image model that generates photorealistic images in sub-second time. Ready-to-use REST inference API, best performance, no coldstarts, affordable pricing.

**Type:** Image Generation
**Model:** `wavespeed-ai/z-image/turbo`
**Source:** https://wavespeed.ai/models/wavespeed-ai/z-image/turbo
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/z-image/turbo",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/z-image/turbo
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/z-image-turbo
...
**Additional parameters found on model page:** `canonical`, `1024`, `Input`, `Button`, `reset`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/z-image/turbo`
