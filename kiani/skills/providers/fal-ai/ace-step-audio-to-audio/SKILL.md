---
name: fal-ai-ace-step-audio-to-audio
description: >
  Use this skill for the fal.ai ACE-Step model (fal-ai/ace-step/audio-to-audio). Generate music from a lyrics and example audio using ACE-Step
---
...
**Source:** https://fal.ai/models/fal-ai/ace-step/audio-to-audio/api
...
| `original_lyrics` | string | No | `""` | Original lyrics of the audio file. |
...
| `edit_mode` | enum: `lyrics`, `remix` | No | `"remix"` | Whether to edit the lyrics only or remix the audio. |
...
| `original_tags` | string | **Yes** |  | Original tags of the audio file. |
| `original_seed` | integer | No |  | Original seed of the audio file. |
...
- API page: https://fal.ai/models/fal-ai/ace-step/audio-to-audio/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ace-step/audio-to-audio
