---
name: fal-ai-cosmos-predict-2.5-video-to-video
description: >
  Use this skill for the fal.ai Cosmos Predict 2.5 2B model (fal-ai/cosmos-predict-2.5/video-to-video). Generate video from text and videos using NVIDIA's 2B Cosmos Post-Trained Model
---
...
**Endpoint:** `fal-ai/cosmos-predict-2.5/video-to-video`
**Source:** https://fal.ai/models/fal-ai/cosmos-predict-2.5/video-to-video/api
...
| `video_url` | string | **Yes** |  | URL of the input video to use as conditioning. |
...
- API page: https://fal.ai/models/fal-ai/cosmos-predict-2.5/video-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/cosmos-predict-2.5/video-to-video
