...
description: >
  Use this skill for the fal.ai ElevenLabs TTS Multilingual v2 model (fal-ai/elevenlabs/tts/multilingual-v2). Generate multilingual text-to-speech audio using ElevenLabs TTS Multilingual v2.
---
...
**Source:** https://fal.ai/models/fal-ai/elevenlabs/tts/multilingual-v2/api
...
- API page: https://fal.ai/models/fal-ai/elevenlabs/tts/multilingual-v2/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/elevenlabs/tts/multilingual-v2
