...
description: >
  Use this skill for the fal.ai Flux 2 model (fal-ai/flux-2/flash). Text-to-image generation with FLUX.2 [dev] from Black Forest Labs. Enhanced realism, crisper text generation, and native editing capabilities— in a flash.
---
...
**Source:** https://fal.ai/models/fal-ai/flux-2/flash/api
...
- API page: https://fal.ai/models/fal-ai/flux-2/flash/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2/flash
