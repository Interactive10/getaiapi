---
name: fal-ai-flux-2-lora-gallery-realism
description: >
  Use this skill for the fal.ai Flux 2 Lora Gallery model (fal-ai/flux-2-lora-gallery/realism). Makes images more photorealistic and natural
---
...
**Source:** https://fal.ai/models/fal-ai/flux-2-lora-gallery/realism/api
...
| --- | --- | --- | --- | --- |
| `prompt` | string | **Yes** |  | The prompt to generate a realistic image with natural lighting and authentic details. |
...
| `lora_scale` | float | No | `1` | The strength of the realism effect. |
...
| `images` | list<Image> | The generated realistic style images |
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/flux-2-lora-gallery/realism", {
  input: {
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/flux-2-lora-gallery/realism", {
...
```javascript
const result = await fal.queue.result("fal-ai/flux-2-lora-gallery/realism", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/flux-2-lora-gallery/realism/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2-lora-gallery/realism
