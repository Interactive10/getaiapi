...
description: >
  Use this skill for the fal.ai FLUX.1 [dev] with LoRAs model (fal-ai/flux-lora). Super fast endpoint for the FLUX.1 [dev] model with LoRA support, enabling rapid and high-quality image generation using pre-trained LoRA adaptations for personalization, specific styles, brand identi
---
...
- API page: https://fal.ai/models/fal-ai/flux-lora/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-lora
