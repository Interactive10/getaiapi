---
name: fal-ai-flux-pro-kontext-max-multi
description: >
  Use this skill for the fal.ai FLUX.1 Kontext [max] model (fal-ai/flux-pro/kontext/max/multi). Experimental version of FLUX.1 Kontext [max] with multi image handling capabilities
---
...
**Source:** https://fal.ai/models/fal-ai/flux-pro/kontext/max/multi/api
...
| `image_urls` | list<string> | **Yes** |  | Image prompt for the omni model. |
...
- API page: https://fal.ai/models/fal-ai/flux-pro/kontext/max/multi/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-pro/kontext/max/multi
