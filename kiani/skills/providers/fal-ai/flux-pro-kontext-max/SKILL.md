...
description: >
  Use this skill for the fal.ai FLUX.1 Kontext [max] model (fal-ai/flux-pro/kontext/max). FLUX.1 Kontext [max] is a model with greatly improved prompt adherence and typography generation meet premium consistency for editing without compromise on speed.
---
...
**Source:** https://fal.ai/models/fal-ai/flux-pro/kontext/max/api
...
- API page: https://fal.ai/models/fal-ai/flux-pro/kontext/max/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-pro/kontext/max
