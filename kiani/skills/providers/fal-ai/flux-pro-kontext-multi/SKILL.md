---
name: fal-ai-flux-pro-kontext-multi
description: >
  Use this skill for the fal.ai FLUX.1 Kontext [pro] model (fal-ai/flux-pro/kontext/multi). Experimental version of FLUX.1 Kontext [pro] with multi image handling capabilities
---
...
**Source:** https://fal.ai/models/fal-ai/flux-pro/kontext/multi/api
...
- API page: https://fal.ai/models/fal-ai/flux-pro/kontext/multi/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-pro/kontext/multi
