---
name: fal-ai-hunyuan3d-v2-multi-view-turbo
description: >
  Use this skill for the fal.ai Hunyuan3D model (fal-ai/hunyuan3d/v2/multi-view/turbo). Generate 3D models from your images using Hunyuan 3D. A native 3D generative model enabling versatile and high-quality 3D asset creation.
---
...
**Endpoint:** `fal-ai/hunyuan3d/v2/multi-view/turbo`
**Source:** https://fal.ai/models/fal-ai/hunyuan3d/v2/multi-view/turbo/api
...
const result = await fal.subscribe("fal-ai/hunyuan3d/v2/multi-view/turbo", {
  input: {
        "left_image_url": "https://example.com/input.png",
        "back_image_url": "https://example.com/input.png",
        "front_image_url": "https://example.com/input.png"
    },
  logs: true,
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/hunyuan3d/v2/multi-view/turbo", {
  input: {
        "left_image_url": "https://example.com/input.png",
        "back_image_url": "https://example.com/input.png",
        "front_image_url": "https://example.com/input.png"
...
```javascript
const status = await fal.queue.status("fal-ai/hunyuan3d/v2/multi-view/turbo", {
...
```javascript
const result = await fal.queue.result("fal-ai/hunyuan3d/v2/multi-view/turbo", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/hunyuan3d/v2/multi-view/turbo/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/hunyuan3d/v2/multi-view/turbo
