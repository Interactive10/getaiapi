---
name: fal-ai-hunyuan3d-v2
description: >
  Use this skill for the fal.ai Hunyuan3D model (fal-ai/hunyuan3d/v2). Generate 3D models from your images using Hunyuan 3D. A native 3D generative model enabling versatile and high-quality 3D asset creation.
---
...
**Source:** https://fal.ai/models/fal-ai/hunyuan3d/v2/api
...
- API page: https://fal.ai/models/fal-ai/hunyuan3d/v2/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/hunyuan3d/v2
