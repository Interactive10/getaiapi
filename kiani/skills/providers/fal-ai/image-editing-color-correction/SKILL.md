---
name: fal-ai-image-editing-color-correction
description: >
  Use this skill for the fal.ai Image Editing model (fal-ai/image-editing/color-correction). Perfect your photos with professional color grading, balanced tones, and vibrant yet natural colors
---
...
**Endpoint:** `fal-ai/image-editing/color-correction`
**Source:** https://fal.ai/models/fal-ai/image-editing/color-correction/api
...
- API page: https://fal.ai/models/fal-ai/image-editing/color-correction/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/image-editing/color-correction
