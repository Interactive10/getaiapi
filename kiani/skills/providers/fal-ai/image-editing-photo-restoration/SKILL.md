---
name: fal-ai-image-editing-photo-restoration
description: >
  Use this skill for the fal.ai Image Editing model (fal-ai/image-editing/photo-restoration). Restore and enhance old or damaged photos by removing imperfections, adding color while preserving the original character and details of the image.
---
...
**Source:** https://fal.ai/models/fal-ai/image-editing/photo-restoration/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/image-editing/photo-restoration", {
  input: {
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/image-editing/photo-restoration", {
...
```javascript
const result = await fal.queue.result("fal-ai/image-editing/photo-restoration", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/image-editing/photo-restoration/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/image-editing/photo-restoration
