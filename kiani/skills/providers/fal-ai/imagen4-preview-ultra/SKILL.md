...
description: >
  Use this skill for the fal.ai Imagen 4 Ultra model (fal-ai/imagen4/preview/ultra). Google’s highest quality image generation model
---
...
**Source:** https://fal.ai/models/fal-ai/imagen4/preview/ultra/api
...
| `resolution` | enum: `1K`, `2K` | No | `"1K"` | The resolution of the generated image. |
...
```javascript
const result = await fal.queue.result("fal-ai/imagen4/preview/ultra", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/imagen4/preview/ultra/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/imagen4/preview/ultra
