---
name: fal-ai-kling-image-o1
description: >
  Use this skill for the fal.ai Kling O1 Image model (fal-ai/kling-image/o1). Perform precise image edits using strong reference control, transforming subjects, styles, and local details while preserving visual consistency.
---
...
**Source:** https://fal.ai/models/fal-ai/kling-image/o1/api
...
| `elements` | list<ElementInput> | null | No |  | Elements (characters/objects) to include in the image. Reference in prompt as @Element1, @Element2, etc. Maximum 10 t... |
...
- API page: https://fal.ai/models/fal-ai/kling-image/o1/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-image/o1
