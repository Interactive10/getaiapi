---
name: fal-ai-kling-video-o3-pro-video-to-video-reference
description: >
  Use this skill for the fal.ai Kling O3 Reference Video to Video [Pro] model (fal-ai/kling-video/o3/pro/video-to-video/reference). Kling O3 Omni generates new shots guided by an input reference video, preserving cinematic language such as motion, and camera style to produce seamless scene continuity.
---
...
**Source:** https://fal.ai/models/fal-ai/kling-video/o3/pro/video-to-video/reference/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/kling-video/o3/pro/video-to-video/reference", {
  input: {
        "prompt": "your value here",
        "video_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/kling-video/o3/pro/video-to-video/reference", {
...
```javascript
const result = await fal.queue.result("fal-ai/kling-video/o3/pro/video-to-video/reference", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/kling-video/o3/pro/video-to-video/reference/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/o3/pro/video-to-video/reference
