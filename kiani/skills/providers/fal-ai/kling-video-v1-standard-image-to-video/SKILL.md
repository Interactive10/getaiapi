...
description: >
  Use this skill for the fal.ai Kling 1.0 model (fal-ai/kling-video/v1/standard/image-to-video). Generate video clips from your images using Kling 1.0
---
...
**Source:** https://fal.ai/models/fal-ai/kling-video/v1/standard/image-to-video/api
...
```javascript
const status = await fal.queue.status("fal-ai/kling-video/v1/standard/image-to-video", {
...
```javascript
const result = await fal.queue.result("fal-ai/kling-video/v1/standard/image-to-video", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/kling-video/v1/standard/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v1/standard/image-to-video
