...
description: >
  Use this skill for the fal.ai Kling 2.1 Master model (fal-ai/kling-video/v2.1/master/image-to-video). Kling 2.1 Master: The premium endpoint for Kling 2.1, designed for top-tier image-to-video generation with unparalleled motion fluidity, cinematic visuals, and exceptional prompt precision.
---
...
**Source:** https://fal.ai/models/fal-ai/kling-video/v2.1/master/image-to-video/api
...
- API page: https://fal.ai/models/fal-ai/kling-video/v2.1/master/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/v2.1/master/image-to-video
