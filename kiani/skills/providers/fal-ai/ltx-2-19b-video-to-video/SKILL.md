---
name: fal-ai-ltx-2-19b-video-to-video
description: >
  Use this skill for the fal.ai LTX-2 19B model (fal-ai/ltx-2-19b/video-to-video). Generate video with audio from videos using LTX-2
---
...
**Source:** https://fal.ai/models/fal-ai/ltx-2-19b/video-to-video/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ltx-2-19b/video-to-video", {
  input: {
        "prompt": "your value here",
        "video_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/ltx-2-19b/video-to-video", {
...
```javascript
const result = await fal.queue.result("fal-ai/ltx-2-19b/video-to-video", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ltx-2-19b/video-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2-19b/video-to-video
