---
name: fal-ai-luma-photon-reframe
description: >
  Use this skill for the fal.ai Luma Photon Reframe model (fal-ai/luma-photon/reframe). Extend and reframe images with Luma Photon Reframe. This advanced tool intelligently expands your visuals, seamlessly blending new content to enhance creativity and adaptability, offering unmatched pe
---
...
**Source:** https://fal.ai/models/fal-ai/luma-photon/reframe/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/luma-photon/reframe", {
  input: {
        "aspect_ratio": "1:1",
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/luma-photon/reframe", {
...
- API page: https://fal.ai/models/fal-ai/luma-photon/reframe/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/luma-photon/reframe
