---
name: fal-ai-minimax-image-01
description: >
  Use this skill for the fal.ai MiniMax (Hailuo AI) Text to Image model (fal-ai/minimax/image-01). Generate high quality images from text prompts using MiniMax Image-01. Longer text prompts will result in better quality images.
---
...
**Source:** https://fal.ai/models/fal-ai/minimax/image-01/api
...
- API page: https://fal.ai/models/fal-ai/minimax/image-01/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/minimax/image-01
