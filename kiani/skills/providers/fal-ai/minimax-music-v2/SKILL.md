...
description: >
  Use this skill for the fal.ai Minimax Music model (fal-ai/minimax-music/v2). Generate music from text prompts using the MiniMax Music 2.0 model, which leverages advanced AI techniques to create high-quality, diverse musical compositions.
---
...
**Source:** https://fal.ai/models/fal-ai/minimax-music/v2/api
...
- API page: https://fal.ai/models/fal-ai/minimax-music/v2/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/minimax-music/v2
