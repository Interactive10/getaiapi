...
description: >
  Use this skill for the fal.ai Nano Banana 2 model (fal-ai/nano-banana-2). Nano Banana 2 is Google's new state-of-the-art fast image generation and editing model
---
...
**Source:** https://fal.ai/models/fal-ai/nano-banana-2/api
...
- API page: https://fal.ai/models/fal-ai/nano-banana-2/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/nano-banana-2
