---
name: fal-ai-pika-v2.2-text-to-video
description: >
  Use this skill for the fal.ai Pika Text to Video (v2.2) model (fal-ai/pika/v2.2/text-to-video). Start with a simple text input to create dynamic generations that defy expectations in up to 1080p. Experience better image clarity and crisper, sharper visuals.
---
...
| `resolution` | enum: `1080p`, `720p` | No | `"720p"` | The resolution of the generated video |
...
- API page: https://fal.ai/models/fal-ai/pika/v2.2/text-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pika/v2.2/text-to-video
