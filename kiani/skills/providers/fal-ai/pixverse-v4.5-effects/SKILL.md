---
name: fal-ai-pixverse-v4.5-effects
description: >
  Use this skill for the fal.ai Pixverse model (fal-ai/pixverse/v4.5/effects). Generate high quality video clips with different effects using PixVerse v4.5
---
...
**Endpoint:** `fal-ai/pixverse/v4.5/effects`
**Source:** https://fal.ai/models/fal-ai/pixverse/v4.5/effects/api
...
- API page: https://fal.ai/models/fal-ai/pixverse/v4.5/effects/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v4.5/effects
