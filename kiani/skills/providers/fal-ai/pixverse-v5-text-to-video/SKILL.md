...
description: >
  Use this skill for the fal.ai Pixverse model (fal-ai/pixverse/v5/text-to-video). Generate high quality video clips from text and image prompts using PixVerse v5
---
...
**Source:** https://fal.ai/models/fal-ai/pixverse/v5/text-to-video/api
...
- API page: https://fal.ai/models/fal-ai/pixverse/v5/text-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v5/text-to-video
