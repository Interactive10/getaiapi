---
name: fal-ai-pixverse-v5.6-transition
description: >
  Use this skill for the fal.ai Pixverse model (fal-ai/pixverse/v5.6/transition). Use the latest pixverse v5.6 model to turn your texts and images into amazing videos.
---
...
**Source:** https://fal.ai/models/fal-ai/pixverse/v5.6/transition/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/pixverse/v5.6/transition", {
  input: {
        "prompt": "your value here",
        "first_image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/pixverse/v5.6/transition", {
...
```javascript
const result = await fal.queue.result("fal-ai/pixverse/v5.6/transition", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/pixverse/v5.6/transition/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v5.6/transition
