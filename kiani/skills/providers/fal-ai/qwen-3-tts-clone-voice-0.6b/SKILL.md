---
name: fal-ai-qwen-3-tts-clone-voice-0.6b
description: >
  Use this skill for the fal.ai Qwen 3 TTS - Clone Voice [0.6B] model (fal-ai/qwen-3-tts/clone-voice/0.6b). Clone your voices using Qwen3-TTS Clone-Voice model with zero shot cloning capabilities and use it on text-to-speech models to create speeches of yours!
---
...
**Endpoint:** `fal-ai/qwen-3-tts/clone-voice/0.6b`
**Source:** https://fal.ai/models/fal-ai/qwen-3-tts/clone-voice/0.6b/api
...
- API page: https://fal.ai/models/fal-ai/qwen-3-tts/clone-voice/0.6b/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-3-tts/clone-voice/0.6b
