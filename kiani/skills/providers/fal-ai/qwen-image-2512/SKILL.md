---
name: fal-ai-qwen-image-2512
description: >
  Use this skill for the fal.ai Qwen Image 2512 model (fal-ai/qwen-image-2512). Qwen Image 2512 is an improved version of Qwen Image with better text rendering, finer natural textures, and more realistic human generation.
---
...
**Source:** https://fal.ai/models/fal-ai/qwen-image-2512/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/qwen-image-2512", {
  input: {
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/qwen-image-2512", {
...
```javascript
const result = await fal.queue.result("fal-ai/qwen-image-2512", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/qwen-image-2512/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-2512
