---
name: fal-ai-qwen-image-edit-2509-lora-gallery-remove-element
description: >
  Use this skill for the fal.ai Qwen Image Edit 2509 Lora Gallery model (fal-ai/qwen-image-edit-2509-lora-gallery/remove-element). Remove unwanted elements (objects, people, text) while maintaining image consistency
---
...
**Source:** https://fal.ai/models/fal-ai/qwen-image-edit-2509-lora-gallery/remove-element/api
...
| --- | --- | --- | --- | --- |
| `prompt` | string | No | `"Remove the specified element from the scene"` | Specify what element(s) to remove from the image (objects, people, text, etc.). The model will cleanly remove the ele... |
...
| `image_urls` | list<string> | **Yes** |  | The URL of the image containing elements to remove. |
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/qwen-image-edit-2509-lora-gallery/remove-element", {
  input: {
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/qwen-image-edit-2509-lora-gallery/remove-element", {
...
```javascript
const result = await fal.queue.result("fal-ai/qwen-image-edit-2509-lora-gallery/remove-element", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/qwen-image-edit-2509-lora-gallery/remove-element/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-edit-2509-lora-gallery/remove-element
