---
name: fal-ai-qwen-image-edit-2511
description: >
  Use this skill for the fal.ai Qwen Image Edit 2511 model (fal-ai/qwen-image-edit-2511). Endpoint for Qwen's Image Editing 2511 model.
---
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/qwen-image-edit-2511", {
  input: {
        "prompt": "your value here",
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/qwen-image-edit-2511", {
...
```javascript
const result = await fal.queue.result("fal-ai/qwen-image-edit-2511", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/qwen-image-edit-2511/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-edit-2511
