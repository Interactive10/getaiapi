---
name: fal-ai-realistic-vision
description: >
  Use this skill for the fal.ai Realistic Vision model (fal-ai/realistic-vision). Generate realistic images.
---
...
**Source:** https://fal.ai/models/fal-ai/realistic-vision/api
...
| `model_name` | string | No |  | The Realistic Vision model to use. |
...
- API page: https://fal.ai/models/fal-ai/realistic-vision/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/realistic-vision
