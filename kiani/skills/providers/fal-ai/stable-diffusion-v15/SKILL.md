---
name: fal-ai-stable-diffusion-v15
description: >
  Use this skill for the fal.ai Stable Diffusion v1.5 model (fal-ai/stable-diffusion-v15). Stable Diffusion v1.5
---
...
**Source:** https://fal.ai/models/fal-ai/stable-diffusion-v15/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/stable-diffusion-v15", {
  input: {
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/stable-diffusion-v15", {
...
```javascript
const result = await fal.queue.result("fal-ai/stable-diffusion-v15", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/stable-diffusion-v15/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/stable-diffusion-v15
