...
description: >
  Use this skill for the fal.ai Veo 3.1 Fast model (fal-ai/veo3.1/fast/image-to-video). Generate videos from your image prompts using Veo 3.1 fast.
---
...
- API page: https://fal.ai/models/fal-ai/veo3.1/fast/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/veo3.1/fast/image-to-video
