...
description: >
  Use this skill for the fal.ai Veo 3.1 Fast model (fal-ai/veo3.1/fast). Faster and more cost effective version of Google's Veo 3.1!
---
...
- API page: https://fal.ai/models/fal-ai/veo3.1/fast/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/veo3.1/fast
