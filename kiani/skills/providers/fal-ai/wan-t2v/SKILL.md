...
name: fal-ai-wan-t2v
description: >
  Use this skill for the fal.ai Wan-2.1 Text-to-Video model (fal-ai/wan-t2v). Wan-2.1 is a text-to-video model that generates high-quality videos with high visual quality and motion diversity from text prompts
---
...
**Source:** https://fal.ai/models/fal-ai/wan-t2v/api
...
| `turbo_mode` | boolean | No | `false` | If true, the video will be generated faster with no noticeable degradation in the visual quality. |
...
- API page: https://fal.ai/models/fal-ai/wan-t2v/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-t2v
