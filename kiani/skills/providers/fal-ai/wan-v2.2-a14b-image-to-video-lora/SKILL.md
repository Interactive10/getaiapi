---
name: fal-ai-wan-v2.2-a14b-image-to-video-lora
description: >
  Use this skill for the fal.ai Wan v2.2 A14B Image-to-Video A14B with LoRAs model (fal-ai/wan/v2.2-a14b/image-to-video/lora). Wan-2.2 image-to-video is a video model that generates high-quality videos with high visual quality and motion diversity from text prompts and images. This endpoint supports LoRAs made for Wan 2.2
---
...
**Source:** https://fal.ai/models/fal-ai/wan/v2.2-a14b/image-to-video/lora/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/wan/v2.2-a14b/image-to-video/lora", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/wan/v2.2-a14b/image-to-video/lora", {
...
```javascript
const result = await fal.queue.result("fal-ai/wan/v2.2-a14b/image-to-video/lora", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/wan/v2.2-a14b/image-to-video/lora/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan/v2.2-a14b/image-to-video/lora
