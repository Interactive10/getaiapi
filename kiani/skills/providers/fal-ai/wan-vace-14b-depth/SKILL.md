---
name: fal-ai-wan-vace-14b-depth
description: >
  Use this skill for the fal.ai Wan VACE 14B model (fal-ai/wan-vace-14b/depth). VACE is a video generation model that uses a source image, mask, and video to create prompted videos with controllable sources.
---
...
**Source:** https://fal.ai/models/fal-ai/wan-vace-14b/depth/api
...
- API page: https://fal.ai/models/fal-ai/wan-vace-14b/depth/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-vace-14b/depth
