---
name: fal-ai-z-image-turbo-lora
description: >
  Use this skill for the fal.ai Z-Image Turbo model (fal-ai/z-image/turbo/lora). Text-to-Image endpoint with LoRA support for Z-Image Turbo, a super fast text-to-image model of 6B parameters developed by Tongyi-MAI.
---
...
**Source:** https://fal.ai/models/fal-ai/z-image/turbo/lora/api
...
- API page: https://fal.ai/models/fal-ai/z-image/turbo/lora/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/z-image/turbo/lora
