---
name: replicate-black-forest-labs-flux-2-klein-9b-base
description: >
  Use this skill for the Replicate Flux 2 Klein 9B Base model (black-forest-labs/flux-2-klein-9b-base). Use the Flux 2 Klein 9B Base model via Replicate API.
---

# Flux 2 Klein 9B Base

**Model:** `black-forest-labs/flux-2-klein-9b-base`
**Source:** https://replicate.com/black-forest-labs/flux-2-klein-9b-base
**Version:** `b037b94bdba7e4a7454b68e9dc6cf8e98c83f0f216fe5474144f52f69420c95c`
...
output = replicate.run("black-forest-labs/flux-2-klein-9b-base",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/black-forest-labs/flux-2-klein-9b-base/predictions \
...
- Model page: https://replicate.com/black-forest-labs/flux-2-klein-9b-base
- API page: https://replicate.com/black-forest-labs/flux-2-klein-9b-base/api
