---
name: replicate-black-forest-labs-flux-2-klein-9b
description: >
  Use this skill for the Replicate Flux 2 Klein 9B model (black-forest-labs/flux-2-klein-9b). Use the Flux 2 Klein 9B model via Replicate API.
---

# Flux 2 Klein 9B

**Model:** `black-forest-labs/flux-2-klein-9b`
**Source:** https://replicate.com/black-forest-labs/flux-2-klein-9b
**Version:** `963f7b2c4aa2bc7e6377b95759dcf3a21cf175f6e8b0d8c1efe7bf6c8a23b690`
...
output = replicate.run("black-forest-labs/flux-2-klein-9b",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/black-forest-labs/flux-2-klein-9b/predictions \
...
| `megapixels` | enum: `0.25`, `0.5`, `1`, `2`, `4` | No | `"1"` | Resolution in megapixels |
...
- Model page: https://replicate.com/black-forest-labs/flux-2-klein-9b
- API page: https://replicate.com/black-forest-labs/flux-2-klein-9b/api
