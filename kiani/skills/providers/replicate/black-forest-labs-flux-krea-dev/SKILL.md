---
name: replicate-black-forest-labs-flux-krea-dev
description: >
  Use this skill for the Replicate Flux Krea Dev model (black-forest-labs/flux-krea-dev). Use the Flux Krea Dev model via Replicate API.
---

# Flux Krea Dev

**Model:** `black-forest-labs/flux-krea-dev`
**Source:** https://replicate.com/black-forest-labs/flux-krea-dev
**Version:** `9d7a7c510de5b6bab1b183a9ed61cee5416ea3b4ab0bd644047780c4ef115662`
...
output = replicate.run("black-forest-labs/flux-krea-dev",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/black-forest-labs/flux-krea-dev/predictions \
...
- Model page: https://replicate.com/black-forest-labs/flux-krea-dev
- API page: https://replicate.com/black-forest-labs/flux-krea-dev/api
