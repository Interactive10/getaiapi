---
name: replicate-black-forest-labs-flux-redux-dev
description: >
  Use this skill for the Replicate Flux Redux Dev model (black-forest-labs/flux-redux-dev). Use the Flux Redux Dev model via Replicate API.
---

# Flux Redux Dev

**Model:** `black-forest-labs/flux-redux-dev`
**Source:** https://replicate.com/black-forest-labs/flux-redux-dev
...
output = replicate.run("black-forest-labs/flux-redux-dev",
    input={
        "redux_image": "https://example.com/input.png"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/black-forest-labs/flux-redux-dev/predictions \
...
- Model page: https://replicate.com/black-forest-labs/flux-redux-dev
- API page: https://replicate.com/black-forest-labs/flux-redux-dev/api
