---
name: replicate-fofr-prompt-classifier
description: >
  Use this skill for the Replicate Prompt Classifier model (fofr/prompt-classifier). Use the Prompt Classifier model via Replicate API.
---

# Prompt Classifier

**Model:** `fofr/prompt-classifier`
**Source:** https://replicate.com/fofr/prompt-classifier
...
const output = await replicate.run("fofr/prompt-classifier", {
  input: {
...
output = replicate.run("fofr/prompt-classifier",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/fofr/prompt-classifier/predictions \
...
- Model page: https://replicate.com/fofr/prompt-classifier
- API page: https://replicate.com/fofr/prompt-classifier/api
