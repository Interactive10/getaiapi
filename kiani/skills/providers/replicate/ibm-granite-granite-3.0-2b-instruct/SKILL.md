---
name: replicate-ibm-granite-granite-3.0-2b-instruct
description: >
  Use this skill for the Replicate Granite 3.0 2B Instruct model (ibm-granite/granite-3.0-2b-instruct). Use the Granite 3.0 2B Instruct model via Replicate API.
---

# Granite 3.0 2B Instruct

**Model:** `ibm-granite/granite-3.0-2b-instruct`
**Source:** https://replicate.com/ibm-granite/granite-3.0-2b-instruct
**Version:** `97679a145f9b2e7370ac4da5012ab06efcba0f30e7a9efadd846fcce51f99d8e`
...
const output = await replicate.run("ibm-granite/granite-3.0-2b-instruct", {
  input: {
...
output = replicate.run("ibm-granite/granite-3.0-2b-instruct",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/ibm-granite/granite-3.0-2b-instruct/predictions \
...
- Model page: https://replicate.com/ibm-granite/granite-3.0-2b-instruct
- API page: https://replicate.com/ibm-granite/granite-3.0-2b-instruct/api
