---
name: replicate-ibm-granite-granite-3.0-8b-instruct
description: >
  Use this skill for the Replicate Granite 3.0 8B Instruct model (ibm-granite/granite-3.0-8b-instruct). Use the Granite 3.0 8B Instruct model via Replicate API.
---

# Granite 3.0 8B Instruct

**Model:** `ibm-granite/granite-3.0-8b-instruct`
**Source:** https://replicate.com/ibm-granite/granite-3.0-8b-instruct
**Version:** `8d8fb55950fb8eb2817fc078b7b05a0bd3ecc612d6332d8009fb0c007839192e`
...
const output = await replicate.run("ibm-granite/granite-3.0-8b-instruct", {
  input: {
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/ibm-granite/granite-3.0-8b-instruct/predictions \
...
- Model page: https://replicate.com/ibm-granite/granite-3.0-8b-instruct
- API page: https://replicate.com/ibm-granite/granite-3.0-8b-instruct/api
