---
name: replicate-jagilley-controlnet-canny
description: >
  Use this skill for the Replicate Controlnet Canny model (jagilley/controlnet-canny). Use the Controlnet Canny model via Replicate API.
---

# Controlnet Canny

**Model:** `jagilley/controlnet-canny`
**Source:** https://replicate.com/jagilley/controlnet-canny
...
const output = await replicate.run("jagilley/controlnet-canny", {
  input: {
...
output = replicate.run("jagilley/controlnet-canny",
    input={
        "image": "https://example.com/input.png",
        "prompt": "your prompt here"
    },
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/jagilley/controlnet-canny/predictions \
...
- Model page: https://replicate.com/jagilley/controlnet-canny
- API page: https://replicate.com/jagilley/controlnet-canny/api
