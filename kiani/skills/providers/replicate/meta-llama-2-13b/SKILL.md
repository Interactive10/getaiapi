...
description: >
  Use this skill for the Replicate Llama 2 13B model (meta/llama-2-13b). Use the Llama 2 13B model via Replicate API.
---

# Llama 2 13B

**Model:** `meta/llama-2-13b`
**Source:** https://replicate.com/meta/llama-2-13b
...
const output = await replicate.run("meta/llama-2-13b", {
  input: {
...
output = replicate.run("meta/llama-2-13b",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/meta/llama-2-13b/predictions \
...
- Model page: https://replicate.com/meta/llama-2-13b
- API page: https://replicate.com/meta/llama-2-13b/api
