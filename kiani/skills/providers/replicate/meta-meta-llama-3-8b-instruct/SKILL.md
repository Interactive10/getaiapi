---
name: replicate-meta-meta-llama-3-8b-instruct
description: >
  Use this skill for the Replicate Meta Llama 3 8B Instruct model (meta/meta-llama-3-8b-instruct). Use the Meta Llama 3 8B Instruct model via Replicate API.
---

# Meta Llama 3 8B Instruct

**Model:** `meta/meta-llama-3-8b-instruct`
**Source:** https://replicate.com/meta/meta-llama-3-8b-instruct
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/meta/meta-llama-3-8b-instruct/predictions \
...
- Model page: https://replicate.com/meta/meta-llama-3-8b-instruct
- API page: https://replicate.com/meta/meta-llama-3-8b-instruct/api
