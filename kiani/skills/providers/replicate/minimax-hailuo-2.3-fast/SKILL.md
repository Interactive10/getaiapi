---
name: replicate-minimax-hailuo-2.3-fast
description: >
  Use this skill for the Replicate Hailuo 2.3 Fast model (minimax/hailuo-2.3-fast). Use the Hailuo 2.3 Fast model via Replicate API.
---

# Hailuo 2.3 Fast

**Model:** `minimax/hailuo-2.3-fast`
**Source:** https://replicate.com/minimax/hailuo-2.3-fast
**Version:** `c92f075dfd04541f1c1913a9689f778ecf76bfec3dd9fdfe19903a86e07f2cdc`
...
output = replicate.run("minimax/hailuo-2.3-fast",
    input={
        "prompt": "your prompt here",
        "first_frame_image": "https://example.com/input.png"
    },
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/minimax/hailuo-2.3-fast/predictions \
...
- Model page: https://replicate.com/minimax/hailuo-2.3-fast
- API page: https://replicate.com/minimax/hailuo-2.3-fast/api
