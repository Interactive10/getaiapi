...
description: >
  Use this skill for the Replicate Gpt 4.1 Mini model (openai/gpt-4.1-mini). Use the Gpt 4.1 Mini model via Replicate API.
---

# Gpt 4.1 Mini

**Model:** `openai/gpt-4.1-mini`
**Source:** https://replicate.com/openai/gpt-4.1-mini
**Version:** `aca77ca43d7155cf9480ea2f697adf1c9c008ab5a471050cedb90dadfb5dc4cc`
...
const output = await replicate.run("openai/gpt-4.1-mini", {
  input: {
...
output = replicate.run("openai/gpt-4.1-mini",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/openai/gpt-4.1-mini/predictions \
...
- Model page: https://replicate.com/openai/gpt-4.1-mini
- API page: https://replicate.com/openai/gpt-4.1-mini/api
