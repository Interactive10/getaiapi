...
description: >
  Use this skill for the Replicate Gpt 4.1 model (openai/gpt-4.1). Use the Gpt 4.1 model via Replicate API.
---

# Gpt 4.1

**Model:** `openai/gpt-4.1`
**Source:** https://replicate.com/openai/gpt-4.1
**Version:** `f7e65222875892b7893e5c7581bdde9056c78cd77171a315c369b63b8907a619`
...
const output = await replicate.run("openai/gpt-4.1", {
  input: {
...
output = replicate.run("openai/gpt-4.1",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/openai/gpt-4.1/predictions \
...
- Model page: https://replicate.com/openai/gpt-4.1
- API page: https://replicate.com/openai/gpt-4.1/api
