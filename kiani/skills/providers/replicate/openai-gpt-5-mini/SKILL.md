...
description: >
  Use this skill for the Replicate Gpt 5 Mini model (openai/gpt-5-mini). Use the Gpt 5 Mini model via Replicate API.
---

# Gpt 5 Mini

**Model:** `openai/gpt-5-mini`
**Source:** https://replicate.com/openai/gpt-5-mini
**Version:** `8fd5dbfbc0f88570a4ba7f9d529aa02b10ca1f92d77c4ada0a56e549ffda0bae`
...
output = replicate.run("openai/gpt-5-mini",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/openai/gpt-5-mini/predictions \
...
- Model page: https://replicate.com/openai/gpt-5-mini
- API page: https://replicate.com/openai/gpt-5-mini/api
