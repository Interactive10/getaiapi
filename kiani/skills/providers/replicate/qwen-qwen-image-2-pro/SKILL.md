---
name: replicate-qwen-qwen-image-2-pro
description: >
  Use this skill for the Replicate Qwen Image 2 Pro model (qwen/qwen-image-2-pro). Use the Qwen Image 2 Pro model via Replicate API.
---

# Qwen Image 2 Pro

**Model:** `qwen/qwen-image-2-pro`
**Source:** https://replicate.com/qwen/qwen-image-2-pro
**Version:** `ece119c87ba75f46154c80282a3b05db3d88e708d09bbe3d772b9b95fb6f3be6`
...
output = replicate.run("qwen/qwen-image-2-pro",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/qwen/qwen-image-2-pro/predictions \
...
- Model page: https://replicate.com/qwen/qwen-image-2-pro
- API page: https://replicate.com/qwen/qwen-image-2-pro/api
