---
name: replicate-sourceful-riverflow-2.0-pro
description: >
  Use this skill for the Replicate Riverflow 2.0 Pro model (sourceful/riverflow-2.0-pro). Use the Riverflow 2.0 Pro model via Replicate API.
---

# Riverflow 2.0 Pro

**Model:** `sourceful/riverflow-2.0-pro`
**Source:** https://replicate.com/sourceful/riverflow-2.0-pro
**Version:** `d46bdf05d249002bbf46683d9d1372860c309f8ceb41ad4fca8cce1180b91d8f`
...
const output = await replicate.run("sourceful/riverflow-2.0-pro", {
  input: {
...
output = replicate.run("sourceful/riverflow-2.0-pro",
    input={
        "instruction": "your value here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/sourceful/riverflow-2.0-pro/predictions \
...
| `resolution` | enum: `1K`, `2K`, `4K` | No | `"1K"` | Target resolution: 1K, 2K, or 4K. |
...
| `max_iterations` | integer | No | `3` | Number of internal reasoning iterations (1-3). |
...
- Model page: https://replicate.com/sourceful/riverflow-2.0-pro
- API page: https://replicate.com/sourceful/riverflow-2.0-pro/api
