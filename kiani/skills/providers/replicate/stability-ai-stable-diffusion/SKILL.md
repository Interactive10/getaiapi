---
name: replicate-stability-ai-stable-diffusion
description: >
  Use this skill for the Replicate Stable Diffusion model (stability-ai/stable-diffusion). Use the Stable Diffusion model via Replicate API.
---
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/stability-ai/stable-diffusion/predictions \
...
| `height` | enum (16 values) | No | `768` | Height of generated image in pixels. Needs to be a multiple of 64 |
| `width` | enum (16 values) | No | `768` | Width of generated image in pixels. Needs to be a multiple of 64 |
...
- Model page: https://replicate.com/stability-ai/stable-diffusion
- API page: https://replicate.com/stability-ai/stable-diffusion/api
