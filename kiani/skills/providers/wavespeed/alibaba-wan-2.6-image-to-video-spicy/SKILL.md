---
name: wavespeed-alibaba-wan-2.6-image-to-video-spicy
description: >
  Use this skill for the WaveSpeed AI Alibaba WAN 2.6 Spicy | Image To Video Unlimited High-Quality model (alibaba/wan-2.6/image-to-video-spicy). Alibaba WAN 2.6 Spicy converts images into unlimited high-quality videos with smooth animations optimized for scalable content generation. Ready-to-use REST inference API, best performance, no cold st
---

# Alibaba WAN 2.6 Spicy | Image To Video Unlimited High-Quality
...
**Type:** Image to Video
**Model:** `alibaba/wan-2.6/image-to-video-spicy`
**Source:** https://wavespeed.ai/models/alibaba/wan-2.6/image-to-video-spicy
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/alibaba/wan-2.6/image-to-video-spicy" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/alibaba/wan-2.6/image-to-video-spicy", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/alibaba/wan-2.6/image-to-video-spicy",
    headers=HEADERS,
    json={
        "prompt": "your prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/alibaba/wan-2.6/image-to-video-spicy
> - API docs: https://wavespeed.ai/docs/docs-api/alibaba/wan-2.6-image-to-video-spicy
...
**POST** `https://api.wavespeed.ai/api/v3/alibaba/wan-2.6/image-to-video-spicy`
