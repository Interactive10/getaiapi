---
name: wavespeed-google-nano-banana-2-edit
description: >
  Use this skill for the WaveSpeed AI Google Nano Banana 2 Edit | Gemini 3.1 Flash AI Image Editing With 4K Output model (google/nano-banana-2/edit). Google Nano Banana 2 Edit (Gemini 3.1 Flash Image) enables advanced image editing with 4K-capable output, fast iteration, and precise instruction following. Supports text translation, localization wit
---

# Google Nano Banana 2 Edit | Gemini 3.1 Flash AI Image Editing With 4K Output
...
**Source:** https://wavespeed.ai/models/google/nano-banana-2/edit
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/google/nano-banana-2/edit",
    headers=HEADERS,
    json={
        "prompt": "your edit prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/google/nano-banana-2/edit
> - API docs: https://wavespeed.ai/docs/docs-api/google/nano-banana-2-edit
...
**POST** `https://api.wavespeed.ai/api/v3/google/nano-banana-2/edit`
