---
name: wavespeed-google-nano-banana-pro-edit-multi
description: >
  Use this skill for the WaveSpeed AI Google Nano Banana Pro Edit Multi | Generate Multiple Edited Images at $0.07 Each model (google/nano-banana-pro/edit-multi). Google&#x27;s Nano Banana Pro (Gemini 3.0 Pro Image) Edit is a next-generation image editing model capable of generating multiple high-quality edited images in a single run. Extremely low cost — only 
---

# Google Nano Banana Pro Edit Multi | Generate Multiple Edited Images at $0.07 Each
...
**Source:** https://wavespeed.ai/models/google/nano-banana-pro/edit-multi
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/google/nano-banana-pro/edit-multi", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/google/nano-banana-pro/edit-multi",
    headers=HEADERS,
    json={
        "prompt": "your edit prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/google/nano-banana-pro/edit-multi
> - API docs: https://wavespeed.ai/docs/docs-api/google/nano-banana-pro-edit-multi
...
**POST** `https://api.wavespeed.ai/api/v3/google/nano-banana-pro/edit-multi`
