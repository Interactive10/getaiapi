---
name: wavespeed-inworld-inworld-1.5-mini-text-to-speech
description: >
  Use this skill for the WaveSpeed AI Inworld 1.5 Mini | Text-To-Speech With 56+ Multilingual Voices model (inworld/inworld-1.5-mini/text-to-speech). Inworld 1.5 Mini delivers high-quality text-to-speech synthesis with 56+ multilingual voices, adjustable speaking rate, and natural-sounding audio output. Ready-to-use REST inference API, best perform
---
...
**Type:** Text to Speech
**Model:** `inworld/inworld-1.5-mini/text-to-speech`
**Source:** https://wavespeed.ai/models/inworld/inworld-1.5-mini/text-to-speech
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/inworld/inworld-1.5-mini/text-to-speech" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/inworld/inworld-1.5-mini/text-to-speech", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/inworld/inworld-1.5-mini/text-to-speech",
    headers=HEADERS,
    json={
        "text": "Hello, this is a test.",
        "voice": "default"
...
> - Model page: https://wavespeed.ai/models/inworld/inworld-1.5-mini/text-to-speech
> - API docs: https://wavespeed.ai/docs/docs-api/inworld/inworld-1.5-mini-text-to-speech
...
**Additional parameters found on model page:** `Input`, `false`, `s`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/inworld/inworld-1.5-mini/text-to-speech`
