---
name: wavespeed-minimax-hailuo-02-i2v-standard
description: >
  Use this skill for the WaveSpeed AI MiniMax Hailuo 02 I2V Standard | Image-To-Video 768P Ultra-Clear model (minimax/hailuo-02/i2v-standard). Hailuo 02 by Hailuo AI is an image-to-video model delivering ultra-clear 768P video with responsive handling of physics-driven scenes. Ready-to-use REST inference API, best performance, no coldstarts,
---

# MiniMax Hailuo 02 I2V Standard | Image-To-Video 768P Ultra-Clear
...
**Source:** https://wavespeed.ai/models/minimax/hailuo-02/i2v-standard
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/minimax/hailuo-02/i2v-standard" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/minimax/hailuo-02/i2v-standard", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/minimax/hailuo-02/i2v-standard",
    headers=HEADERS,
    json={
        "prompt": "your prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/minimax/hailuo-02/i2v-standard
> - API docs: https://wavespeed.ai/docs/docs-api/minimax/hailuo-02-i2v-standard
...
**POST** `https://api.wavespeed.ai/api/v3/minimax/hailuo-02/i2v-standard`
