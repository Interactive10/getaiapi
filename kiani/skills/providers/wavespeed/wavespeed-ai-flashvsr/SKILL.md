---
name: wavespeed-wavespeed-ai-flashvsr
description: >
  Use this skill for the WaveSpeed AI FlashVSR Video Upscaler | Fast High-Quality Video Upscaling For Low-Resolution Footage model (wavespeed-ai/flashvsr). FlashVSR is a fast, high-quality video upscaler that boosts resolution and restores clarity for low-resolution or blurry footage. Ready-to-use REST inference API, best performance, no coldstarts, affo
---

# FlashVSR Video Upscaler | Fast High-Quality Video Upscaling For Low-Resolution Footage
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/flashvsr
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/flashvsr" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/flashvsr", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/flashvsr",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/flashvsr
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/flashvsr
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/flashvsr`
