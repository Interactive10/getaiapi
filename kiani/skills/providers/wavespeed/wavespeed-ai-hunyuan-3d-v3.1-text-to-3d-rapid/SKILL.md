---
name: wavespeed-wavespeed-ai-hunyuan-3d-v3.1-text-to-3d-rapid
description: >
  Use this skill for the WaveSpeed AI Hunyuan 3D V3.1 Rapid | Fast Text-To-3D AI Model Generation model (wavespeed-ai/hunyuan-3d-v3.1/text-to-3d-rapid). Hunyuan 3D V3.1 Rapid is a fast text-to-3D generation model that quickly creates 3D models from text descriptions. Ready-to-use REST inference API, best performance, no coldstarts, affordable pricing.
---

# Hunyuan 3D V3.1 Rapid | Fast Text-To-3D AI Model Generation
...
**Type:** Text to 3D
**Model:** `wavespeed-ai/hunyuan-3d-v3.1/text-to-3d-rapid`
**Source:** https://wavespeed.ai/models/wavespeed-ai/hunyuan-3d-v3.1/text-to-3d-rapid
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/hunyuan-3d-v3.1/text-to-3d-rapid" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/hunyuan-3d-v3.1/text-to-3d-rapid", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/hunyuan-3d-v3.1/text-to-3d-rapid",
    headers=HEADERS,
    json={
        "prompt": "a 3D model of a cat"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/hunyuan-3d-v3.1/text-to-3d-rapid
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/hunyuan-3d-v3.1-text-to-3d-rapid
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/hunyuan-3d-v3.1/text-to-3d-rapid`
