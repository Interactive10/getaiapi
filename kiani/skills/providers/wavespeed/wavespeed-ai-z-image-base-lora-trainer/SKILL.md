---
name: wavespeed-wavespeed-ai-z-image-base-lora-trainer
description: >
  Use this skill for the WaveSpeed AI Z-Image Base LoRA Trainer | Train Custom Z-Image LoRA Models model (wavespeed-ai/z-image/base-lora-trainer). Z-Image Base LoRA Trainer – train custom image LoRA models from your own dataset, with zip uploads, auto-tuned defaults and fast iteration for brand, character or IP looks. Ready-to-use REST inference
---

# Z-Image Base LoRA Trainer | Train Custom Z-Image LoRA Models
...
**Type:** LoRA Training
**Model:** `wavespeed-ai/z-image/base-lora-trainer`
**Source:** https://wavespeed.ai/models/wavespeed-ai/z-image/base-lora-trainer
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/z-image/base-lora-trainer", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/z-image/base-lora-trainer",
    headers=HEADERS,
    json={
        "images": [
            "https://example.com/img1.png",
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/z-image/base-lora-trainer
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/z-image-base-lora-trainer
...
**Additional parameters found on model page:** `Input`, `10`, `false`, `s`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/z-image/base-lora-trainer`
