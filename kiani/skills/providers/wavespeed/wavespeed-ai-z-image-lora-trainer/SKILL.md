---
name: wavespeed-wavespeed-ai-z-image-lora-trainer
description: >
  Use this skill for the WaveSpeed AI Z-Image-LoRA-trainer - Train custom Z-Image LoRA models 10x faster model (wavespeed-ai/z-image-lora-trainer). Z-Image-LoRA-Trainer – train custom image LoRA models from your own dataset, with zip uploads, auto-tuned defaults and fast iteration for brand, character or IP looks. Ready-to-use REST inference API,
---

# Z-Image-LoRA-trainer - Train custom Z-Image LoRA models 10x faster
...
**Type:** LoRA Training
**Model:** `wavespeed-ai/z-image-lora-trainer`
**Source:** https://wavespeed.ai/models/wavespeed-ai/z-image-lora-trainer
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/z-image-lora-trainer", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/z-image-lora-trainer",
    headers=HEADERS,
    json={
        "images": [
            "https://example.com/img1.png",
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/z-image-lora-trainer
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/z-image-lora-trainer
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/z-image-lora-trainer`
