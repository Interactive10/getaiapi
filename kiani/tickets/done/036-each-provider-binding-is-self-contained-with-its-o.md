---
id: "036"
title: "Each provider binding is self-contained with its own `param_map` (no shared category templates)"
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-036: Each provider binding is self-contained with its own `param_map` (no shared category templates)
...
Completion of each provider binding is self-contained with its own `param_map` (no shared category templates).
...
- AC-1: Each provider binding is self-contained with its own `param_map` (no shared category templates)

### Task breakdown
- [x] Each provider binding is self-contained with its own `param_map` (no shared category templates)
