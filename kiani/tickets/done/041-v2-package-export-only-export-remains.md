---
id: "041"
title: "`./v2` package export — only `\".\"` export remains"
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-041: `./v2` package export — only `"."` export remains
...
Completion of `./v2` package export — only `"."` export remains.
...
- AC-1: `./v2` package export — only `"."` export remains

### Task breakdown
- [x] `./v2` package export — only `"."` export remains
