---
id: "042"
title: "`registry/catalog.json`, `registry/categories.json` — v1-only registry files"
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-042: `registry/catalog.json`, `registry/categories.json` — v1-only registry files
...
Completion of `registry/catalog.json`, `registry/categories.json` — v1-only registry files.
...
- AC-1: `registry/catalog.json`, `registry/categories.json` — v1-only registry files

### Task breakdown
- [x] `registry/catalog.json`, `registry/categories.json` — v1-only registry files
