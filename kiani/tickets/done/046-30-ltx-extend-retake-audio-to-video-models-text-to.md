---
id: "046"
title: "30+ LTX extend/retake/audio-to-video models: `text-to-video`/`image-to-video` → `video-to-video` or `text-to-video` (correct primary input)"
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-046: 30+ LTX extend/retake/audio-to-video models: `text-to-video`/`image-to-video` → `video-to-video` or `text-to-video` (correct primary input)
...
Completion of 30+ ltx extend/retake/audio-to-video models: `text-to-video`/`image-to-video` → `video-to-video` or `text-to-video` (correct primary input).
...
- AC-1: 30+ LTX extend/retake/audio-to-video models: `text-to-video`/`image-to-video` → `video-to-video` or `text-to-video` (correct primary input)

### Task breakdown
- [x] 30+ LTX extend/retake/audio-to-video models: `text-to-video`/`image-to-video` → `video-to-video` or `text-to-video` (correct primary input)
