---
id: "051"
title: "6+ PixVerse models: `text-to-video` → `video-to-video`/`image-to-video` (video/image input required)"
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-051: 6+ PixVerse models: `text-to-video` → `video-to-video`/`image-to-video` (video/image input required)
...
Completion of 6+ pixverse models: `text-to-video` → `video-to-video`/`image-to-video` (video/image input required).
...
- AC-1: 6+ PixVerse models: `text-to-video` → `video-to-video`/`image-to-video` (video/image input required)

### Task breakdown
- [x] 6+ PixVerse models: `text-to-video` → `video-to-video`/`image-to-video` (video/image input required)
