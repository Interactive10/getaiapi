---
id: "054"
title: "Gemini/GLM image models: `image-edit` → `text-to-image` (no image input required)"
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-054: Gemini/GLM image models: `image-edit` → `text-to-image` (no image input required)
...
Completion of gemini/glm image models: `image-edit` → `text-to-image` (no image input required).
...
- AC-1: Gemini/GLM image models: `image-edit` → `text-to-image` (no image input required)

### Task breakdown
- [x] Gemini/GLM image models: `image-edit` → `text-to-image` (no image input required)
