---
id: "055"
title: "Voice clone/embedding models: `text-to-audio` → `training` (outputs voice ID/embedding, not audio)"
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-055: Voice clone/embedding models: `text-to-audio` → `training` (outputs voice ID/embedding, not audio)
...
Completion of voice clone/embedding models: `text-to-audio` → `training` (outputs voice id/embedding, not audio).
...
- AC-1: Voice clone/embedding models: `text-to-audio` → `training` (outputs voice ID/embedding, not audio)

### Task breakdown
- [x] Voice clone/embedding models: `text-to-audio` → `training` (outputs voice ID/embedding, not audio)
