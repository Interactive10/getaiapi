---
id: "090"
title: "**Text generation category**: New `text-generation` category template for prompt-in, text-out workflows."
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-090: **Text generation category**: New `text-generation` category template for prompt-in, text-out workflows.
...
Completion of **text generation category**: new `text-generation` category template for prompt-in, text-out workflows..
...
- AC-1: **Text generation category**: New `text-generation` category template for prompt-in, text-out workflows.

### Task breakdown
- [x] **Text generation category**: New `text-generation` category template for prompt-in, text-out workflows.
