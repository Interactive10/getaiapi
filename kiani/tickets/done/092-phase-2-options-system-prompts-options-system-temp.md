---
id: "092"
title: "**Phase 2 options**: System prompts (`options.system`), `temperature`, `max_tokens`, `top_p` via `options` passthrough."
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-092: **Phase 2 options**: System prompts (`options.system`), `temperature`, `max_tokens`, `top_p` via `options` passthrough.
...
Completion of **phase 2 options**: system prompts (`options.system`), `temperature`, `max_tokens`, `top_p` via `options` passthrough..
...
- AC-1: **Phase 2 options**: System prompts (`options.system`), `temperature`, `max_tokens`, `top_p` via `options` passthrough.

### Task breakdown
- [x] **Phase 2 options**: System prompts (`options.system`), `temperature`, `max_tokens`, `top_p` via `options` passthrough.
