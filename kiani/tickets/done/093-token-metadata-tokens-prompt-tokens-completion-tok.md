---
id: "093"
title: "**Token metadata**: `tokens`, `prompt_tokens`, `completion_tokens` fields on `GenerateResponse.metadata` for cost tracking."
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-093: **Token metadata**: `tokens`, `prompt_tokens`, `completion_tokens` fields on `GenerateResponse.metadata` for cost tracking.
...
Completion of **token metadata**: `tokens`, `prompt_tokens`, `completion_tokens` fields on `generateresponse.metadata` for cost tracking..
...
- AC-1: **Token metadata**: `tokens`, `prompt_tokens`, `completion_tokens` fields on `GenerateResponse.metadata` for cost tracking.

### Task breakdown
- [x] **Token metadata**: `tokens`, `prompt_tokens`, `completion_tokens` fields on `GenerateResponse.metadata` for cost tracking.
