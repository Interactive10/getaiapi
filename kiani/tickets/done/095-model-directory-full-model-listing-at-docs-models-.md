---
id: "095"
title: "**Model directory**: Full model listing at `docs/MODELS.md` with provider availability."
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-095: **Model directory**: Full model listing at `docs/MODELS.md` with provider availability.
...
Completion of **model directory**: full model listing at `docs/models.md` with provider availability..
...
- AC-1: **Model directory**: Full model listing at `docs/MODELS.md` with provider availability.

### Task breakdown
- [x] **Model directory**: Full model listing at `docs/MODELS.md` with provider availability.
