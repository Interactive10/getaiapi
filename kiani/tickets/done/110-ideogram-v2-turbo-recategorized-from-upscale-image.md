---
id: "110"
title: "**ideogram-v2-turbo**: Recategorized from `upscale-image` to `text-to-image` (prompt-only generation model, not an upscaler)"
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-110: **ideogram-v2-turbo**: Recategorized from `upscale-image` to `text-to-image` (prompt-only generation model, not an upscaler)
...
Completion of **ideogram-v2-turbo**: recategorized from `upscale-image` to `text-to-image` (prompt-only generation model, not an upscaler).
...
- AC-1: **ideogram-v2-turbo**: Recategorized from `upscale-image` to `text-to-image` (prompt-only generation model, not an upscaler)

### Task breakdown
- [x] **ideogram-v2-turbo**: Recategorized from `upscale-image` to `text-to-image` (prompt-only generation model, not an upscaler)
