---
id: "111"
title: "**ideogram-v2a-turbo**: Recategorized from `upscale-image` to `text-to-image` (prompt-only generation model, not an upscaler)"
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-111: **ideogram-v2a-turbo**: Recategorized from `upscale-image` to `text-to-image` (prompt-only generation model, not an upscaler)
...
Completion of **ideogram-v2a-turbo**: recategorized from `upscale-image` to `text-to-image` (prompt-only generation model, not an upscaler).
...
- AC-1: **ideogram-v2a-turbo**: Recategorized from `upscale-image` to `text-to-image` (prompt-only generation model, not an upscaler)

### Task breakdown
- [x] **ideogram-v2a-turbo**: Recategorized from `upscale-image` to `text-to-image` (prompt-only generation model, not an upscaler)
