---
id: "144"
title: "add multi-image reference support for image-edit models"
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-144: add multi-image reference support for image-edit models
...
add multi-image reference support for image-edit models

### Key metric

Completion of add multi-image reference support for image-edit models.
...
- AC-1: add multi-image reference support for image-edit models

### Task breakdown
- [x] add multi-image reference support for image-edit models
