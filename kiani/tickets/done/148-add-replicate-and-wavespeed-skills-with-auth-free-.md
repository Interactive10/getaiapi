---
id: "148"
title: "add Replicate and WaveSpeed skills with auth-free scrapers"
priority: P2
complexity: S
depends_on: []
area: "build"
...
# PDD-148: add Replicate and WaveSpeed skills with auth-free scrapers

## Product — PM

### Problem

Discovered from git log (feat commit)

### Proposal

add Replicate and WaveSpeed skills with auth-free scrapers

### Key metric

Completion of add replicate and wavespeed skills with auth-free scrapers.
...
Auto-discovered from git log. Review and update as needed.
...
- AC-1: add Replicate and WaveSpeed skills with auth-free scrapers

### Task breakdown
- [x] add Replicate and WaveSpeed skills with auth-free scrapers
