...
description: >
  Use this skill for the fal.ai ACE-Step model (fal-ai/ace-step). Generate music with lyrics from text using ACE-Step
---
...
**Source:** https://fal.ai/models/fal-ai/ace-step/api
...
- API page: https://fal.ai/models/fal-ai/ace-step/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ace-step
