---
name: fal-ai-bria-fibo-generate
description: >
  Use this skill for the fal.ai Fibo model (bria/fibo/generate). SOTA Open source model trained on licensed data, transforming intent into structured control for precise, high-quality AI image generation in enterprise and agentic workflows.
---
...
**Source:** https://fal.ai/models/bria/fibo/generate/api
...
| `resolution` | enum: `1MP`, `4MP` | No | `"1MP"` | Output image resolution |
...
- API page: https://fal.ai/models/bria/fibo/generate/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=bria/fibo/generate
