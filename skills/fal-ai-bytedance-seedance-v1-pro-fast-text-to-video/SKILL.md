---
name: fal-ai-bytedance-seedance-v1-pro-fast-text-to-video
description: >
  Use this skill for the fal.ai Bytedance model (fal-ai/bytedance/seedance/v1/pro/fast/text-to-video). Text to Video endpoint for Seedance 1.0 Pro Fast, a next-generation video model designed to deliver maximum performance at minimal cost
---
...
**Source:** https://fal.ai/models/fal-ai/bytedance/seedance/v1/pro/fast/text-to-video/api
...
- API page: https://fal.ai/models/fal-ai/bytedance/seedance/v1/pro/fast/text-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/bytedance/seedance/v1/pro/fast/text-to-video
