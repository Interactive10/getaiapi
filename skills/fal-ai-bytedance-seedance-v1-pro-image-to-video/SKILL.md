...
description: >
  Use this skill for the fal.ai Seedance 1.0 Pro model (fal-ai/bytedance/seedance/v1/pro/image-to-video). Seedance 1.0 Pro, a high quality video generation model developed by Bytedance.
---
...
**Source:** https://fal.ai/models/fal-ai/bytedance/seedance/v1/pro/image-to-video/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/bytedance/seedance/v1/pro/image-to-video", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/bytedance/seedance/v1/pro/image-to-video", {
...
- API page: https://fal.ai/models/fal-ai/bytedance/seedance/v1/pro/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/bytedance/seedance/v1/pro/image-to-video
