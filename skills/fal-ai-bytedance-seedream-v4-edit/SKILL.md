...
description: >
  Use this skill for the fal.ai Bytedance Seedream v4 Edit model (fal-ai/bytedance/seedream/v4/edit). A new-generation image creation model ByteDance, Seedream 4.0 integrates image generation and image editing capabilities into a single, unified architecture.
---
...
| `image_size` | ImageSize | enum (9 values) | No | `{'height': 2048, 'width': 2048}` | The size of the generated image. The minimum total image area is 921600 pixels. Failing this, the image size will be ... |
...
- API page: https://fal.ai/models/fal-ai/bytedance/seedream/v4/edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/bytedance/seedream/v4/edit
