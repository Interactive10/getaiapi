...
name: fal-ai-dia-tts
description: >
  Use this skill for the fal.ai Dia model (fal-ai/dia-tts). Dia directly generates realistic dialogue from transcripts. Audio conditioning enables emotion control. Produces natural nonverbals like laughter and throat clearing.
---
...
**Source:** https://fal.ai/models/fal-ai/dia-tts/api
...
- API page: https://fal.ai/models/fal-ai/dia-tts/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/dia-tts
