---
name: fal-ai-fashn-tryon-v1.6
description: >
  Use this skill for the fal.ai FASHN Virtual Try-On V1.6 model (fal-ai/fashn/tryon/v1.6). FASHN v1.6 delivers precise virtual try-on capabilities, accurately rendering garment details like text and patterns at 864x1296 resolution from both on-model and flat-lay photo references.
---
...
**Source:** https://fal.ai/models/fal-ai/fashn/tryon/v1.6/api
...
- API page: https://fal.ai/models/fal-ai/fashn/tryon/v1.6/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fashn/tryon/v1.6
