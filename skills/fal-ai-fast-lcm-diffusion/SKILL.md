---
name: fal-ai-fast-lcm-diffusion
description: >
  Use this skill for the fal.ai Latent Consistency Models (v1.5/XL) model (fal-ai/fast-lcm-diffusion). Run SDXL at the speed of light
---
...
**Endpoint:** `fal-ai/fast-lcm-diffusion`
**Source:** https://fal.ai/models/fal-ai/fast-lcm-diffusion/api
...
- API page: https://fal.ai/models/fal-ai/fast-lcm-diffusion/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-lcm-diffusion
