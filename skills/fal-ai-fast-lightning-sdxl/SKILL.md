...
description: >
  Use this skill for the fal.ai Stable Diffusion XL Lightning model (fal-ai/fast-lightning-sdxl). Run SDXL at the speed of light
---
...
**Source:** https://fal.ai/models/fal-ai/fast-lightning-sdxl/api
...
- API page: https://fal.ai/models/fal-ai/fast-lightning-sdxl/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-lightning-sdxl
