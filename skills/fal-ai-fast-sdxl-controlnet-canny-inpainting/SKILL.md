---
name: fal-ai-fast-sdxl-controlnet-canny-inpainting
description: >
  Use this skill for the fal.ai ControlNet SDXL model (fal-ai/fast-sdxl-controlnet-canny/inpainting). Generate Images with ControlNet.
---
...
**Endpoint:** `fal-ai/fast-sdxl-controlnet-canny/inpainting`
**Source:** https://fal.ai/models/fal-ai/fast-sdxl-controlnet-canny/inpainting/api
...
- API page: https://fal.ai/models/fal-ai/fast-sdxl-controlnet-canny/inpainting/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-sdxl-controlnet-canny/inpainting
