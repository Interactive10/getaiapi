...
description: >
  Use this skill for the fal.ai Stable Diffusion XL model (fal-ai/fast-sdxl). Run SDXL at the speed of light
---
...
**Source:** https://fal.ai/models/fal-ai/fast-sdxl/api
...
- API page: https://fal.ai/models/fal-ai/fast-sdxl/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/fast-sdxl
