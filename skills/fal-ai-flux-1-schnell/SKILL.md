...
description: >
  Use this skill for the fal.ai FLUX.1 [schnell] model (fal-ai/flux-1/schnell). Fastest inference in the world for the 12 billion parameter FLUX.1 [schnell] text-to-image model.
---
...
**Source:** https://fal.ai/models/fal-ai/flux-1/schnell/api
...
- API page: https://fal.ai/models/fal-ai/flux-1/schnell/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-1/schnell
