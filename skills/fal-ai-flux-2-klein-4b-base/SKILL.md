---
name: fal-ai-flux-2-klein-4b-base
description: >
  Use this skill for the fal.ai Flux 2 [klein] 4B Base model (fal-ai/flux-2/klein/4b/base). Text-to-image generation with Flux 2 [klein] 4B Base from Black Forest Labs. Enhanced realism, crisper text generation, and native editing capabilities.
---
...
- API page: https://fal.ai/models/fal-ai/flux-2/klein/4b/base/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2/klein/4b/base
