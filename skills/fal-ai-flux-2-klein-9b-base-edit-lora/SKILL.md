---
name: fal-ai-flux-2-klein-9b-base-edit-lora
description: >
  Use this skill for the fal.ai Flux 2 [klein] 9B Base Lora model (fal-ai/flux-2/klein/9b/base/edit/lora). Image-to-image editing with LoRA support for FLUX.2 [klein] 9B Base from Black Forest Labs. Specialized style transfer and domain-specific modifications.
---
...
**Source:** https://fal.ai/models/fal-ai/flux-2/klein/9b/base/edit/lora/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/flux-2/klein/9b/base/edit/lora", {
  input: {
        "prompt": "your value here",
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/flux-2/klein/9b/base/edit/lora", {
...
```javascript
const result = await fal.queue.result("fal-ai/flux-2/klein/9b/base/edit/lora", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/flux-2/klein/9b/base/edit/lora/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-2/klein/9b/base/edit/lora
