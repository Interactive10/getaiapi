---
name: fal-ai-flux-general
description: >
  Use this skill for the fal.ai FLUX.1 [dev] with Controlnets and Loras model (fal-ai/flux-general). A versatile endpoint for the FLUX.1 [dev] model that supports multiple AI extensions including LoRA, ControlNet conditioning, and IP-Adapter integration, enabling comprehensive control over image gene
---
...
**Source:** https://fal.ai/models/fal-ai/flux-general/api
...
- API page: https://fal.ai/models/fal-ai/flux-general/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-general
