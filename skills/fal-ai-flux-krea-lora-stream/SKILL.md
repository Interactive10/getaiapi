---
name: fal-ai-flux-krea-lora-stream
description: >
  Use this skill for the fal.ai Flux Krea Lora model (fal-ai/flux-krea-lora/stream). Super fast endpoint for the FLUX.1 [dev] model with LoRA support, enabling rapid and high-quality image generation using pre-trained LoRA adaptations for personalization, specific styles, brand identi
---
...
**Endpoint:** `fal-ai/flux-krea-lora/stream`
**Source:** https://fal.ai/models/fal-ai/flux-krea-lora/stream/api
...
- API page: https://fal.ai/models/fal-ai/flux-krea-lora/stream/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-krea-lora/stream
