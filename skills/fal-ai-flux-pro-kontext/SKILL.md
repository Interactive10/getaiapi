...
description: >
  Use this skill for the fal.ai FLUX.1 Kontext [pro] model (fal-ai/flux-pro/kontext). FLUX.1 Kontext [pro] handles both text and reference images as inputs, seamlessly enabling targeted, local edits and complex transformations of entire scenes.
---
...
- API page: https://fal.ai/models/fal-ai/flux-pro/kontext/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-pro/kontext
