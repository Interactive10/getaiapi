---
name: fal-ai-flux-pro-v1-fill-finetuned
description: >
  Use this skill for the fal.ai FLUX.1 [pro] Fill Fine-tuned model (fal-ai/flux-pro/v1/fill-finetuned). FLUX.1 [pro] Fill Fine-tuned is a high-performance endpoint for the FLUX.1 [pro] model with a fine-tuned LoRA that enables rapid transformation of existing images, delivering high-quality style transf
---
...
**Source:** https://fal.ai/models/fal-ai/flux-pro/v1/fill-finetuned/api
...
| `finetune_strength` | float | **Yes** |  | Controls finetune influence.         Increase this value if your target concept isn't showing up strongly enough.    ... |
| `output_format` | enum: `jpeg`, `png` | No | `"jpeg"` | The format of the generated image. |
| `finetune_id` | string | **Yes** |  | References your specific model |
...
- API page: https://fal.ai/models/fal-ai/flux-pro/v1/fill-finetuned/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/flux-pro/v1/fill-finetuned
