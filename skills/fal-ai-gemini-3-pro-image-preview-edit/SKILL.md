---
name: fal-ai-gemini-3-pro-image-preview-edit
description: >
  Use this skill for the fal.ai Gemini 3 Pro Image Preview model (fal-ai/gemini-3-pro-image-preview/edit). Gemini 3 Pro Image (a.k.a Nano Banana Pro) is Google's state-of-the-art high-fidelity image generation and editing model
---
...
**Source:** https://fal.ai/models/fal-ai/gemini-3-pro-image-preview/edit/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/gemini-3-pro-image-preview/edit", {
  input: {
        "prompt": "your value here",
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/gemini-3-pro-image-preview/edit", {
...
```javascript
const result = await fal.queue.result("fal-ai/gemini-3-pro-image-preview/edit", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/gemini-3-pro-image-preview/edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/gemini-3-pro-image-preview/edit
