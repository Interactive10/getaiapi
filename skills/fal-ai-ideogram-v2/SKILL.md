...
description: >
  Use this skill for the fal.ai Ideogram V2 model (fal-ai/ideogram/v2). Generate high-quality images, posters, and logos with Ideogram V2. Features exceptional typography handling and realistic outputs optimized for commercial and creative use.
---
...
**Source:** https://fal.ai/models/fal-ai/ideogram/v2/api
...
- API page: https://fal.ai/models/fal-ai/ideogram/v2/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ideogram/v2
