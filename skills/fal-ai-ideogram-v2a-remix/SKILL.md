---
name: fal-ai-ideogram-v2a-remix
description: >
  Use this skill for the fal.ai Ideogram V2A Remix model (fal-ai/ideogram/v2a/remix). Create variations of existing images with Ideogram V2A Remix while maintaining creative control through prompt guidance.
---
...
**Endpoint:** `fal-ai/ideogram/v2a/remix`
**Source:** https://fal.ai/models/fal-ai/ideogram/v2a/remix/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ideogram/v2a/remix", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/ideogram/v2a/remix", {
...
```javascript
const result = await fal.queue.result("fal-ai/ideogram/v2a/remix", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ideogram/v2a/remix/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ideogram/v2a/remix
