---
name: fal-ai-image-editing-background-change
description: >
  Use this skill for the fal.ai Image Editing model (fal-ai/image-editing/background-change). Replace your photo's background with any scene you desire, from beach sunsets to urban landscapes, with perfect lighting and shadows
---
...
**Source:** https://fal.ai/models/fal-ai/image-editing/background-change/api
...
| --- | --- | --- | --- | --- |
| `prompt` | string | No | `"beach sunset with palm trees"` | The desired background to apply. |
...
- API page: https://fal.ai/models/fal-ai/image-editing/background-change/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/image-editing/background-change
