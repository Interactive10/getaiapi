---
name: fal-ai-image-editing-cartoonify
description: >
  Use this skill for the fal.ai Image Editing model (fal-ai/image-editing/cartoonify). Transform your photos into vibrant cool cartoons with bold outlines and rich colors.
---
...
**Endpoint:** `fal-ai/image-editing/cartoonify`
**Source:** https://fal.ai/models/fal-ai/image-editing/cartoonify/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/image-editing/cartoonify", {
  input: {
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/image-editing/cartoonify", {
...
```javascript
const result = await fal.queue.result("fal-ai/image-editing/cartoonify", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/image-editing/cartoonify/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/image-editing/cartoonify
