---
name: fal-ai-image-editing-face-enhancement
description: >
  Use this skill for the fal.ai Image Editing model (fal-ai/image-editing/face-enhancement). Enhance facial features with professional retouching while maintaining a natural, realistic look
---
...
**Source:** https://fal.ai/models/fal-ai/image-editing/face-enhancement/api
...
- API page: https://fal.ai/models/fal-ai/image-editing/face-enhancement/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/image-editing/face-enhancement
