---
name: fal-ai-image-editing-object-removal
description: >
  Use this skill for the fal.ai Image Editing model (fal-ai/image-editing/object-removal). Remove unwanted objects or people from your photos while seamlessly blending the background.
---
...
**Source:** https://fal.ai/models/fal-ai/image-editing/object-removal/api
...
| --- | --- | --- | --- | --- |
| `prompt` | string | No | `"background people"` | Specify which objects to remove from the image. |
...
- API page: https://fal.ai/models/fal-ai/image-editing/object-removal/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/image-editing/object-removal
