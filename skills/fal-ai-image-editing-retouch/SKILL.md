---
name: fal-ai-image-editing-retouch
description: >
  Use this skill for the fal.ai Image Editing model (fal-ai/image-editing/retouch). Retouch photos of faces. Remove blemishes and improve the skin.
---
...
**Source:** https://fal.ai/models/fal-ai/image-editing/retouch/api
...
const result = await fal.subscribe("fal-ai/image-editing/retouch", {
  input: {
...
| `image_url` | string | **Yes** |  | URL of the image to retouch. |
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/image-editing/retouch", {
  input: {
        "image_url": "https://example.com/input.png"
    },
...
- API page: https://fal.ai/models/fal-ai/image-editing/retouch/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/image-editing/retouch
