---
name: fal-ai-image-editing-style-transfer
description: >
  Use this skill for the fal.ai Image Editing model (fal-ai/image-editing/style-transfer). Transform your photos into artistic masterpieces inspired by famous styles like Van Gogh's Starry Night or any artistic style you choose.
---
...
**Source:** https://fal.ai/models/fal-ai/image-editing/style-transfer/api
...
| --- | --- | --- | --- | --- |
| `prompt` | string | No | `"Van Gogh's Starry Night"` | The artistic style to apply. |
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/image-editing/style-transfer", {
  input: {
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/image-editing/style-transfer", {
...
```javascript
const result = await fal.queue.result("fal-ai/image-editing/style-transfer", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/image-editing/style-transfer/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/image-editing/style-transfer
