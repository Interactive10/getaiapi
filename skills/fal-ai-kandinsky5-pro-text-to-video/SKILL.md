---
name: fal-ai-kandinsky5-pro-text-to-video
description: >
  Use this skill for the fal.ai Kandinsky5 Pro model (fal-ai/kandinsky5-pro/text-to-video). Kandinsky 5.0 Pro is a diffusion model for fast, high-quality text-to-video generation.
---
...
**Endpoint:** `fal-ai/kandinsky5-pro/text-to-video`
**Source:** https://fal.ai/models/fal-ai/kandinsky5-pro/text-to-video/api
...
| `duration` | string | No | `"5s"` | The length of the video to generate (5s or 10s) |
...
- API page: https://fal.ai/models/fal-ai/kandinsky5-pro/text-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kandinsky5-pro/text-to-video
