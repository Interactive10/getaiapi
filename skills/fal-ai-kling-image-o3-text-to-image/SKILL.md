---
name: fal-ai-kling-image-o3-text-to-image
description: >
  Use this skill for the fal.ai Kling Image model (fal-ai/kling-image/o3/text-to-image). Kling Omni 3: Top-tier text-to-image with flawless consistency.
---
...
**Source:** https://fal.ai/models/fal-ai/kling-image/o3/text-to-image/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/kling-image/o3/text-to-image", {
  input: {
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/kling-image/o3/text-to-image", {
...
```javascript
const result = await fal.queue.result("fal-ai/kling-image/o3/text-to-image", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/kling-image/o3/text-to-image/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-image/o3/text-to-image
