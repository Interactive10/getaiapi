---
name: fal-ai-leffa-pose-transfer
description: >
  Use this skill for the fal.ai Leffa Pose Transfer model (fal-ai/leffa/pose-transfer). Leffa Pose Transfer is an endpoint for changing pose of an image with a reference image.
---
...
**Source:** https://fal.ai/models/fal-ai/leffa/pose-transfer/api
...
const result = await fal.subscribe("fal-ai/leffa/pose-transfer", {
  input: {
        "pose_image_url": "https://example.com/input.png",
...
| --- | --- | --- | --- | --- |
| `pose_image_url` | string | **Yes** |  | Url for the human image. |
...
| `person_image_url` | string | **Yes** |  | Url to the garment image. |
...
- API page: https://fal.ai/models/fal-ai/leffa/pose-transfer/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/leffa/pose-transfer
