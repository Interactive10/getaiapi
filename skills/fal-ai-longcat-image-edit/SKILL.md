---
name: fal-ai-longcat-image-edit
description: >
  Use this skill for the fal.ai Longcat Image model (fal-ai/longcat-image/edit). LongCat image Edit is a 6B parameter image editing model excelling at multilingual text rendering, photorealism and deployment efficiency.
---
...
**Endpoint:** `fal-ai/longcat-image/edit`
**Source:** https://fal.ai/models/fal-ai/longcat-image/edit/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/longcat-image/edit", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/longcat-image/edit", {
...
```javascript
const result = await fal.queue.result("fal-ai/longcat-image/edit", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/longcat-image/edit/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/longcat-image/edit
