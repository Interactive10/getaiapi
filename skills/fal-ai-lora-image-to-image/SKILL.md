---
name: fal-ai-lora-image-to-image
description: >
  Use this skill for the fal.ai Stable Diffusion with LoRAs model (fal-ai/lora/image-to-image). Run Any Stable Diffusion model with customizable LoRA weights.
---
...
**Source:** https://fal.ai/models/fal-ai/lora/image-to-image/api
...
- API page: https://fal.ai/models/fal-ai/lora/image-to-image/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/lora/image-to-image
