---
name: fal-ai-ltx-2-19b-distilled-audio-to-video
description: >
  Use this skill for the fal.ai LTX-2 19B Distilled model (fal-ai/ltx-2-19b/distilled/audio-to-video). Generate video with audio from audio, text and images using LTX-2 Distilled
---
...
**Endpoint:** `fal-ai/ltx-2-19b/distilled/audio-to-video`
**Source:** https://fal.ai/models/fal-ai/ltx-2-19b/distilled/audio-to-video/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ltx-2-19b/distilled/audio-to-video", {
  input: {
        "prompt": "your value here",
        "audio_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/ltx-2-19b/distilled/audio-to-video", {
...
```javascript
const result = await fal.queue.result("fal-ai/ltx-2-19b/distilled/audio-to-video", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ltx-2-19b/distilled/audio-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2-19b/distilled/audio-to-video
