---
name: fal-ai-ltx-video-v095-multiconditioning
description: >
  Use this skill for the fal.ai LTX Video-0.9.5 model (fal-ai/ltx-video-v095/multiconditioning). Generate videos from prompts,images, and videos using LTX Video-0.9.5
---
...
**Endpoint:** `fal-ai/ltx-video-v095/multiconditioning`
**Source:** https://fal.ai/models/fal-ai/ltx-video-v095/multiconditioning/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ltx-video-v095/multiconditioning", {
  input: {
        "prompt": "your value here"
    },
...
```javascript
const status = await fal.queue.status("fal-ai/ltx-video-v095/multiconditioning", {
...
```javascript
const result = await fal.queue.result("fal-ai/ltx-video-v095/multiconditioning", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ltx-video-v095/multiconditioning/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-video-v095/multiconditioning
