---
name: fal-ai-ltxv-13b-098-distilled-extend
description: >
  Use this skill for the fal.ai LTX-Video 13B 0.9.8 Distilled model (fal-ai/ltxv-13b-098-distilled/extend). Extend videos using LTX Video-0.9.8 13B Distilled and custom LoRA
---
...
**Endpoint:** `fal-ai/ltxv-13b-098-distilled/extend`
**Source:** https://fal.ai/models/fal-ai/ltxv-13b-098-distilled/extend/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/ltxv-13b-098-distilled/extend", {
  input: {
        "prompt": "your value here",
        "video": "..."
    },
...
```javascript
const status = await fal.queue.status("fal-ai/ltxv-13b-098-distilled/extend", {
...
```javascript
const result = await fal.queue.result("fal-ai/ltxv-13b-098-distilled/extend", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/ltxv-13b-098-distilled/extend/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltxv-13b-098-distilled/extend
