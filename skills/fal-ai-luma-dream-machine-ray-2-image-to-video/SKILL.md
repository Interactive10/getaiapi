...
description: >
  Use this skill for the fal.ai Luma Ray 2 (Image to Video) model (fal-ai/luma-dream-machine/ray-2/image-to-video). Ray2 is a large-scale video generative model capable of creating realistic visuals with natural, coherent motion.
---
...
**Source:** https://fal.ai/models/fal-ai/luma-dream-machine/ray-2/image-to-video/api
...
- API page: https://fal.ai/models/fal-ai/luma-dream-machine/ray-2/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/luma-dream-machine/ray-2/image-to-video
