---
name: fal-ai-pixverse-v3.5-text-to-video-fast
description: >
  Use this skill for the fal.ai PixVerse v3.5 Fast model (fal-ai/pixverse/v3.5/text-to-video/fast). Generate high quality video clips quickly from text prompts using PixVerse v3.5 Fast
---
...
**Endpoint:** `fal-ai/pixverse/v3.5/text-to-video/fast`
**Source:** https://fal.ai/models/fal-ai/pixverse/v3.5/text-to-video/fast/api
...
- API page: https://fal.ai/models/fal-ai/pixverse/v3.5/text-to-video/fast/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/pixverse/v3.5/text-to-video/fast
