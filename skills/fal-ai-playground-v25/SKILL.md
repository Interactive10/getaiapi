...
description: >
  Use this skill for the fal.ai Playground v2.5 model (fal-ai/playground-v25). State-of-the-art open-source model in aesthetic quality
---
...
**Source:** https://fal.ai/models/fal-ai/playground-v25/api
...
- API page: https://fal.ai/models/fal-ai/playground-v25/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/playground-v25
