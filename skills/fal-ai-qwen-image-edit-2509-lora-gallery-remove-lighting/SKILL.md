---
name: fal-ai-qwen-image-edit-2509-lora-gallery-remove-lighting
description: >
  Use this skill for the fal.ai Qwen Image Edit 2509 Lora Gallery model (fal-ai/qwen-image-edit-2509-lora-gallery/remove-lighting). Remove existing lighting and apply soft, even illumination
---
...
**Endpoint:** `fal-ai/qwen-image-edit-2509-lora-gallery/remove-lighting`
**Source:** https://fal.ai/models/fal-ai/qwen-image-edit-2509-lora-gallery/remove-lighting/api
...
const result = await fal.subscribe("fal-ai/qwen-image-edit-2509-lora-gallery/remove-lighting", {
  input: {
        "image_urls": []
    },
  logs: true,
...
| `image_urls` | list<string> | **Yes** |  | The URL of the image with lighting/shadows to remove. |
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/qwen-image-edit-2509-lora-gallery/remove-lighting", {
  input: {
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/qwen-image-edit-2509-lora-gallery/remove-lighting", {
...
```javascript
const result = await fal.queue.result("fal-ai/qwen-image-edit-2509-lora-gallery/remove-lighting", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/qwen-image-edit-2509-lora-gallery/remove-lighting/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-edit-2509-lora-gallery/remove-lighting
