---
name: fal-ai-qwen-image-edit-2509-lora-gallery-shirt-design
description: >
  Use this skill for the fal.ai Qwen Image Edit 2509 Lora Gallery model (fal-ai/qwen-image-edit-2509-lora-gallery/shirt-design). Apply designs/graphics onto people's shirts
---
...
**Endpoint:** `fal-ai/qwen-image-edit-2509-lora-gallery/shirt-design`
**Source:** https://fal.ai/models/fal-ai/qwen-image-edit-2509-lora-gallery/shirt-design/api
...
| --- | --- | --- | --- | --- |
| `prompt` | string | No | `"Put this design on their shirt"` | Describe what design to put on the shirt. The model will apply the design from your input image onto the person's shirt. |
...
| `image_urls` | list<string> | **Yes** |  | The URLs of the images: first image is the person wearing a shirt, second image is the design/logo to put on the shirt. |
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/qwen-image-edit-2509-lora-gallery/shirt-design", {
  input: {
        "image_urls": []
    },
...
```javascript
const status = await fal.queue.status("fal-ai/qwen-image-edit-2509-lora-gallery/shirt-design", {
...
```javascript
const result = await fal.queue.result("fal-ai/qwen-image-edit-2509-lora-gallery/shirt-design", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/qwen-image-edit-2509-lora-gallery/shirt-design/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-edit-2509-lora-gallery/shirt-design
