---
name: fal-ai-qwen-image-edit-plus-lora-gallery-remove-element
description: >
  Use this skill for the fal.ai Qwen Image Edit Plus Lora Gallery model (fal-ai/qwen-image-edit-plus-lora-gallery/remove-element). Remove unwanted elements (objects, people, text) while maintaining image consistency
---
...
**Source:** https://fal.ai/models/fal-ai/qwen-image-edit-plus-lora-gallery/remove-element/api
...
- API page: https://fal.ai/models/fal-ai/qwen-image-edit-plus-lora-gallery/remove-element/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/qwen-image-edit-plus-lora-gallery/remove-element
