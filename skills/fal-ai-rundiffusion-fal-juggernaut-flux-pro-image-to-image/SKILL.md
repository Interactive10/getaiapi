---
name: fal-ai-rundiffusion-fal-juggernaut-flux-pro-image-to-image
description: >
  Use this skill for the fal.ai Juggernaut Flux Pro model (rundiffusion-fal/juggernaut-flux/pro/image-to-image). Juggernaut Pro Flux by RunDiffusion is the flagship Juggernaut model rivaling some of the most advanced image models available, often surpassing them in realism. It combines Juggernaut Base with RunDi
---
...
**Source:** https://fal.ai/models/rundiffusion-fal/juggernaut-flux/pro/image-to-image/api
...
```javascript
const { request_id } = await fal.queue.submit("rundiffusion-fal/juggernaut-flux/pro/image-to-image", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png"
    },
...
```javascript
const status = await fal.queue.status("rundiffusion-fal/juggernaut-flux/pro/image-to-image", {
...
```javascript
const result = await fal.queue.result("rundiffusion-fal/juggernaut-flux/pro/image-to-image", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/rundiffusion-fal/juggernaut-flux/pro/image-to-image/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=rundiffusion-fal/juggernaut-flux/pro/image-to-image
