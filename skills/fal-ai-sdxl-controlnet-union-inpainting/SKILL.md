---
name: fal-ai-sdxl-controlnet-union-inpainting
description: >
  Use this skill for the fal.ai SDXL ControlNet Union model (fal-ai/sdxl-controlnet-union/inpainting). An efficent SDXL multi-controlnet inpainting model.
---
...
**Source:** https://fal.ai/models/fal-ai/sdxl-controlnet-union/inpainting/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/sdxl-controlnet-union/inpainting", {
  input: {
        "prompt": "your value here",
        "image_url": "https://example.com/input.png",
        "mask_url": "https://example.com/input.png"
...
```javascript
const status = await fal.queue.status("fal-ai/sdxl-controlnet-union/inpainting", {
...
```javascript
const result = await fal.queue.result("fal-ai/sdxl-controlnet-union/inpainting", {
  requestId: "<request_id>",
});
console.log(result.data);
```
...
- API page: https://fal.ai/models/fal-ai/sdxl-controlnet-union/inpainting/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/sdxl-controlnet-union/inpainting
