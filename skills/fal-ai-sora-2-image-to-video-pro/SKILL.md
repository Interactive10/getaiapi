---
name: fal-ai-sora-2-image-to-video-pro
description: >
  Use this skill for the fal.ai Sora 2 model (fal-ai/sora-2/image-to-video/pro). Image-to-video endpoint for Sora 2 Pro, OpenAI's state-of-the-art video model capable of creating richly detailed, dynamic clips with audio from natural language or images.
---
...
| `resolution` | enum: `auto`, `720p`, `1080p` | No | `"auto"` | The resolution of the generated video |
...
- API page: https://fal.ai/models/fal-ai/sora-2/image-to-video/pro/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/sora-2/image-to-video/pro
