---
name: fal-ai-veed-fabric-1.0
description: >
  Use this skill for the fal.ai Fabric 1.0 model (veed/fabric-1.0). VEED Fabric 1.0 is an image-to-video API that turns any image into a talking video
---
...
**Source:** https://fal.ai/models/veed/fabric-1.0/api
...
- API page: https://fal.ai/models/veed/fabric-1.0/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=veed/fabric-1.0
