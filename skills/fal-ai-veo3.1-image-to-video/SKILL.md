...
description: >
  Use this skill for the fal.ai Veo 3.1 model (fal-ai/veo3.1/image-to-video). Veo 3.1 is the latest state-of-the art video generation model from Google DeepMind
---
...
**Source:** https://fal.ai/models/fal-ai/veo3.1/image-to-video/api
...
| `aspect_ratio` | enum: `auto`, `16:9`, `9:16` | No | `"auto"` | The aspect ratio of the generated video. Only 16:9 and 9:16 are supported. |
...
- API page: https://fal.ai/models/fal-ai/veo3.1/image-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/veo3.1/image-to-video
