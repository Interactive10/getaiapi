...
description: >
  Use this skill for the fal.ai Veo 3.1 model (fal-ai/veo3.1/reference-to-video). Generate Videos from images using Google's Veo 3.1
---
...
**Source:** https://fal.ai/models/fal-ai/veo3.1/reference-to-video/api
...
| `duration` | string | No | `"8s"` | The duration of the generated video. |
...
| `image_urls` | list<string> | **Yes** |  | URLs of the reference images to use for consistent subject appearance |
...
- API page: https://fal.ai/models/fal-ai/veo3.1/reference-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/veo3.1/reference-to-video
