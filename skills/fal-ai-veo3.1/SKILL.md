...
name: fal-ai-veo3.1
description: >
  Use this skill for the fal.ai Veo 3.1 model (fal-ai/veo3.1). Veo 3.1 by Google, the most advanced AI video generation model in the world. With sound on!
---
...
**Source:** https://fal.ai/models/fal-ai/veo3.1/api
...
- API page: https://fal.ai/models/fal-ai/veo3.1/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/veo3.1
