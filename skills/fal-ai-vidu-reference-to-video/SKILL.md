...
description: >
  Use this skill for the fal.ai Vidu Reference to Video model (fal-ai/vidu/reference-to-video). Vidu Reference to Video creates videos by using a reference images and combining them with a prompt.
---
...
**Source:** https://fal.ai/models/fal-ai/vidu/reference-to-video/api
...
- API page: https://fal.ai/models/fal-ai/vidu/reference-to-video/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/vidu/reference-to-video
