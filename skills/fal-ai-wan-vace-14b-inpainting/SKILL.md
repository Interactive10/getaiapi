---
name: fal-ai-wan-vace-14b-inpainting
description: >
  Use this skill for the fal.ai Wan VACE 14B model (fal-ai/wan-vace-14b/inpainting). VACE is a video generation model that uses a source image, mask, and video to create prompted videos with controllable sources.
---
...
**Source:** https://fal.ai/models/fal-ai/wan-vace-14b/inpainting/api
...
```javascript
const { request_id } = await fal.queue.submit("fal-ai/wan-vace-14b/inpainting", {
  input: {
        "prompt": "your value here",
        "video_url": "https://example.com/input.png"
    },
...
- API page: https://fal.ai/models/fal-ai/wan-vace-14b/inpainting/api
- OpenAPI spec: https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/wan-vace-14b/inpainting
