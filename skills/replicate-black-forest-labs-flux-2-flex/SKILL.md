---
name: replicate-black-forest-labs-flux-2-flex
description: >
  Use this skill for the Replicate Flux 2 Flex model (black-forest-labs/flux-2-flex). Use the Flux 2 Flex model via Replicate API.
---

# Flux 2 Flex

**Model:** `black-forest-labs/flux-2-flex`
**Source:** https://replicate.com/black-forest-labs/flux-2-flex
**Version:** `57df51f07c4bc4457b768277b1bb754a0c35b9f02c2ce48582a8b3a48fe0a2c3`
...
output = replicate.run("black-forest-labs/flux-2-flex",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/black-forest-labs/flux-2-flex/predictions \
...
| `input_images` | list<string (URL)> | No | `[]` | List of input images for image-to-image generation. Maximum 10 images. Must be jpeg, png, gif, or webp. |
...
| `prompt_upsampling` | boolean | No | `true` | Automatically modify the prompt for more creative generation |
| `steps` | integer | No | `30` | Number of inference steps |
| `guidance` | float | No | `4.5` | Guidance scale for generation. Controls how closely the output follows the prompt |
...
- Model page: https://replicate.com/black-forest-labs/flux-2-flex
- API page: https://replicate.com/black-forest-labs/flux-2-flex/api
