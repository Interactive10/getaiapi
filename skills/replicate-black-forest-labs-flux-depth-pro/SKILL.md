---
name: replicate-black-forest-labs-flux-depth-pro
description: >
  Use this skill for the Replicate Flux Depth Pro model (black-forest-labs/flux-depth-pro). Use the Flux Depth Pro model via Replicate API.
---

# Flux Depth Pro

**Model:** `black-forest-labs/flux-depth-pro`
**Source:** https://replicate.com/black-forest-labs/flux-depth-pro
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/black-forest-labs/flux-depth-pro/predictions \
...
- Model page: https://replicate.com/black-forest-labs/flux-depth-pro
- API page: https://replicate.com/black-forest-labs/flux-depth-pro/api
