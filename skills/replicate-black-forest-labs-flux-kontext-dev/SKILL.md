---
name: replicate-black-forest-labs-flux-kontext-dev
description: >
  Use this skill for the Replicate Flux Kontext Dev model (black-forest-labs/flux-kontext-dev). Use the Flux Kontext Dev model via Replicate API.
---

# Flux Kontext Dev

**Model:** `black-forest-labs/flux-kontext-dev`
**Source:** https://replicate.com/black-forest-labs/flux-kontext-dev
...
output = replicate.run("black-forest-labs/flux-kontext-dev",
    input={
        "prompt": "your prompt here",
        "input_image": "https://example.com/input.png"
    },
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/black-forest-labs/flux-kontext-dev/predictions \
...
| `aspect_ratio` | enum (12 values) | No | `"match_input_image"` | Aspect ratio of the generated image. Use 'match_input_image' to match the aspect ratio of the input image. |
...
- Model page: https://replicate.com/black-forest-labs/flux-kontext-dev
- API page: https://replicate.com/black-forest-labs/flux-kontext-dev/api
