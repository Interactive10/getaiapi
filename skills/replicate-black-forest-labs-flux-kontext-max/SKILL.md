---
name: replicate-black-forest-labs-flux-kontext-max
description: >
  Use this skill for the Replicate Flux Kontext Max model (black-forest-labs/flux-kontext-max). Use the Flux Kontext Max model via Replicate API.
---
...
output = replicate.run("black-forest-labs/flux-kontext-max",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/black-forest-labs/flux-kontext-max/predictions \
...
- Model page: https://replicate.com/black-forest-labs/flux-kontext-max
- API page: https://replicate.com/black-forest-labs/flux-kontext-max/api
