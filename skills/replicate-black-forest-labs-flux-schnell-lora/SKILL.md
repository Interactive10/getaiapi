---
name: replicate-black-forest-labs-flux-schnell-lora
description: >
  Use this skill for the Replicate Flux Schnell Lora model (black-forest-labs/flux-schnell-lora). Use the Flux Schnell Lora model via Replicate API.
---
...
const output = await replicate.run("black-forest-labs/flux-schnell-lora", {
  input: {
...
output = replicate.run("black-forest-labs/flux-schnell-lora",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/black-forest-labs/flux-schnell-lora/predictions \
...
- Model page: https://replicate.com/black-forest-labs/flux-schnell-lora
- API page: https://replicate.com/black-forest-labs/flux-schnell-lora/api
