---
name: replicate-cjwbw-supir
description: >
  Use this skill for the Replicate Supir model (cjwbw/supir). Use the Supir model via Replicate API.
---

# Supir

**Model:** `cjwbw/supir`
**Source:** https://replicate.com/cjwbw/supir
...
const output = await replicate.run("cjwbw/supir", {
  input: {
...
output = replicate.run("cjwbw/supir",
    input={
        "image": "https://example.com/input.png"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/cjwbw/supir/predictions \
...
| --- | --- | --- | --- | --- |
| `model_name` | enum: `SUPIR-v0Q`, `SUPIR-v0F` | No | `"SUPIR-v0Q"` | Choose a model. SUPIR-v0Q is the default training settings with paper. SUPIR-v0F is high generalization and high imag... |
...
| `use_llava` | boolean | No | `true` | Use LLaVA model to get captions. |
...
- Model page: https://replicate.com/cjwbw/supir
- API page: https://replicate.com/cjwbw/supir/api
