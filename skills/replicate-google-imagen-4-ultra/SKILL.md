---
name: replicate-google-imagen-4-ultra
description: >
  Use this skill for the Replicate Imagen 4 Ultra model (google/imagen-4-ultra). Use the Imagen 4 Ultra model via Replicate API.
---

# Imagen 4 Ultra

**Model:** `google/imagen-4-ultra`
**Source:** https://replicate.com/google/imagen-4-ultra
**Version:** `1a75d7b302b3847bab8f9dbec11d52800479af35323c837612053ab5de035ee9`
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/google/imagen-4-ultra/predictions \
...
- Model page: https://replicate.com/google/imagen-4-ultra
- API page: https://replicate.com/google/imagen-4-ultra/api
