---
name: replicate-google-nano-banana-pro
description: >
  Use this skill for the Replicate Nano Banana Pro model (google/nano-banana-pro). Use the Nano Banana Pro model via Replicate API.
---
...
output = replicate.run("google/nano-banana-pro",
    input={
        "prompt": "your prompt here"
    },
)
...
| `resolution` | enum: `1K`, `2K`, `4K` | No | `"2K"` | Resolution of the generated image |
...
| `allow_fallback_model` | boolean | No | `false` | Fallback to another model (currently bytedance/seedream-5) if Nano Banana Pro is at capacity. |
...
- Model page: https://replicate.com/google/nano-banana-pro
- API page: https://replicate.com/google/nano-banana-pro/api
