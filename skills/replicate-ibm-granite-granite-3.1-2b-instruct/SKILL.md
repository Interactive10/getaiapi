---
name: replicate-ibm-granite-granite-3.1-2b-instruct
description: >
  Use this skill for the Replicate Granite 3.1 2B Instruct model (ibm-granite/granite-3.1-2b-instruct). Use the Granite 3.1 2B Instruct model via Replicate API.
---

# Granite 3.1 2B Instruct

**Model:** `ibm-granite/granite-3.1-2b-instruct`
**Source:** https://replicate.com/ibm-granite/granite-3.1-2b-instruct
**Version:** `7b0098e3d43b2c13c23a78ee680b1797e1149b8b0ea492dd8b2b3ccc78f8a94b`
...
const output = await replicate.run("ibm-granite/granite-3.1-2b-instruct", {
  input: {
...
output = replicate.run("ibm-granite/granite-3.1-2b-instruct",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/ibm-granite/granite-3.1-2b-instruct/predictions \
...
- Model page: https://replicate.com/ibm-granite/granite-3.1-2b-instruct
- API page: https://replicate.com/ibm-granite/granite-3.1-2b-instruct/api
