---
name: replicate-ideogram-ai-ideogram-v3-turbo
description: >
  Use this skill for the Replicate Ideogram V3 Turbo model (ideogram-ai/ideogram-v3-turbo). Use the Ideogram V3 Turbo model via Replicate API.
---

# Ideogram V3 Turbo

**Model:** `ideogram-ai/ideogram-v3-turbo`
**Source:** https://replicate.com/ideogram-ai/ideogram-v3-turbo
...
output = replicate.run("ideogram-ai/ideogram-v3-turbo",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/ideogram-ai/ideogram-v3-turbo/predictions \
...
- Model page: https://replicate.com/ideogram-ai/ideogram-v3-turbo
- API page: https://replicate.com/ideogram-ai/ideogram-v3-turbo/api
