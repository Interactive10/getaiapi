---
name: replicate-jagilley-controlnet-pose
description: >
  Use this skill for the Replicate Controlnet Pose model (jagilley/controlnet-pose). Use the Controlnet Pose model via Replicate API.
---

# Controlnet Pose

**Model:** `jagilley/controlnet-pose`
**Source:** https://replicate.com/jagilley/controlnet-pose
...
const output = await replicate.run("jagilley/controlnet-pose", {
  input: {
...
output = replicate.run("jagilley/controlnet-pose",
    input={
        "image": "https://example.com/input.png",
        "prompt": "your prompt here"
    },
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/jagilley/controlnet-pose/predictions \
...
- Model page: https://replicate.com/jagilley/controlnet-pose
- API page: https://replicate.com/jagilley/controlnet-pose/api
