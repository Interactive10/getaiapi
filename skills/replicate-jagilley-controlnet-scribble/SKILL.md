---
name: replicate-jagilley-controlnet-scribble
description: >
  Use this skill for the Replicate Controlnet Scribble model (jagilley/controlnet-scribble). Use the Controlnet Scribble model via Replicate API.
---

# Controlnet Scribble

**Model:** `jagilley/controlnet-scribble`
**Source:** https://replicate.com/jagilley/controlnet-scribble
...
output = replicate.run("jagilley/controlnet-scribble",
    input={
        "image": "https://example.com/input.png",
        "prompt": "your prompt here"
    },
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/jagilley/controlnet-scribble/predictions \
...
- API page: https://replicate.com/jagilley/controlnet-scribble/api
