...
description: >
  Use this skill for the Replicate Llama 2 70B model (meta/llama-2-70b). Use the Llama 2 70B model via Replicate API.
---

# Llama 2 70B

**Model:** `meta/llama-2-70b`
**Source:** https://replicate.com/meta/llama-2-70b
...
const output = await replicate.run("meta/llama-2-70b", {
  input: {
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/meta/llama-2-70b/predictions \
...
- Model page: https://replicate.com/meta/llama-2-70b
- API page: https://replicate.com/meta/llama-2-70b/api
