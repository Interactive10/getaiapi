...
description: >
  Use this skill for the Replicate Llama 2 7B Chat model (meta/llama-2-7b-chat). Use the Llama 2 7B Chat model via Replicate API.
---

# Llama 2 7B Chat

**Model:** `meta/llama-2-7b-chat`
**Source:** https://replicate.com/meta/llama-2-7b-chat
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/meta/llama-2-7b-chat/predictions \
...
| `system_prompt` | string | No | `"You are a helpful, respectful and honest assistant."` | System prompt to send to the model. This is prepended to the prompt and helps guide system behavior. |
...
| `top_k` | integer | No | `-1` | When decoding text, samples from the top k most likely tokens; lower to ignore less likely tokens |
...
- Model page: https://replicate.com/meta/llama-2-7b-chat
- API page: https://replicate.com/meta/llama-2-7b-chat/api
