---
name: replicate-meta-llama-4-scout-instruct
description: >
  Use this skill for the Replicate Llama 4 Scout Instruct model (meta/llama-4-scout-instruct). Use the Llama 4 Scout Instruct model via Replicate API.
---

# Llama 4 Scout Instruct

**Model:** `meta/llama-4-scout-instruct`
**Source:** https://replicate.com/meta/llama-4-scout-instruct
**Version:** `82ee03e0be499f722f72998242ea0bbfff8b361af4a31cd451349b9b41ef2036`
...
const output = await replicate.run("meta/llama-4-scout-instruct", {
  input: {
...
output = replicate.run("meta/llama-4-scout-instruct",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/meta/llama-4-scout-instruct/predictions \
...
- Model page: https://replicate.com/meta/llama-4-scout-instruct
- API page: https://replicate.com/meta/llama-4-scout-instruct/api
