---
name: replicate-minimax-speech-02-turbo
description: >
  Use this skill for the Replicate Speech 02 Turbo model (minimax/speech-02-turbo). Use the Speech 02 Turbo model via Replicate API.
---

# Speech 02 Turbo

**Model:** `minimax/speech-02-turbo`
**Source:** https://replicate.com/minimax/speech-02-turbo
...
output = replicate.run("minimax/speech-02-turbo",
    input={
        "text": "your value here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/minimax/speech-02-turbo/predictions \
...
- Model page: https://replicate.com/minimax/speech-02-turbo
- API page: https://replicate.com/minimax/speech-02-turbo/api
