---
name: replicate-minimax-speech-2.6-hd
description: >
  Use this skill for the Replicate Speech 2.6 Hd model (minimax/speech-2.6-hd). Use the Speech 2.6 Hd model via Replicate API.
---

# Speech 2.6 Hd

**Model:** `minimax/speech-2.6-hd`
**Source:** https://replicate.com/minimax/speech-2.6-hd
**Version:** `6968911f19d698a4d18654b5d58b0103ee9a8ba469addf8358c3fd38b1544c1c`
...
const output = await replicate.run("minimax/speech-2.6-hd", {
  input: {
...
output = replicate.run("minimax/speech-2.6-hd",
    input={
        "text": "your value here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/minimax/speech-2.6-hd/predictions \
...
- Model page: https://replicate.com/minimax/speech-2.6-hd
- API page: https://replicate.com/minimax/speech-2.6-hd/api
