---
name: replicate-minimax-speech-2.8-turbo
description: >
  Use this skill for the Replicate Speech 2.8 Turbo model (minimax/speech-2.8-turbo). Use the Speech 2.8 Turbo model via Replicate API.
---

# Speech 2.8 Turbo

**Model:** `minimax/speech-2.8-turbo`
**Source:** https://replicate.com/minimax/speech-2.8-turbo
**Version:** `fb87e0f2c69157fc47cf9c6ba00aa7548b98e970cd3401abeeea0204bcf2cfb6`
...
output = replicate.run("minimax/speech-2.8-turbo",
    input={
        "text": "your value here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/minimax/speech-2.8-turbo/predictions \
...
- Model page: https://replicate.com/minimax/speech-2.8-turbo
- API page: https://replicate.com/minimax/speech-2.8-turbo/api
