---
name: replicate-openai-gpt-5-pro
description: >
  Use this skill for the Replicate Gpt 5 Pro model (openai/gpt-5-pro). Use the Gpt 5 Pro model via Replicate API.
---

# Gpt 5 Pro

**Model:** `openai/gpt-5-pro`
**Source:** https://replicate.com/openai/gpt-5-pro
**Version:** `0e984ca8bb157e868fcf1a6fa7b47debabf59e1eb4d77686fb95c780be72d348`
...
const output = await replicate.run("openai/gpt-5-pro", {
  input: {
...
output = replicate.run("openai/gpt-5-pro",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/openai/gpt-5-pro/predictions \
...
- Model page: https://replicate.com/openai/gpt-5-pro
- API page: https://replicate.com/openai/gpt-5-pro/api
