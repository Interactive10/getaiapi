---
name: replicate-openai-gpt-image-1-mini
description: >
  Use this skill for the Replicate Gpt Image 1 Mini model (openai/gpt-image-1-mini). Use the Gpt Image 1 Mini model via Replicate API.
---

# Gpt Image 1 Mini

**Model:** `openai/gpt-image-1-mini`
**Source:** https://replicate.com/openai/gpt-image-1-mini
**Version:** `5bdbb6c220dac7de7e271ca61300166bd784ba8c814ea425ec053fb17f598cd4`
...
const output = await replicate.run("openai/gpt-image-1-mini", {
  input: {
...
output = replicate.run("openai/gpt-image-1-mini",
    input={
        "prompt": "your prompt here",
        "openai_api_key": "your value here"
    },
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/openai/gpt-image-1-mini/predictions \
...
- Model page: https://replicate.com/openai/gpt-image-1-mini
- API page: https://replicate.com/openai/gpt-image-1-mini/api
