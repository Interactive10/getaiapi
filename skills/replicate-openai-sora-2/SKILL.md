---
name: replicate-openai-sora-2
description: >
  Use this skill for the Replicate Sora 2 model (openai/sora-2). Use the Sora 2 model via Replicate API.
---
...
**Version:** `763a9321f615f4867b1d7a2d53666200da21f71da358b12c9b25e0127edae014`
...
output = replicate.run("openai/sora-2",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/openai/sora-2/predictions \
...
- Model page: https://replicate.com/openai/sora-2
- API page: https://replicate.com/openai/sora-2/api
