---
name: replicate-prunaai-p-image-edit-lora
description: >
  Use this skill for the Replicate P Image Edit Lora model (prunaai/p-image-edit-lora). Use the P Image Edit Lora model via Replicate API.
---

# P Image Edit Lora

**Model:** `prunaai/p-image-edit-lora`
**Source:** https://replicate.com/prunaai/p-image-edit-lora
**Version:** `191152bf662a44024fe326e61595d4f84c0293afdee7ff08d973d5e399973a4e`
...
const output = await replicate.run("prunaai/p-image-edit-lora", {
  input: {
...
output = replicate.run("prunaai/p-image-edit-lora",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/prunaai/p-image-edit-lora/predictions \
...
- Model page: https://replicate.com/prunaai/p-image-edit-lora
- API page: https://replicate.com/prunaai/p-image-edit-lora/api
