---
name: replicate-qwen-qwen-image-edit
description: >
  Use this skill for the Replicate Qwen Image Edit model (qwen/qwen-image-edit). Use the Qwen Image Edit model via Replicate API.
---

# Qwen Image Edit

**Model:** `qwen/qwen-image-edit`
**Source:** https://replicate.com/qwen/qwen-image-edit
**Version:** `a072e0d160ef0501120a390f602404655e467a6f591f6574f5742df0b67cbba7`
...
output = replicate.run("qwen/qwen-image-edit",
    input={
        "image": "https://example.com/input.png",
        "prompt": "your prompt here"
    },
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/qwen/qwen-image-edit/predictions \
...
| `image` | string (URL) | **Yes** |  | Image to use as reference. Must be jpeg, png, gif, or webp. |
...
- API page: https://replicate.com/qwen/qwen-image-edit/api
