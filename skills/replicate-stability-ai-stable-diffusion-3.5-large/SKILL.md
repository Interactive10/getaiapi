---
name: replicate-stability-ai-stable-diffusion-3.5-large
description: >
  Use this skill for the Replicate Stable Diffusion 3.5 Large model (stability-ai/stable-diffusion-3.5-large). Use the Stable Diffusion 3.5 Large model via Replicate API.
---
...
output = replicate.run("stability-ai/stable-diffusion-3.5-large",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/stability-ai/stable-diffusion-3.5-large/predictions \
...
- Model page: https://replicate.com/stability-ai/stable-diffusion-3.5-large
- API page: https://replicate.com/stability-ai/stable-diffusion-3.5-large/api
