---
name: replicate-wavespeedai-wan-2.1-t2v-720p
description: >
  Use this skill for the Replicate Wan 2.1 T2V 720P model (wavespeedai/wan-2.1-t2v-720p). Use the Wan 2.1 T2V 720P model via Replicate API.
---
...
**Version:** `f5576aa30f5d363b6cfa6ff8193de59a32c0f8bee3c73cdf17df92844a8b5570`
...
const output = await replicate.run("wavespeedai/wan-2.1-t2v-720p", {
  input: {
...
output = replicate.run("wavespeedai/wan-2.1-t2v-720p",
    input={
        "prompt": "your prompt here"
    },
)
...
```bash
curl -s -X POST https://api.replicate.com/v1/models/wavespeedai/wan-2.1-t2v-720p/predictions \
...
- Model page: https://replicate.com/wavespeedai/wan-2.1-t2v-720p
- API page: https://replicate.com/wavespeedai/wan-2.1-t2v-720p/api
