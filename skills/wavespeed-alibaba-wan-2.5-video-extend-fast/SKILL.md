---
name: wavespeed-alibaba-wan-2.5-video-extend-fast
description: >
  Use this skill for the WaveSpeed AI Alibaba Wan 2.5 Video Extend Fast model (alibaba/wan-2.5/video-extend-fast). Use the Alibaba Wan 2.5 Video Extend Fast model via WaveSpeed AI API.
---
...
**Source:** https://wavespeed.ai/models/alibaba/wan-2.5/video-extend-fast
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/alibaba/wan-2.5/video-extend-fast" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/alibaba/wan-2.5/video-extend-fast", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/alibaba/wan-2.5/video-extend-fast",
    headers=HEADERS,
    json={
        "video": "https://example.com/input.mp4"
    },
...
> - Model page: https://wavespeed.ai/models/alibaba/wan-2.5/video-extend-fast
> - API docs: https://wavespeed.ai/docs/docs-api/alibaba/wan-2.5-video-extend-fast
...
**POST** `https://api.wavespeed.ai/api/v3/alibaba/wan-2.5/video-extend-fast`
