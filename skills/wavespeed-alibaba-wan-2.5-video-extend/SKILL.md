---
name: wavespeed-alibaba-wan-2.5-video-extend
description: >
  Use this skill for the WaveSpeed AI Alibaba WAN 2.5 Video-Extend | AI Video Extender With Audio model (alibaba/wan-2.5/video-extend). Alibaba WAN 2.5 Video-Extend turns short clips into longer videos with preserved or generated synchronized audio for continuity. Ready-to-use REST inference API, best performance, no coldstarts, affor
---

# Alibaba WAN 2.5 Video-Extend | AI Video Extender With Audio
...
**Source:** https://wavespeed.ai/models/alibaba/wan-2.5/video-extend
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/alibaba/wan-2.5/video-extend" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/alibaba/wan-2.5/video-extend", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/alibaba/wan-2.5/video-extend",
    headers=HEADERS,
    json={
        "video": "https://example.com/input.mp4"
    },
...
> - Model page: https://wavespeed.ai/models/alibaba/wan-2.5/video-extend
> - API docs: https://wavespeed.ai/docs/docs-api/alibaba/wan-2.5-video-extend
...
**POST** `https://api.wavespeed.ai/api/v3/alibaba/wan-2.5/video-extend`
