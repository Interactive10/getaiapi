---
name: wavespeed-bytedance-dreamactor-v2
description: >
  Use this skill for the WaveSpeed AI ByteDance DreamActor V2 | Motion Transfer Video Generation model (bytedance/dreamactor-v2). ByteDance DreamActor V2 transfers motion from a driving video to characters in an image. Great performance for non-human and multiple characters. Ready-to-use REST inference API, best performance, no 
---

# ByteDance DreamActor V2 | Motion Transfer Video Generation
...
**Source:** https://wavespeed.ai/models/bytedance/dreamactor-v2
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/bytedance/dreamactor-v2", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/bytedance/dreamactor-v2",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/bytedance/dreamactor-v2
> - API docs: https://wavespeed.ai/docs/docs-api/bytedance/dreamactor-v2
...
**POST** `https://api.wavespeed.ai/api/v3/bytedance/dreamactor-v2`
