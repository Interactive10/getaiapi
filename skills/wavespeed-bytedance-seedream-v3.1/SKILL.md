---
name: wavespeed-bytedance-seedream-v3.1
description: >
  Use this skill for the WaveSpeed AI ByteDance Seedream V3.1 | High-Fidelity Text-To-Image Model model (bytedance/seedream-v3.1). Seedream V3.1 by ByteDance is a text-to-image model with upgraded visuals, stronger style fidelity, and rich detail from text prompts. Ready-to-use REST inference API, best performance, no coldstarts,
---

# ByteDance Seedream V3.1 | High-Fidelity Text-To-Image Model
...
**Source:** https://wavespeed.ai/models/bytedance/seedream-v3.1
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/bytedance/seedream-v3.1" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/bytedance/seedream-v3.1", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/bytedance/seedream-v3.1",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/bytedance/seedream-v3.1
> - API docs: https://wavespeed.ai/docs/docs-api/bytedance/seedream-v3.1
...
**Additional parameters found on model page:** `Input`, `1280`, `720`, `Button`, `reset`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/bytedance/seedream-v3.1`
