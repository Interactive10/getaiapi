---
name: wavespeed-google-gemini-2.5-pro-text-to-speech
description: >
  Use this skill for the WaveSpeed AI Google Gemini 2.5 Pro Text-To-Speech | Premium Multi-Speaker Voice Synthesis model (google/gemini-2.5-pro/text-to-speech). Google Gemini 2.5 Pro Text-to-Speech delivers natural multi-speaker voice synthesis with 30+ voices across 24 languages. Perfect for dialogues, conversations, and multilingual content. Ready-to-use RE
---

# Google Gemini 2.5 Pro Text-To-Speech | Premium Multi-Speaker Voice Synthesis
...
**Type:** Text to Speech
**Model:** `google/gemini-2.5-pro/text-to-speech`
**Source:** https://wavespeed.ai/models/google/gemini-2.5-pro/text-to-speech
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/google/gemini-2.5-pro/text-to-speech", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/google/gemini-2.5-pro/text-to-speech",
    headers=HEADERS,
    json={
        "text": "Hello, this is a test.",
        "voice": "default"
...
> - Model page: https://wavespeed.ai/models/google/gemini-2.5-pro/text-to-speech
> - API docs: https://wavespeed.ai/docs/docs-api/google/gemini-2.5-pro-text-to-speech
...
**POST** `https://api.wavespeed.ai/api/v3/google/gemini-2.5-pro/text-to-speech`
