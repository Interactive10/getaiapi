---
name: wavespeed-google-nano-banana-2-edit-fast
description: >
  Use this skill for the WaveSpeed AI Google Nano Banana 2 Edit Fast | Gemini 3.1 Flash AI Fast Image Editing With 2K &amp; 4K Output model (google/nano-banana-2/edit-fast). Google Nano Banana 2 Edit Fast (Gemini 3.1 Flash Image) is the cheapest Nano Banana 2 editing option, starting at just $0.045 per image. Enables fast image editing with 2K default output and 4K suppor
---

# Google Nano Banana 2 Edit Fast | Gemini 3.1 Flash AI Fast Image Editing With 2K &amp; 4K Output
...
**Source:** https://wavespeed.ai/models/google/nano-banana-2/edit-fast
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/google/nano-banana-2/edit-fast", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/google/nano-banana-2/edit-fast",
    headers=HEADERS,
    json={
        "prompt": "your edit prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/google/nano-banana-2/edit-fast
> - API docs: https://wavespeed.ai/docs/docs-api/google/nano-banana-2-edit-fast
...
**POST** `https://api.wavespeed.ai/api/v3/google/nano-banana-2/edit-fast`
