---
name: wavespeed-google-nano-banana-pro-edit-ultra
description: >
  Use this skill for the WaveSpeed AI Google Nano Banana Pro Edit Ultra | 8K Image Editing model (google/nano-banana-pro/edit-ultra). Google Nano Banana Pro (Gemini 3.0 Pro Image) Edit enables image editing with highres output. Ready-to-use REST inference API, best performance, no coldstarts, affordable pricing.
---

# Google Nano Banana Pro Edit Ultra | 8K Image Editing
...
**Source:** https://wavespeed.ai/models/google/nano-banana-pro/edit-ultra
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/google/nano-banana-pro/edit-ultra", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/google/nano-banana-pro/edit-ultra",
    headers=HEADERS,
    json={
        "prompt": "your edit prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/google/nano-banana-pro/edit-ultra
> - API docs: https://wavespeed.ai/docs/docs-api/google/nano-banana-pro-edit-ultra
...
**POST** `https://api.wavespeed.ai/api/v3/google/nano-banana-pro/edit-ultra`
