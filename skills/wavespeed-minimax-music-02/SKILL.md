---
name: wavespeed-minimax-music-02
description: >
  Use this skill for the WaveSpeed AI Minimax Music-02 | Compact Fast MoE Music Generation (230B/10B Active) model (minimax/music-02). Minimax Music-02 is a compact, fast, cost-effective MoE music generator (230B params, 10B active) for high-quality music production. Ready-to-use REST inference API, best performance, no coldstarts, a
---

# Minimax Music-02 | Compact Fast MoE Music Generation (230B/10B Active)
...
**Source:** https://wavespeed.ai/models/minimax/music-02
...
curl -X POST "https://api.wavespeed.ai/api/v3/minimax/music-02" \
  ...
  -d '{"prompt": "upbeat jazz melody"}'
```

### JavaScript Example

```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/minimax/music-02", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/minimax/music-02",
    headers=HEADERS,
    json={
        "prompt": "upbeat jazz melody"
    },
...
> - Model page: https://wavespeed.ai/models/minimax/music-02
> - API docs: https://wavespeed.ai/docs/docs-api/minimax/music-02
...
**Additional parameters found on model page:** `root_bitrate`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`, `Web`
...
**POST** `https://api.wavespeed.ai/api/v3/minimax/music-02`
