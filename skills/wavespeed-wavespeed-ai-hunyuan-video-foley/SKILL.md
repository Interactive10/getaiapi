---
name: wavespeed-wavespeed-ai-hunyuan-video-foley
description: >
  Use this skill for the WaveSpeed AI Hunyuan Video Foley | Realistic Video-To-Audio Foley Generation model (wavespeed-ai/hunyuan-video-foley). HunyuanVideo-Foley generates realistic Foley and ambient audio from an uploaded video using a text prompt to describe desired sounds. Ready-to-use REST inference API, best performance, no coldstarts, 
---

# Hunyuan Video Foley | Realistic Video-To-Audio Foley Generation
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/hunyuan-video-foley
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/hunyuan-video-foley", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/hunyuan-video-foley",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/hunyuan-video-foley
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/hunyuan-video-foley
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/hunyuan-video-foley`
