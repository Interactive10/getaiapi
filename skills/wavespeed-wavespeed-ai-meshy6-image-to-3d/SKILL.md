---
name: wavespeed-wavespeed-ai-meshy6-image-to-3d
description: >
  Use this skill for the WaveSpeed AI Meshy 6 | Image To 3D Model Generation With PBR Textures model (wavespeed-ai/meshy6/image-to-3d). Meshy 6 converts 2D images into high-quality 3D models with accurate geometry reconstruction and superior texture quality. Ready-to-use REST inference API, best performance, no coldstarts, affordable 
---

# Meshy 6 | Image To 3D Model Generation With PBR Textures
...
**Type:** Image to 3D
**Model:** `wavespeed-ai/meshy6/image-to-3d`
**Source:** https://wavespeed.ai/models/wavespeed-ai/meshy6/image-to-3d
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/meshy6/image-to-3d" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/meshy6/image-to-3d", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/meshy6/image-to-3d",
    headers=HEADERS,
    json={
        "image": "https://example.com/input.png"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/meshy6/image-to-3d
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/meshy6-image-to-3d
...
**Additional parameters found on model page:** `Input`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`, `quad`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/meshy6/image-to-3d`
