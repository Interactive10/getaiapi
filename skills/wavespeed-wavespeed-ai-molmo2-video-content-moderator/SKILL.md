---
name: wavespeed-wavespeed-ai-molmo2-video-content-moderator
description: >
  Use this skill for the WaveSpeed AI Molmo2-4B Video Content Moderator | AI Video Safety Analysis &amp; Visual Content Moderation model (wavespeed-ai/molmo2/video-content-moderator). Molmo2-4B Video Content Moderator analyzes video content for safety, appropriateness, and policy compliance. Detects violence, nudity, gore, and other harmful visual content in videos using an open-so
---

# Molmo2-4B Video Content Moderator | AI Video Safety Analysis &amp; Visual Content Moderation
...
**Model:** `wavespeed-ai/molmo2/video-content-moderator`
**Source:** https://wavespeed.ai/models/wavespeed-ai/molmo2/video-content-moderator
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/molmo2/video-content-moderator" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/molmo2/video-content-moderator", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/molmo2/video-content-moderator",
    headers=HEADERS,
    json={
        "video": "https://example.com/input.mp4"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/molmo2/video-content-moderator
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/molmo2-video-content-moderator
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/molmo2/video-content-moderator`
