---
name: wavespeed-wavespeed-ai-qwen-image-2.0-pro-text-to-image
description: >
  Use this skill for the WaveSpeed AI Qwen Image 2.0 Pro | Professional AI Text-To-Image Generator model (wavespeed-ai/qwen-image-2.0-pro/text-to-image). Qwen Image 2.0 Pro is a professional-grade text-to-image model with superior quality and advanced prompt understanding. Up to 2k. Ready-to-use REST inference API, best performance, no coldstarts, affo
---

# Qwen Image 2.0 Pro | Professional AI Text-To-Image Generator
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/qwen-image-2.0-pro/text-to-image
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image-2.0-pro/text-to-image" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image-2.0-pro/text-to-image", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image-2.0-pro/text-to-image",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/qwen-image-2.0-pro/text-to-image
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/qwen-image-2.0-pro-text-to-image
...
**Additional parameters found on model page:** `Input`, `2048`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image-2.0-pro/text-to-image`
