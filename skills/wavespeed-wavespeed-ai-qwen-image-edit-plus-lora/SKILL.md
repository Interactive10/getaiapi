---
name: wavespeed-wavespeed-ai-qwen-image-edit-plus-lora
description: >
  Use this skill for the WaveSpeed AI Qwen Image Edit Plus (2509) | Image Edit with LoRAs model (wavespeed-ai/qwen-image/edit-plus-lora). Qwen-Image-Edit-Plus (2509) is 20B MMDiT image-to-image editor supporting multi-image edits, single-image consistency, and native ControlNet. Ready-to-use REST inference API, best performance, no cold
---

# Qwen Image Edit Plus (2509) | Image Edit with LoRAs
...
**Type:** Image Editing
**Model:** `wavespeed-ai/qwen-image/edit-plus-lora`
**Source:** https://wavespeed.ai/models/wavespeed-ai/qwen-image/edit-plus-lora
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/edit-plus-lora", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/edit-plus-lora",
    headers=HEADERS,
    json={
        "prompt": "your edit prompt here",
        "image": "https://example.com/input.png"
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/qwen-image/edit-plus-lora
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/qwen-image-edit-plus-lora
...
**Additional parameters found on model page:** `Input`, `1536`, `0`, `Button`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/edit-plus-lora`
