---
name: wavespeed-wavespeed-ai-qwen-image-layered
description: >
  Use this skill for the WaveSpeed AI Qwen-Image Layered | RGBA Layer Decomposition for Image Compositing model (wavespeed-ai/qwen-image/layered). Qwen-Image Layered is a unified image-layer decomposition model for prompt-guided compositing. Provide points, boxes, or rough masks to isolate subjects and regions, and the model splits a single imag
---

# Qwen-Image Layered | RGBA Layer Decomposition for Image Compositing
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/qwen-image/layered
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/layered", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/layered",
    headers=HEADERS,
    json={
        "prompt": "your prompt here"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/qwen-image/layered
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/qwen-image-layered
...
**Additional parameters found on model page:** `Input`, `1`, `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/qwen-image/layered`
