---
name: wavespeed-wavespeed-ai-sam3-image-rle
description: >
  Use this skill for the WaveSpeed AI SAM 3 RLE | AI Image Segmentation With RLE Encoded Mask Output model (wavespeed-ai/sam3-image-rle). SAM 3 RLE is a unified foundation model for promptable image segmentation using text, points, or boxes to detect and segment objects. Returns RLE (Run-Length Encoding) encoded masks for efficient stor
---

# SAM 3 RLE | AI Image Segmentation With RLE Encoded Mask Output
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/sam3-image-rle
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/sam3-image-rle" \
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/sam3-image-rle", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/sam3-image-rle",
    headers=HEADERS,
    json={
        "image": "https://example.com/input.png"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/sam3-image-rle
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/sam3-image-rle
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/sam3-image-rle`
