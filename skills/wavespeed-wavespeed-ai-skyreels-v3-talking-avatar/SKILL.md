---
name: wavespeed-wavespeed-ai-skyreels-v3-talking-avatar
description: >
  Use this skill for the WaveSpeed AI SkyReels V3 Talking Avatar | AI Lip Sync Portrait Animation Up to 200 Seconds model (wavespeed-ai/skyreels-v3/talking-avatar). SkyReels V3 Talking Avatar is a 19B-parameter multimodal model that generates talking avatars from portrait and audio with precise lip sync, supporting up to 20 seconds at 720p resolution. Ready-to-us
---

# SkyReels V3 Talking Avatar | AI Lip Sync Portrait Animation Up to 200 Seconds
...
**Type:** Avatar
**Model:** `wavespeed-ai/skyreels-v3/talking-avatar`
**Source:** https://wavespeed.ai/models/wavespeed-ai/skyreels-v3/talking-avatar
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/skyreels-v3/talking-avatar" \
  -H "Authorization: Bearer $WAVESPEED_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"image": "https://example.com/portrait.png", "audio": "https://example.com/audio.wav"}'
```

### JavaScript Example

```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/skyreels-v3/talking-avatar", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/skyreels-v3/talking-avatar",
    headers=HEADERS,
    json={
        "image": "https://example.com/portrait.png",
        "audio": "https://example.com/audio.wav"
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/skyreels-v3/talking-avatar
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/skyreels-v3-talking-avatar
...
**Additional parameters found on model page:** `canonical`, `false`, `s`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/skyreels-v3/talking-avatar`
