---
name: wavespeed-wavespeed-ai-ultimate-image-upscaler
description: >
  Use this skill for the WaveSpeed AI Ultimate Image Upscaler | Upscale To 4K/8K Enhanced Detail model (wavespeed-ai/ultimate-image-upscaler). Ultimate Image Upscaler is the most advanced AI enhancer that reimagines fine detail while upscaling images to 4K or 8K. Ready-to-use REST inference API, best performance, no coldstarts, affordable pr
---

# Ultimate Image Upscaler | Upscale To 4K/8K Enhanced Detail
...
**Source:** https://wavespeed.ai/models/wavespeed-ai/ultimate-image-upscaler
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/ultimate-image-upscaler" \
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/ultimate-image-upscaler",
    headers=HEADERS,
    json={
        "image": "https://example.com/input.png"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/ultimate-image-upscaler
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/ultimate-image-upscaler
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/ultimate-image-upscaler`
