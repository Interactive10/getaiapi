---
name: wavespeed-wavespeed-ai-ultimate-video-upscaler
description: >
  Use this skill for the WaveSpeed AI Ultimate Video Upscaler | 4K Video Enhancement &amp; Frame Consistency model (wavespeed-ai/ultimate-video-upscaler). Ultimate Video Upscaler converts low-resolution videos into crisp 4K footage with seamless motion dynamics and frame consistency. Ready-to-use REST inference API, best performance, no cold starts, aff
---

# Ultimate Video Upscaler | 4K Video Enhancement &amp; Frame Consistency
...
**Type:** Upscaler
**Model:** `wavespeed-ai/ultimate-video-upscaler`
**Source:** https://wavespeed.ai/models/wavespeed-ai/ultimate-video-upscaler
...
```bash
curl -X POST "https://api.wavespeed.ai/api/v3/wavespeed-ai/ultimate-video-upscaler" \
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/ultimate-video-upscaler",
    headers=HEADERS,
    json={
        "video": "https://example.com/input.mp4"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/ultimate-video-upscaler
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/ultimate-video-upscaler
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/ultimate-video-upscaler`
