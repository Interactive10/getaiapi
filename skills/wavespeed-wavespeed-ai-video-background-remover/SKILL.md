---
name: wavespeed-wavespeed-ai-video-background-remover
description: >
  Use this skill for the WaveSpeed AI WaveSpeed Video Background Remover | AI Video Background Removal And Replacement model (wavespeed-ai/video-background-remover). WaveSpeed Video Background Remover replaces or removes video backgrounds with a custom image. Upload or paste a link to your video, then provide a background image by URL or file—clean matting, edge-a
---

# WaveSpeed Video Background Remover | AI Video Background Removal And Replacement
...
**Model:** `wavespeed-ai/video-background-remover`
**Source:** https://wavespeed.ai/models/wavespeed-ai/video-background-remover
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/video-background-remover", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/video-background-remover",
    headers=HEADERS,
    json={
        "video": "https://example.com/input.mp4"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/video-background-remover
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/video-background-remover
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/video-background-remover`
