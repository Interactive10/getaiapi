---
name: wavespeed-wavespeed-ai-video-upscaler-pro
description: >
  Use this skill for the WaveSpeed AI AI Video Upscaler Pro | 4K Video Enhancement &amp; Frame Consistency model (wavespeed-ai/video-upscaler-pro). AI Video Upscaler Pro converts low-resolution videos into crisp 4K footage with seamless motion dynamics and frame consistency. Ready-to-use REST inference API, best performance, no coldstarts, afford
---

# AI Video Upscaler Pro | 4K Video Enhancement &amp; Frame Consistency
...
**Type:** Upscaler
**Model:** `wavespeed-ai/video-upscaler-pro`
**Source:** https://wavespeed.ai/models/wavespeed-ai/video-upscaler-pro
...
```javascript
const response = await fetch("https://api.wavespeed.ai/api/v3/wavespeed-ai/video-upscaler-pro", {
  method: "POST",
  headers: {
...
# Submit task
resp = requests.post("https://api.wavespeed.ai/api/v3/wavespeed-ai/video-upscaler-pro",
    headers=HEADERS,
    json={
        "video": "https://example.com/input.mp4"
    },
...
> - Model page: https://wavespeed.ai/models/wavespeed-ai/video-upscaler-pro
> - API docs: https://wavespeed.ai/docs/docs-api/wavespeed-ai/video-upscaler-pro
...
**Additional parameters found on model page:** `false`, `What`, `OpenAI`, `Kuaishou`, `Google`, `Alibaba`, `Tencent`, `Shengshu`, `WaveSpeedAI`, `op`
...
**POST** `https://api.wavespeed.ai/api/v3/wavespeed-ai/video-upscaler-pro`
